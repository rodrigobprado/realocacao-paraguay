...
% REVISADO: Formato legível para A5
...
\begin{tabular}{@{}p{3.2cm} p{3.5cm} c p{2.2cm} c@{}}
\toprule
...
\begin{tabular}{@{}p{2.5cm} p{2.8cm} c p{1.8cm} c@{}}
\toprule
\textbf{Variável} & \textbf{Fonte} & \textbf{Tipo} & \textbf{Cobert.} & \textbf{Conf.} \\
\midrule
