...
O pacote 15 cobre o departamento , com 6 localidades. Amambay e
departamento do nordeste paraguaio, fronteirico com o Brasil (Mato
...
Ranking nacional (1=melhor) & 5/\allowbreak 18 \\
...
\item
  ...
  \item
    ...
    (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}AD/\allowbreak MDI).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Classificação: - Seguro (Localidade de elite para quem busca isolamento
...
\item
  ...
  \tightlist
  \item
    Relatórios de segurança regional da SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}AD e FTC.
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Classificação: - Moderadamente Seguro (Indicado para projetos de
...
Notas (0-10): - A: 8.3 - B: 7.6 - C: 6.9 - D: 7.9 - E: 7.7

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (82/\allowbreak 100) e exposicao hidro
(39/\allowbreak 100). - B (infraestrutura): combina conectividade (82/\allowbreak 100) e escala
populacional (106721 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (39/\allowbreak 100). - D (autossuficiência): combina
conectividade, ajuste de densidade (133.0 hab/\allowbreak km2) e risco hidro. - E
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -22.55°, -55.73°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 7.0 (Localização estratégica de fronteira; boa
invisibilidade tática fora dos eixos urbanos, equilibrada por riscos
regionais) - B: 8.0 (Densidade populacional baixa; isolamento social
satisfatório em ambiente rural) - C: 7.5 (Geologia muito estável e
relevo seguro contra desastres hídricos) - D: 8.5 (Recursos agrícolas de
elite e abundância hídrica subterrânea excepcional) - E: 8.0 (Forte
segurança institucional de fronteira e proximidade com suporte estatal
capital)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) /\allowbreak  10 - GSS: 7.7

Classificação: - Seguro (Localidade de elite para quem busca
autossuficiência em solo de alta performance com suporte institucional
próximo).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -22.5833°, -55.7333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
