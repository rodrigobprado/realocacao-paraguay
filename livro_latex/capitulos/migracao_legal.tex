...
\toprule
\textbf{Modalidade} & \textbf{Duração} & \textbf{Requisito Principal} & \textbf{Permite Trabalhar?} \\
\midrule
Residência Temporária & 2 anos (renovável) & Propósito declarado (trabalho, estudo, investimento, reagrupamento familiar) & Sim, com permissão específica \\
Residência Permanente & Indefinida & 3 anos de residência temporária contínua \textit{ou} requisito econômico & Sim, irrestrito \\
Residência por Investimento & Permanente direta & Investimento mínimo de USD 75.000 em empresa paraguaia & Sim \\
Residência por Reagrupamento Familiar & Temporária → Permanente & Cônjuge, filhos ou pais de residente/cidadão paraguaio & Sim \\
Residência de Aposentado & Permanente direta & Renda passiva mínima de USD 1.500/mês comprovada & Não remunerado \\
\bottomrule
\end{tabularx}
