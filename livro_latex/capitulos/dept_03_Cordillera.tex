...
Média anual: 4.95 kWh/m²/dia. Inclinação recomendada: 25° Norte (anual);
35° inverno; 15° verão.
...
Média anual: \textasciitilde1.500 mm/ano. Estação chuvosa Out-Mai; seca
Jun-Set.
\clearpage
...
\bottomrule\noalign{}
\endlastfoot
Taxa de homicídios (por 100k hab) & 3,5 (2022, fonte INE\footnote{Instituto Nacional de Estadística (Instituto Nacional de Estatística), órgão oficial de dados demográficos e censitários.}/Prosegur) \\
Crimes registrados (total/ano) & --- dados não desagregados
publicamente \\
Número de comisarías & \textasciitilde18 (estimativa departamental) \\
...
\clearpage
\newpage
\secaoDiagnostico{Altos}{\mapaDistrito{0302}}{Altos é o ápice da segurança e resiliência tática no Paraguai.
...
e recursos. Referencia atual de score: GSS 8.9.
...
\item
  ...
  \item
    ...
    municipal.
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Altos}
\begin{table}[ht!]
...
Notas (0-10): - A: 8.5 (Posição estratégica serrana; observatório
natural e isolamento de elite; fora do radar de fallout metropolitano) -
B: 9.0 (População gerenciada e qualificada; densidade sob controle
privado; baixíssimo risco social) - C: 8.5 (Segurança absoluta contra
inundações; geologia muito estável em cota elevada) - D: 9.0
(Excepcionais recursos hídricos de nascente; infraestrutura de suporte
tecnológico superior) - E: 9.5 (Máxima segurança institucional e privada
satelital; governança comunitária de elite)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 8.9

Classificacao: - Seguro (A localidade nº 1 do Paraguai para relocação
estratégica; oferece o máximo em segurança, recursos e isolamento
geográfico defensivo).
...
\item[Densidade]  \textasciitilde 133,1 hab/km² (Densidade moderada e altamente qualificada, garantindo privacidade absoluta em propriedades de grande porte e condomínios fechados).
...
\item[Preço da Terra]  US\$ 50.000-80.000/ha (áreas de expansão com vista); US\$ 100-300/m² (lotes em condomínios de luxo).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.2°, -57.25°. Média
...
Taxa de homicídios (est., /100k hab) & 3,5 (2022, fonte INE\footnote{Instituto Nacional de Estadística (Instituto Nacional de Estatística), órgão oficial de dados demográficos e censitários.}/Prosegur) &
dept. \\
...
\item
  \textbf{Conservador (Crise hídrica/cheias):} GSS 6.2
\end{itemize}
...
\end{enumerate}}{dist:03_Cordillera:Arroyos_y_Esteros}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
\item[Densidade]  \textasciitilde 37,89 hab/km².
...
\item[Preço da Terra]  Gs. 40-60 milhões/ha (USD 5.200 - 8.000). Propriedades premium até USD 11.000/ha.
\item[Fontes] 
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.0667°, -57.1°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.

\begin{itemize}
\tightlist
\item
  \textbf{Preço da Terra:} Gs. 40-60 milhões/ha (USD 5.200 - 8.000).
  Propriedades premium até USD 11.000/ha.
\item
  \textbf{Fontes:}
\end{itemize}
\subsubsection{Indicadores Sociais}
...
equilíbrio com a visibilidade estratégica da localidade. Referencia
...
\item
  ...
  \item
    ...
    departamental.
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Caacupe}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 6.5 (Capital departamental e hub espiritual; alvo
logístico de alta visibilidade e sensibilidade tática) - B: 6.5
(População regional gerenciada; risco social temporário em épocas de
grandes peregrinações) - C: 7.0 (Geologia estável e relevo seguro contra
desastres naturais sistêmicos) - D: 8.0 (Recursos hídricos, de serviços
e de suprimentos excelentes; solo fértil) - E: 8.0 (Forte segurança
institucional e suporte de saúde regional de elite)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.2

Classificacao: - Seguro (Altamente recomendado como base administrativa
e de suporte próximo à capital nacional, ciente da visibilidade tática).

\begin{itemize}
\tightlist
\item
  Fonte Municipalidade de Caacupé (Operação da Planta Asfáltica e
  Obras).
\end{itemize}
...
\item[Densidade]  \textasciitilde 347,6 hab/km² (Densidade moderada para uma capital, oferecendo bom equilíbrio entre serviços urbanos e áreas rurais periféricas de lazer).
...
\item[Preço da Terra]  US\$ 15.000-30.000/ha (áreas rurais de lazer); US\$ 60-120/m² (Urbano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3833°, -57.1333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
localidade. Referencia atual de score: GSS 8.0.
...
\item
  ...
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Caraguatay}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 8.5 (Isolamento tático excepcional; vale protegido e
baixíssima visibilidade estratégica) - B: 8.5 (Densidade populacional
extremamente baixa; isolamento social superior e privacidade absoluta) -
C: 7.0 (Geologia muito estável e baixo risco de grandes desastres
naturais graves) - D: 8.0 (Excelentes recursos hídricos e de proteína
animal; solo fértil) - E: 7.5 (Forte segurança institucional e social
sustentada pela tradição local)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 8.0

Classificacao: - Seguro (Altamente recomendado para quem busca o máximo
de isolamento tático e privacidade em solo fértil próximo à capital).

\begin{itemize}
\tightlist
\item
  Fonte MOPC infraestrutura: Relatórios de acessibilidade rural em
  Cordillera.
\end{itemize}
...
\item[Densidade]  \textasciitilde 19,3 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência de riscos sociais de massa urbana).
...
\item[Preço da Terra]  US\$ 5.000-8.000/ha (terras agrícolas); US\$ 3.000-5.000/ha (áreas de campo natural/lazer).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.2333°, -56.8167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  \tightlist
  \item
    Registro histórico de sismos intraplaca (Villa Hayes/Emboscada).
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Emboscada}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 5.0 (Nó rodoviário e alvo prisional estratégico;
visibilidade moderada pelo fluxo da PY03) - B: 6.5 (Densidade urbana
manejada; baixíssima taxa de homicídios no departamento) - C: 7.5
(Geologia excepcional para fundações e proteção; baixo risco de
inundações graves) - D: 7.5 (Recursos minerais inesgotáveis para
construção e defesa; boa disponibilidade hídrica) - E: 8.0 (Forte
estabilidade institucional regional e proximidade com serviços de elite
da capital)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.8

Classificacao: - Moderadamente Seguro (Recomendado para perfis que
buscam segurança institucional e recursos de construção).
...
\item[Densidade]  \textasciitilde 110,9 hab/km² (Alta para o interior, exigindo cautela em cenários de escassez urbana).
...
\item[Preço da Terra]  US\$ 5.500/ha (grandes glebas rurais); US\$ 15.000-35.000/ha (áreas menores ou com potencial de extração mineral).
...
\item[Clima]  Subtropical Úmido. Média de 1.500 mm/ano. Tempestades de verão podem ser intensas.
...
\item[Qualidade do Solo]  Predominantemente rochoso; limita a agricultura mecanizada de grande escala, mas é excelente para mineração e construção de estruturas subterrâneas/abrigos de alta resistência.
...
\item[Segurança]  Zona de Atenção Tática. A presença do complexo penitenciário exige monitoramento contra fugas ou instabilidades internas. Contudo, a taxa de homicídios no departamento de Cordillera é uma das mais baixas do país (\textasciitilde 3,6/100k).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.1167°, -57.35°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
dos recursos e das instituições locais. Referencia atual de score: GSS
8.0.
...
\item
  ...
  \item
    Registro de segurança pública e governança municipal histórica.
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Eusebio_Ayala}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 7.5 (Posicionamento tático defensivo; relevo ondulado
e visibilidade estratégica moderada no eixo PY02) - B: 8.0 (Densidade
populacional baixa; isolamento social satisfatório em ambiente rural
tradicional) - C: 7.5 (Geologia muito estável e topografia segura contra
inundações) - D: 9.0 (Excepcionais recursos alimentares tradicionais e
hídricos; polo de processamento de grãos) - E: 8.0 (Forte segurança
institucional e social sustentada pela importância histórica nacional)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 8.0

Classificacao: - Seguro (Altamente recomendado como polo de recursos e
residência de resiliência tática próximo à capital).
...
\item[Densidade]  \textasciitilde 57,2 hab/km² (Densidade baixa, oferecendo excelente isolamento social e privacidade em áreas rurais preservadas).
...
\item[Preço da Terra]  US\$ 8.000-12.000/ha (terras agrícolas mecanizáveis); US\$ 30-60/m² (Urbano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3833°, -56.9667°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
principal. Referencia atual de score: GSS 6.1.
...
\item
  ...
  \item
    ...
    regional).
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Isla_Pucu}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 5.0 (Posicionamento rodoviário estratégico no eixo
PY02; visibilidade tática moderada) - B: 6.0 (Densidade urbana manejada
e alta estabilidade social comunitária) - C: 6.5 (Geologia muito estável
e riscos climáticos moderados) - D: 7.0 (Excelentes recursos para
agricultura e pecuária familiar; abundância de água) - E: 6.0 (Ambiente
institucional pacífico e seguro, mas com serviços locais de saúde
limitados)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.1

Classificacao: - Moderadamente Seguro (Excelente opção para quem busca
um estilo de vida rural ordenado com acesso rápido à capital).
...
\item[Densidade]  \textasciitilde 58,3 hab/km² (Baixa densidade, oferecendo isolamento rural com acesso rápido a centros urbanos).
...
\item[Preço da Terra]  US\$ 5.000-8.500/ha (áreas rurais produtivas ou próximas ao asfalto).
...
\item[Segurança]  Zona extremamente tranquila. Cordillera possui uma das menores taxas de homicídios do país (\textasciitilde 3,8/100k). Alta coesão social e perfil conservador.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.2667°, -56.9°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Referencia atual de score: GSS 6.5.
...
\item
  ...
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Itacurubi_de_la_Cordillera}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 5.0 (Posicionamento rodoviário nevrálgico na PY02;
alvo logístico de alta visibilidade) - B: 6.5 (População pequena e
densidade controlada; baixo risco de agitação urbana) - C: 7.0 (Geologia
estável e riscos climáticos típicos manejáveis) - D: 7.5 (Excelentes
recursos: mel, proteína animal, água pura e solos férteis) - E: 6.5
(Forte estabilidade institucional regional e ambiente social pacífico)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.5

Classificacao: - Moderadamente Seguro (Ideal para quem busca base
logística com alta qualidade de vida rural).
...
\item[Densidade]  \textasciitilde 34,2 hab/km² (Densidade moderada-baixa, oferecendo isolamento rural com acesso imediato a eixos de transporte).
...
\item[Preço da Terra]  US\$ 6.000-12.000/ha (áreas rurais valorizadas ou com arroios); lotes residenciais em condomínios com valorização crescente.
...
\item[Recursos Locais]  Grande produção de mel, gado de corte/leite e hortifrúti. Elevado potencial para autossuficiência alimentar básica em nível de propriedade.
\item[Segurança]  Cidade tradicionalmente pacífica. Taxa de homicídios no departamento de Cordillera entre as menores do país (\textasciitilde 3,8/100k). Alta coesão social e hospitalidade.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.45°, -56.85°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
infraestrutural. Referencia atual de score: GSS 6.4.
...
\item
  ...
  \tightlist
  \item
    Mapa de hidrografia e bacias do Manduvirá (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/DMH).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
  ...
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Juan_de_Mena}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 6.5 (Localização remota e discreta; excelente
invisibilidade tática e ausência de alvos estratégicos) - B: 7.5
(Baixíssima densidade demográfica; um dos distritos mais vazios da
região oriental) - C: 6.0 (Geologia estável; penalizado pelo risco
moderado de isolamento hídrico fluvial) - D: 6.5 (Recursos naturais
abundantes - gado e água - mas limitados pela infraestrutura logística
local) - E: 5.0 (Município grande territorialmente, mas com
...
tático massivo em terras de pecuária).
...
\item[Densidade]  \textasciitilde 6,56 hab/km² (Densidade baixíssima, oferecendo isolamento tático e privacidade estratégica superior).
...
\item[Preço da Terra]  US\$ 2.000-5.000/ha (áreas de pecuária extensiva ou matas).
...
\item[Segurança]  Zona rural extremamente pacífica e segura. Taxa de homicídios no departamento entre as menores do país (\textasciitilde 3,8/100k). Baixíssimo risco de agitação social urbana.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.9833°, -56.75°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
centro urbano. Referencia atual de score: GSS 6.7.
...
\item
  ...
  \item
    Registro de segurança pública departamental.
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Loma_Grande}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 6.0 (Proximidade com a capital aliada a uma
localização protegida do fluxo direto de rodovias) - B: 7.0 (População
reduzida e densidade controlada; baixíssimo risco de agitação social
urbana) - C: 7.0 (Geologia muito estável e riscos naturais climáticos
típicos manejáveis) - D: 7.5 (Excelentes recursos para agricultura
familiar, solo fértil e abundância hídrica) - E: 6.0 (Ambiente
institucional pacífico e seguro, mas com infraestrutura pública local
moderada)
...
Classificacao: - Moderadamente Seguro (Excelente opção para quem busca
um refúgio rural tranquilo com acesso facilitado a serviços urbanos).
...
\item[Densidade]  \textasciitilde 45,7 hab/km² (Baixa densidade, oferecendo isolamento relativo com acesso rápido à região metropolitana).
...
\item[Preço da Terra]  US\$ 5.000-8.500/ha (terras rurais produtivas); valorização imobiliária para fins residenciais de veraneio.
...
\item[Segurança]  Zona extremamente segura e pacata. Cordillera apresenta taxas de homicídios significativamente menores que a média nacional (\textasciitilde 3,8/100k). Alta coesão social e perfil comunitário conservador.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.1667°, -57.2167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
do isolamento em contraste com a limitação institucional. Referencia
...
\item
  ...
  \tightlist
  \item
    Registro histórico de eventos climáticos severos (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/DMH).
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Mbocayaty_del_Yhaguy}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 6.5 (Localidade remota e discreta; altíssima
invisibilidade tática e ausência de alvos estratégicos) - B: 7.0
(Baixíssima densidade demográfica; risco social urbano e de agitação
desprezível) - C: 6.0 (Geologia estável; penalizado pelo risco de
isolamento por cheias e eventos climáticos extremos) - D: 6.0 (Bons
recursos naturais: gado, coco e água, mas limitado pela infraestrutura
logística de insumos) - E: 4.5 (Município pequeno com infraestrutura
institucional e de saúde limitada)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.0

Classificacao: - Moderadamente Seguro (Ideal para quem busca o máximo de
isolamento demográfico em uma região segura).
...
\item[Fallout]  Ventos predominantes do Norte (Viento Norte, quente/seco no verão) e Sul (frentes frias no inverno). Baixo risco de fallout direto.
\item[População]  3.316 habitantes (Censo 2022 Final). População em declínio, com perfil majoritariamente rural (78\%).
\item[Densidade]  \textasciitilde 13,6 hab/km² (Densidade baixíssima, uma das menores do departamento, ideal para isolamento tático).
...
\item[Preço da Terra]  US\$ 5.000-12.000/ha (áreas rurais agrícolas); áreas próximas ao novo asfalto podem atingir US\$ 23.000/ha.
...
\item[Segurança]  Zona rural extremamente pacata e segura. Taxa de homicídios no departamento de Cordillera entre as menores do país (\textasciitilde 3,8/100k). Coesão comunitária forte e perfil conservador.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.2°, -56.8°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
esteja bloqueada. Referencia atual de score: GSS 6.4.
...
\item
  ...
  \tightlist
  \item
    Relatórios de produção de hortifrúti e mineração (MAG/MADES).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
\item
  ...
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Nueva_Colombia}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 5.5 (Proximidade com a capital aumenta a visibilidade
e o risco logístico como rota de fuga) - B: 6.5 (Densidade controlada e
população pequena; baixíssimo risco de criminalidade violenta) - C: 7.0
(Geologia estável e baixo risco de inundações sistêmicas) - D: 7.5
(Excelentes recursos: solo fértil, fornecedor de hortifrúti, petitgrain
e pedras) - E: 6.0 (Ambiente institucional funcional e seguro, mas com
serviços locais limitados)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.4

Classificacao: - Moderadamente Seguro (Excelente opção para residências
rurais próximas à capital com foco em autossuficiência alimentar).
...
\item[Densidade]  \textasciitilde 59,7 hab/km² (Moderada-baixa, com núcleo urbano pequeno e chácaras de veraneio dispersas).
\item[Vias de Acesso]  Acesso via Rota D037, conectando à Rota PY03 (Emboscada) e à zona de Altos/San Bernardino. Risco elevado de saturação como rota de fuga populacional vinda da região metropolitana em crises severas.
...
\item[Preço da Terra]  US\$ 5.000-8.000/ha (áreas rurais brutas); US\$ 15.000-18.000/ha (chácaras estruturadas ou residenciais de alto padrão).
\item[Hidrologia]  Baixo risco de inundações catastróficas. Áreas de pântanos e biodiversidade ligadas ao Rio Salado (6 km ao sul). Risco de erosão em áreas de pedreiras em eventos de chuva extrema (>1.500 mm/ano).
\item[Clima]  Subtropical subúmido. Verões intensos; suscetibilidade a rajadas de vento (100-120 km/h) em tempestades sazonais.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.1833°, -57.3°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
localidade. Referencia atual de score: GSS 7.3.
...
\item
  ...
  \item
    Registro de segurança pública e governança municipal histórica.
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Piribebuy}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 7.0 (Posição tático-defensiva natural; relevo serrano
e importância histórica como refúgio de governo) - B: 7.5 (Densidade
populacional moderada e gerenciada; forte estabilidade social
tradicional) - C: 7.5 (Geologia estável e segurança absoluta contra
inundações sistêmicas) - D: 7.5 (Recursos hídricos de elite e produção
de derivados de cana; solo diversificado) - E: 7.0 (Forte segurança
institucional e suporte social baseado na identidade histórica nacional)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.3

Classificacao: - Seguro (Altamente recomendado como residência tática e
refúgio histórico próximo à infraestrutura da capital).

\begin{itemize}
\tightlist
\item
  Fonte SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}ATUR (Dados de turismo e infraestrutura histórica).
\item
...
\item[Densidade]  \textasciitilde 123,2 hab/km² (Densidade moderada, oferecendo bom equilíbrio entre serviços urbanos e isolamento rural serrano).
...
\item[Custo de Vida]  Baixo-médio; economia baseada no turismo, pequenas indústrias (cana-de-açúcar/caña) e agricultura.
\item[Preço da Terra]  US\$ 15.000-30.000/ha (áreas turísticas/lazer); US\$ 5.000-8.000/ha (áreas rurais de produção).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.4667°, -57.0333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
complexidade.
\newpage
\secaoDiagnostico{Primero de Marzo}{\mapaDistrito{0315}}{Primero de Marzo é uma localidade que personifica a discrição e a
...
Referencia atual de score: GSS 6.4.
...
\item
  ...
  \tightlist
  \item
    Mapa de bacias hidrográficas do Rio Yhaguy (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/DMH).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
  ...
  \item
    Registro de segurança pública departamental.
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Primero_de_Marzo}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 6.5 (Localização discreta e protegida do fluxo das
grandes rodovias; excelente invisibilidade tática) - B: 7.0 (População
pequena e baixa densidade demográfica; risco social urbano desprezível)
- C: 6.5 (Geologia estável; penalizado pelo risco moderado de inundação
ribeirinha) - D: 7.0 (Bons recursos: abundância hídrica, cana-de-açúcar
e agricultura diversificada) - E: 5.0 (Município pequeno com
infraestrutura institucional e de segurança local limitada)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.4

Classificacao: - Moderadamente Seguro (Ideal para quem busca máxima
privacidade e autossuficiência em solo fértil).
...
\item[Densidade]  \textasciitilde 31,4 hab/km² (Baixa densidade, oferecendo isolamento tático superior em áreas de propriedades médias).
...
\item[Preço da Terra]  US\$ 4.000-7.000/ha (áreas rurais agrícolas ou com arroios).
...
\item[Recursos Locais]  Grande produção de cana-de-açúcar, óleos essenciais (petitgrain) e gado de pequeno/médio porte. Elevado potencial para autossuficiência calórica e hídrica em nível familiar.
\item[Segurança]  Zona extremamente estável e pacífica. Cordillera mantém taxas de homicídios entre as menores do país (\textasciitilde 3,8/100k). Alta coesão comunitária e baixíssima visibilidade para conflitos sociais de massa.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.15°, -56.9167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
e demográfica. Referencia atual de score: GSS 6.7.
...
\item
  ...
  \tightlist
  \item
    Estudos ambientais do Lago Ypacaraí (MADES/CONADERNA).
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:San_Bernardino}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 5.0 (Hub social de elite e alta visibilidade tática;
vulnerável como rota de escape da capital) - B: 5.5 (Densidade urbana
metropolitana e alta população flutuante em crises) - C: 7.0 (Geologia
muito estável e riscos climáticos típicos manejáveis) - D: 7.5
(Excelentes recursos residenciais instalados; abundância hídrica
subterrânea) - E: 8.5 (Forte segurança institucional e privada; ambiente
...
Classificacao: - Moderadamente Seguro (Recomendado para perfis que
buscam infraestrutura de elite, cientes da necessidade de autonomia de
suprimentos).
...
\item[Densidade]  \textasciitilde 101,5 hab/km² (Densidade urbana elevada para os padrões rurais, indicando vulnerabilidade social e de suprimentos em crises agudas).
...
\item[Água]  Dependência de poços artesianos profundos (Aquífero Patiño/Guarani) e sistemas de tratamento.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3°, -57.2833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
nacional em termos de segurança, recursos e infraestrutura. Referencia
...
\item
  ...
  \tightlist
  \item
    Mapa de aptidão do solo e hidrografia (MAG/SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
  ...
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:San_Jose_de_los_Arroyos}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 8.7 (Hub logístico de elite no eixo vital
Assunção-CDE; conexão estratégica) - B: 9.1 (Baixíssima densidade
demográfica combinada com infraestrutura rodoviária duplicada) - C: 7.7
(Geologia muito estável e risco hidrometeorológico controlado) - D: 8.1
(Excelentes recursos: solo fértil, produção de aves, cana e abundância
hídrica) - E: 8.9 (Forte segurança institucional e social; proximidade
com polo administrativo de Cel. Oviedo)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 8.6

Classificacao: - Muito Seguro (Localidade de elite para estabelecimento
de refúgio tático ou produtivo).
...
\item[Densidade]  \textasciitilde 28,0 hab/km² (Baixa densidade, oferecendo excelente isolamento e segurança social).
...
\item[Preço da Terra]  US\$ 5.500-9.500/ha (áreas rurais altamente produtivas ou próximas à rodovia).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.5167°, -56.7333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
protegida pela tranquilidade social da região. Referencia atual de
score: GSS 7.1.
...
\item
  ...
  \item
    Registro de segurança pública departamental.
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Santa_Elena}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 7.5 (Isolamento tático de alto nível; cidade
``invisível'' e fora dos eixos de conflito) - B: 8.5 (Densidade
populacional extremamente baixa; segurança contra riscos de massa
absoluta) - C: 7.0 (Geologia estável e baixo risco de grandes desastres
naturais) - D: 7.0 (Bons recursos de proteína animal e água; limitado
pela escala comercial local) - E: 5.5 (Ambiente social seguro e
pacífico, mas com suporte institucional limitado)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.1

Classificacao: - Seguro (Altamente recomendado para quem busca
isolamento tático absoluto e anonimato em ambiente de paz social).
...
\item[Densidade]  \textasciitilde 39,5 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência de riscos sociais de massa urbana).
...
\item[Preço da Terra]  US\$ 4.000-7.000/ha (terras agrícolas); US\$ 2.500-4.000/ha (áreas de campo natural).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.4°, -56.7833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
complexidade.
\newpage
\secaoDiagnostico{Tobati}{\mapaDistrito{0318}}{Tobati (Cordillera) apresenta perfil operacional consolidado para
...
\item
  ...
  \item
    ...
    acesso: 2026-03-05).
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Tobati}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
\item
  ...
  priorizado quando risco hidro=60/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=90/100 for
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.2667°, -57.0833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
de autossuficiência de pequeno/médio porte. O GSS de 6.4 reflete a
segurança social e institucional superior da região. Referencia atual de
score: GSS 6.4.
...
\item
  ...
  \item
    Registro de segurança pública departamental.
  \end{enumerate}
\end{itemize}}{dist:03_Cordillera:Valenzuela}
\begin{table}[ht!]
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
...
Notas (0-10): - A: 6.5 (Localidade protegida do fluxo das rodovias
principais; alta invisibilidade estratégica) - B: 7.0 (População
reduzida e densidade controlada; baixíssimo risco social urbano) - C:
6.5 (Geologia estável; penalizado pelo risco moderado de cheias de
arroios) - D: 7.0 (Excelentes recursos para fruticultura e água pura;
solo exige manejo de pH) - E: 5.0 (Ambiente institucional pacífico, mas
com infraestrutura pública local limitada)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.4

Classificacao: - Moderadamente Seguro (Excelente para quem busca um
refúgio rural tranquilo com abundância de água).
...
\item[Densidade]  \textasciitilde 34,1 hab/km² (Densidade moderada-baixa, com núcleo urbano pequeno e áreas rurais protegidas).
...
\item[Preço da Terra]  US\$ 12.500-25.000/ha (áreas com arroios e benfeitorias); valores elevados pela proximidade com a capital e apelo turístico.
...
\item[Clima]  Subtropical Úmido. Precipitação anual de 800 a 1.500 mm. Suscetível a temporais com ventos fortes (>100 km/h) vindos do Sul.
...
\item[Segurança]  Uma das zonas mais pacíficas do Paraguai. Taxa de homicídios regional de \textasciitilde 3,8/100k no departamento de Cordillera. Baixa criminalidade e alta coesão comunitária.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.5833°, -56.8667°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
