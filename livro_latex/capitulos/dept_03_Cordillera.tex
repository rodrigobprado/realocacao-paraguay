...
\vfill\clearpage
\section{Cordillera /\allowbreak  pacote 05}

O pacote 05 fecha a leitura documental de , com 19 localidades e uma
malha territorial de transicao entre a area metropolitana e o interior
produtivo.
...
e recursos. Referencia atual de score: GSS 8.9 em 2026-03-05.
...
\item[Resources Locais]  Grande polo de recursos técnicos e segurança. Produção regional de frutas e café de altitude em pequena escala. Altíssima capacidade de resiliência individual sustentada pelo capital acumulado e infraestrutura privada.
...
-25.2°, -57.25°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
\item
  População: 20.347 hab (INE\footnote{Instituto Nacional de Estadística (Instituto Nacional de Estatística), órgão oficial de dados demográficos e censitários.} 2022).
\item
  Densidade: 37,89 hab/\allowbreak km².
\item
  Conectividade: Alta (Ruta PY03).
\item
  Risco Hidro: 8/\allowbreak 10 (Crítico).
\item
  \textbf{Curto Prazo:} Inundações sazonais afetando logística rural.
\item
  \textbf{Médio Prazo:} Pressão migratória de Central em caso de colapso
  urbano (proximidade \textasciitilde67km).
\item
  \textbf{Longo Prazo:} Sustentabilidade do modelo orgânico frente a
  mudanças climáticas extremas.
\end{itemize}

\subsubsection{Diagnostico Integrado}\label{vuln-Arroyos_y_Esteros-diagnostico-integrado}

Arroyos y Esteros é um polo de produção orgânica com excelente
conectividade logística, mas que exige atenção rigorosa à sua
hidrografia. É uma opção sólida para quem busca autossuficiência
agrícola, desde que o terreno seja escolhido fora das áreas de inundação
dos esteros.
...
\subsubsection{Combustível}\label{vuln-Arroyos_y_Esteros-combustuxedvel}
...
\subsubsection{Cobertura Celular}\label{vuln-Arroyos_y_Esteros-cobertura-celular}
...
\subsubsection{Internet}\label{vuln-Arroyos_y_Esteros-internet}
...
\subsubsection{Mercado Imobiliário e Terra
Rural}\label{vuln-Arroyos_y_Esteros-mercado-imobiliuxe1rio-e-terra-rural}
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.0667°, -57.1°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
dept. \\
Índice de segurança & alto & dept. \\
População (Censo 2022) & 20.347 & dist. \\
Idade mediana & N/\allowbreak D & dist. \\
Taxa de fecundidade & N/\allowbreak D & dist. \\
\end{longtable}
\subsubsection{Combustível}
...
atual de score: GSS 7.2 em 2026-03-05.
...
\item[Precipitação — PRECTOTCORR (mm/\allowbreak mês)]  Jan 4.09 | Fev 4.96 | Mar 4.29 | Abr 4.95 | Mai 4.91 | Jun 2.61 | Jul 2.14 | Ago 1.32 | Set 2.58 | Out 5.53 | Nov 6.42 | Dez 5.66. Média anual: \textasciitilde 1.500 mm/\allowbreak ano. Estação chuvosa Out-Mai; seca Jun-Set (mínimo em Ago). Fonte: NASA POWER (acesso em 2026-03-20).
...
\item[Resources Locais]  Grande polo produtor de mudas, flores e ervas medicinais. Produção diversificada de agricultura familiar. Elevadíssimo potencial para autossuficiência hídrica e alimentar regional.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.3833°, -57.1333°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
localidade. Referencia atual de score: GSS 8.0 em 2026-03-05.
...
\item[Resources Locais]  Grande produção de proteína animal e frutas. Elevadíssimo potencial para autossuficiência alimentar básica em nível de propriedade devido à vasta área produtiva e baixa população.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.2333°, -56.8167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
dept. \\
Índice de segurança & alto & dept. \\
População (Censo 2022) & 10.143 habitantes & dist. \\
Idade mediana & N/\allowbreak D & dist. \\
Taxa de fecundidade & N/\allowbreak D & dist. \\
\end{longtable}
\subsubsection{Combustível}
...
\item[Resources Locais]  Líder nacional em extração de pedras brutas e lajas. Produção de gado de engorde e agricultura de subsistência.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.1167°, -57.35°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
dept. \\
Índice de segurança & alto & dept. \\
População (Censo 2022) & 21.182 habitantes & dist. \\
Idade mediana & N/\allowbreak D & dist. \\
Taxa de fecundidade & N/\allowbreak D & dist. \\
\end{longtable}
\subsubsection{Combustível}
...
\item[Resources Locais]  Capital Nacional da Chipa. Excepcional capacidade de processamento de alimentos básicos (milho e mandioca). Grande polo de logística de suprimentos regionais. Elevadíssimo potencial para autossuficiência calórica regional baseado em grãos e proteína animal.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.3833°, -56.9667°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
dept. \\
Índice de segurança & alto & dept. \\
População (Censo 2022) & 19.334 habitantes & dist. \\
Idade mediana & N/\allowbreak D & dist. \\
Taxa de fecundidade & N/\allowbreak D & dist. \\
\end{longtable}
\subsubsection{Combustível}
...
principal. Referencia atual de score: GSS 6.1 em 2026-03-05.
...
\item[Resources Locais]  Produção de coco (óleo e sabão), gado de corte, citros e mandioca. Elevado potencial para autossuficiência alimentar e hídrica em nível de propriedade.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.2667°, -56.9°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
dept. \\
Índice de segurança & alto & dept. \\
População (Censo 2022) & 5.304 habitantes & dist. \\
Idade mediana & N/\allowbreak D & dist. \\
Taxa de fecundidade & N/\allowbreak D & dist. \\
\end{longtable}
\subsubsection{Combustível}
...
\item[Resources Locais]  Grande produção de mel, gado de corte/\allowbreak leite e hortifrúti. Elevado potencial para autossuficiência alimentar básica em nível de propriedade.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.45°, -56.85°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
infraestrutural. Referencia atual de score: GSS 6.4 em 2026-03-05.
...
\item[Resources Locais]  Grande produção de gado de corte, cana-de-açúcar e produtos de subsistência. Elevado potencial para autossuficiência individual em grande escala.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-24.9833°, -56.75°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
centro urbano. Referencia atual de score: GSS 6.7 em 2026-03-05.
...
\item[Resources Locais]  Fornecedor regional de hortaliças, pecuária de pequena escala e agricultura de subsistência. Elevado potencial para autossuficiência hídrica e alimentar básica em nível comunitário.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.1667°, -57.2167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item[Resources Locais]  Gado de corte e leite; exploração tradicional de coco Mbokaja (óleo e ração). Elevado potencial para autossuficiência per capita devido à baixa carga demográfica.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.2°, -56.8°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
esteja bloqueada. Referencia atual de score: GSS 6.4 em 2026-03-05.
...
\item[Resources Locais]  Grande fornecedor de hortaliças para Assunção; produção de petitgrain (óleo essencial) e pedra loza. Elevado potencial para autossuficiência hídrica e alimentar básica.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.1833°, -57.3°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
\tightlist
\item
  \textbf{Cenario curto prazo:} Manutenção da segurança e valorização
  das terras para uso residencial de médio padrão.
\item
  \textbf{Cenario medio prazo:} Pressão urbana vinda de Limpio e
  Assunção sobre as áreas rurais do distrito.
\end{itemize}
...
Nueva Colombia é uma ``zona branca'' estratégica no cinturão verde de
Assunção. Oferece solos de altíssima qualidade e um ambiente social
extremamente pacífico e seguro. Sua viabilidade como refúgio é
sustentada pela capacidade de produção alimentar e pela abundância de
recursos minerais, equilibrada pelo risco tático de sua proximidade com
...
\item[Resources Locais]  Grande polo produtor de aguardente orgânica (Caña Paraguaya) e derivados de cana. Produção diversificada de hortifrúti. Elevado potencial para autossuficiência hídrica e alimentar básica em nível regional e comunitário.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.4667°, -57.0333°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item[Resources Locais]  Grande produção de cana-de-açúcar, óleos essenciais (petitgrain) e gado de pequeno/\allowbreak médio porte. Elevado potencial para autossuficiência calórica e hídrica em nível familiar.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.15°, -56.9167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
e demográfica. Referencia atual de score: GSS 6.7 em 2026-03-05.
...
\item[Resources Locais]  Baixa produção agrícola local. Dependência crítica de logística externa para abastecimento de longo prazo (Mercado de Abasto de Assunção). Ponto crítico negativo para autossuficiência isolada.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.3°, -57.2833°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
atual de score: GSS 8.6 em 2026-03-05.
...
\item[Resources Locais]  Grande produtor de aves (processamento industrial), cana-de-açúcar, mandioca e lácteos artesanais. Elevadíssimo potencial para autossuficiência alimentar e energética (biomassa).
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.5167°, -56.7333°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item[Resources Locais]  Grande produção de proteína animal e alimentos básicos de subsistência. Elevadíssimo potencial para autossuficiência alimentar básica em nível de propriedade devido à vasta área produtiva e baixíssima população.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.4°, -56.7833°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\tightlist
\item
  População municipal/\allowbreak distrital (consolidado operacional): 28632
...
\item
  Densidade demografica (consolidado operacional): 212 hab/\allowbreak km2
...
\item
  ...
  60/\allowbreak 100 (referencia temporal: 2026-03-05; base: DMH/\allowbreak SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.} avisos e
  ocorrencias).
\end{itemize}
...
\subsubsection{Diagnostico Integrado}\label{vuln-Tobati-diagnostico-integrado}

Tobati (Cordillera) apresenta perfil operacional consolidado para
comparacao territorial, com leitura conjunta de infraestrutura, risco
hidroclimatico e capacidade de continuidade de servicos essenciais.

\subsubsection{Por que sim}\label{vuln-Tobati-por-que-sim}
...
\subsubsection{Por que não}\label{vuln-Tobati-por-que-nuxe3o}
...
\subsubsection{Pre-condicoes Minimas de
Decisao}\label{vuln-Tobati-pre-condicoes-minimas-de-decisao}
...
\subsubsection{Recomendação
Técnica}\label{vuln-Tobati-recomendauxe7uxe3o-tuxe9cnica}
...
\subsubsection{Combustível}\label{vuln-Tobati-combustuxedvel}
...
\subsubsection{Cobertura Celular}\label{vuln-Tobati-cobertura-celular}
...
\subsubsection{Internet}\label{vuln-Tobati-internet}
...
\subsubsection{Mercado Imobiliário e Terra
Rural}\label{vuln-Tobati-mercado-imobiliuxe1rio-e-terra-rural}
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.2667°, -57.0833°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item[Resources Locais]  Principal produtor nacional de abacaxi. Elevado potencial para autossuficiência calórica e hídrica em nível familiar.
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords:
-25.5833°, -56.8667°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
