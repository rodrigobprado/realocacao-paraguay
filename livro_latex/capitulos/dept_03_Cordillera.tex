...
\midrule
 \textbf{GSS FINAL} & \textbf{8.9} & \textbf{Seguro (A localidade nº 1 do Paraguai para relocação estratégica; oferece o máximo em segurança, recursos e isolamento geográfico defensivo).} \\ \bottomrule
 \end{tabular}
\end{table}
...
\midrule
 \textbf{GSS FINAL} & \textbf{6.0} & \textbf{Moderadamente Seguro (Ideal para quem busca o máximo de isolamento demográfico em uma região segura).} \\ \bottomrule
 \end{tabular}
\end{table}
\subsubsection{Vulnerabilidades e
...
\midrule
 \textbf{GSS FINAL} & \textbf{8.6} & \textbf{Muito Seguro (Localidade de elite para estabelecimento de refúgio tático ou produtivo).} \\ \bottomrule
 \end{tabular}
\end{table}
\subsubsection{Vulnerabilidades e
