...
\midrule
 \textbf{GSS FINAL} & \textbf{5.7} & \textbf{Moderadamente Seguro (Ideal para quem busca isolamento demográfico em região segura e discreta).} \\ \bottomrule
 \end{tabular}
\end{table}
\subsubsection{Vulnerabilidades e
...
\midrule
 \textbf{GSS FINAL} & \textbf{6.0} & \textbf{Moderadamente Seguro (Ideal para quem busca integração com comunidades produtivas de elite e segurança alimentar).} \\ \bottomrule
 \end{tabular}
\end{table}
\subsubsection{Vulnerabilidades e
...
\midrule
 \textbf{GSS FINAL} & \textbf{5.5} & \textbf{Moderadamente Seguro (Ideal para quem busca isolamento natural e autonomia hídrica absoluta).} \\ \bottomrule
 \end{tabular}
\end{table}
\subsubsection{Vulnerabilidades e
