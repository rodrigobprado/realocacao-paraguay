...
Média anual: 4.93 kWh/m²/dia. Inclinação recomendada: 24° Norte (anual);
34° inverno; 14° verão.
...
Média anual: \textasciitilde1.471 mm/ano. Estação chuvosa Out-Mai; seca
Jun-Set.
\clearpage
...
\bottomrule\noalign{}
\endlastfoot
Taxa de homicídios (por 100k hab) & \textasciitilde7--9 (estimativa,
...
\bottomrule\noalign{}
\endlastfoot
Agrícola alta produtividade & 4.600 & 3.000 -- 6.500 & ↑ \\
Pastagem & 2.200 & 1.500 -- 3.000 & ↑ \\
Mata / reserva & 800 & 400 -- 1.200 & → \\
\end{longtable}
}
...
baixa exposição a riscos naturais. Referencia atual de score: GSS 6.9.
...
\item
  ...
  \tightlist
  \item
    Mapa de solos e aptidão agrícola (MAG/Productiva).
  \end{enumerate}
...
Notas (0-10): - A: 6.0 (Ponto de passagem rodoviário estratégico, mas
não um alvo militar primário) - B: 7.5 (Baixa densidade populacional
rural; risco de agitação social reduzido) - C: 7.5 (Geologia estável e
baixo risco de inundações graves) - D: 7.0 (Base agropecuária sólida;
boa disponibilidade hídrica e potencial proteico) - E: 7.0 (Município
consolidado; liberdade jurídica para estrangeiros limítrofes)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.9

Classificacao: - Moderadamente Seguro (Recomendado para residências
rurais com fácil acesso à capital).
...
\item[Fallout]  Ventos predominantes do Norte/Nordeste (verão) e Sul (inverno). Baixo risco de fallout global direto.
\item[População]  8.703 habitantes (Censo 2022 Final). População majoritariamente rural (89\%).
\item[Densidade]  \textasciitilde 8,7 hab/km² (Baixa densidade, oferecendo excelente isolamento em áreas de fazendas).
...
\item[Preço da Terra]  US\$ 1.500-2.500/ha (campos mecanizáveis); US\$ 1.000-1.300/ha (áreas de pastagem natural).
...
\item[Energia]  Rede nacional (ANDE\footnote{Administración Nacional de Electricidade (Administração Nacional de Eletricidade), companhia estatal de energia.}/Itaipu). Estabilidade moderada por estar próximo a eixos principais.
...
\item[Segurança]  Zona rural com baixos índices de criminalidade urbana violenta. Patrulhamento da FTC/Polícia Nacional na Ruta PY03 garante presença estatal.
\item[Leis Local: Município consolidado. Livre de Restrição de Fronteira]  Fora da faixa de 50km da Lei 2532/05, permitindo plena titularidade para estrangeiros brasileiros.
\end{description}
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.6667°, -56.8667°. Média
...
Taxa de homicídios (est., /100k hab) & \textasciitilde7--9 (estimativa,
...
em cotas de segurança elevadas. Referencia atual de score: GSS 6.9.
...
\item
  ...
  \tightlist
  \item
    Relatórios portuários e de grãos (Salto Aguaray/MOPC).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
  ...
  \tightlist
  \item
    Mapa de inundação histórica do Rio Paraguai (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/DMH).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.5 (Hub portuário estratégico; alvo logístico de
alta visibilidade) - B: 7.0 (População reduzida e densidade gerenciável;
baixo risco social urbano) - C: 6.0 (Geologia estável; penalizado pelo
risco crítico de inundação fluvial) - D: 7.5 (Recursos hídricos e
alimentares abundantes; solo exige manejo) - E: 8.5 (Forte segurança
institucional pela proximidade com a sede do governo departamental)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.9

Classificacao: - Moderadamente Seguro (Ideal para quem busca base
logística com acesso a recursos hídricos).
...
\item[Densidade]  \textasciitilde 9,3 hab/km² (Baixa densidade, com núcleo urbano portuário pequeno e áreas rurais/ribeirinhas).
...
\item[Preço da Terra]  US\$ 1.700-8.000/ha (dependendo da proximidade portuária e qualidade do solo). Média departamental de US\$ 4.600/ha.
\item[Hidrologia]  Risco Crítico de Inundação. Áreas baixas e ribeirinhas vulneráveis a cheias cíclicas do Rio Paraguai. Tempestades intensas podem causar inundações repentinas (>100mm/poucas horas).
...
\item[Qualidade do Solo]  Oxisolos (latossolos); profundos e bem drenados, mas ácidos. Excelente para mandioca e amendoim; exige calagem para soja/milho.
\item[Recursos Locais]  Grande polo exportador de grãos (soja/milho) e pesca comercial/subsistência. Elevado potencial para autossuficiência hídrica e proteica.
\item[Segurança]  Perfil portuário relativamente tranquilo. Taxa de homicídios regional de \textasciitilde 7,9/100k. Presença estatal reforçada pela proximidade com a capital departamental.
\item[Leis Local: Município consolidado. Restrição de Fronteira (Lei 2532/05)]  Aplicável a terras rurais na faixa de 50km da fronteira fluvial. Áreas urbanas liberadas para estrangeiros brasileiros.
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.1167°, -57.0667°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  priorizado quando risco hidro=24/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=83/100 for
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.7333°, -56.0167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  integração com a comunidade local/pequenos produtores).
\item
...
Notas (0-10): - A: 4.5 (Polo agrícola e de processamento de tabaco; alvo
logístico secundário) - B: 5.5 (Densidade moderada com dispersão rural;
risco social por conflitos de terra) - C: 7.0 (Geologia muito estável e
baixo risco de grandes inundações) - D: 7.5 (Recursos produtivos
abundantes e solo mecanizável de alta resposta) - E: 6.0 (Ambiente
institucional estável, mas desafiado por tensões rurais e informalidade)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.0

Classificacao: - Moderadamente Seguro (Recomendado para perfis focados
em produção agrícola e integração rural).
...
\item[Fallout]  Ventos predominantes do Norte (quentes/secos) e Sul (frentes frias).
\item[População]  23.548 habitantes (Censo 2022 Final). Elevada predominância rural (\textasciitilde 90\%).
\item[Densidade]  \textasciitilde 33,5 hab/km² (Moderada, mas com população dispersa em colônias agrícolas).
...
\item[Preço da Terra]  US\$ 1.400-2.500/ha (terras agrícolas brutas); US\$ 3.000-5.000/ha (áreas com infraestrutura e prontas para mecanização).
\item[Hidrologia]  Baixo risco de inundações em grande escala. Risco moderado de isolamento de colônias rurais por chuvas intensas (>100mm/mês frequentes no verão).
\item[Clima]  Subtropical Úmido. Precipitação anual de 1.400-1.600 mm. Suscetível a ventos fortes (90-120 km/h) durante temporais.
...
\item[Leis Local: Município consolidado e polo agrícola. Livre de Restrição de Fronteira]  Fora da faixa de 50km da Lei 2532/05, sem restrições para proprietários estrangeiros brasileiros.
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.1833°, -56.5833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 5.0 (Ponto de conexão regional e polo de produção de
alimentos; alvo logístico secundário) - B: 6.0 (Densidade moderada com
perfil rural estável; baixo risco de agitação urbana) - C: 7.0 (Geologia
estável; clima favorável mas com chuvas intensas sazonais) - D: 7.5
(Recursos diversificados: arroz, cana, gado e água abundante para
irrigação) - E: 6.5 (Ambiente institucional funcional; liberdade de
aquisição legal para estrangeiros)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.3

Classificacao: - Moderadamente Seguro (Recomendado para projetos
agroindustriais e autossuficiência baseada em irrigação).
...
\item[Fallout]  Ventos predominantes de Leste (E) durante a maior parte do ano; ventos do Norte em janeiro/fevereiro. Baixo risco de exposição a fallout de alvos continentais primários.
\item[População]  16.971 habitantes (Censo 2022 Final). População majoritariamente rural (80\%).
\item[Densidade]  \textasciitilde 27,2 hab/km² (Moderada, com dispersão rural significativa em fazendas e assentamentos).
...
\item[Preço da Terra]  US\$ 1.500-3.500/ha (áreas agrícolas/pecuárias); áreas próximas ao asfalto podem atingir US\$ 6.000/ha.
...
\item[Clima]  Subtropical Quente. Verões com temperaturas >35°C frequentes. Inverno seco (junho/julho).
...
\item[Segurança]  Zona rural considerada estável para residentes. Embora o departamento tenha taxas de homicídios elevadas (\textasciitilde 27/100k em 2023), os conflitos são concentrados no norte de San Pedro. Perfil comunitário conservador.
\item[Leis Local: Município consolidado. Livre de Restrição de Fronteira]  Localizado fora da faixa de 50km da Lei 2532/05, permitindo plena propriedade para estrangeiros brasileiros.
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.4333°, -56.8833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.

\begin{itemize}
\tightlist
\item
  \textbf{Homicidios/100k:} \textasciitilde27,0 (Regional/Departamento).
\end{itemize}
\subsubsection{Indicadores Sociais}
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.1°, -57.0667°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=25/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=61/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.5333°, -56.4°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=38/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=61/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.5333°, -56.8167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Duplicar rotas/logistica quando conectividade viaria=88/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Notas (0-10): - A: 5.0 (Entroncamento rodoviário vital; alvo tático e
logístico de alta visibilidade) - B: 5.5 (População em crescimento e
alta exposição em rotas nacionais de trânsito) - C: 7.0 (Geologia muito
estável e baixo risco de grandes desastres naturais) - D: 7.5 (Recursos
diversificados: soja, grãos especiais, citricultura e água abundante) -
E: 7.0 (Ambiente institucional funcional; total liberdade jurídica para
estrangeiros em terras privadas)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.3

Classificacao: - Moderadamente Seguro (Ideal para quem busca base
logística e produtividade agrícola diversificada).
...
\item[Densidade]  \textasciitilde 32,5 hab/km² (Moderada, com alta concentração comercial ao longo do eixo rodoviário).
\item[Vias de Acesso]  Ponto de encontro da Ruta PY03 (Assunção-Norte) e PY08 (Eixo Norte-Sul). Conectividade asfáltica de excelência em tempos de paz, mas risco elevado de controle/bloqueio em crises.
...
\item[Preço da Terra]  US\$ 2.500-5.500/ha (áreas agrícolas mecanizáveis); lotes comerciais urbanos com valorização significativa.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.35°, -56.5°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  \tightlist
  \item
    Mapa de drenagem e riscos hídricos (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/DMH).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 4.5 (Ponto de intersecção rodoviário; alvo logístico
secundário em eixos nacionais) - B: 5.5 (Baixa densidade populacional
rural; risco de agitação social em colônias rurais) - C: 6.0 (Geologia
estável; penalizado pelo risco moderado de inundação ribeirinha) - D:
7.0 (Recursos agrícolas e hídricos abundantes; solo exige manejo
intensivo) - E: 6.0 (Ambiente institucional estável, mas desafiado por
tensões sociais regionais)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 5.7

Classificacao: - Moderadamente Seguro (Recomendado para perfis que
buscam integração agrícola com boa logística).
...
\item[Alvos Estratégicos]  Áreas de cultivo intensivo de citros (limão/laranja) e soja mecanizada; Cruce Lima (Ponto de intersecção estratégico na Ruta PY03); Proximidade com o hub de Santa Rosa del Aguaray.
\item[Fallout]  Ventos predominantes do Norte/Nordeste (quentes) e Leste. Baixo risco de fallout direto de alvos continentais primários.
...
\item[Densidade]  \textasciitilde 12,5 hab/km² (Baixa densidade, oferecendo isolamento relativo em colônias agrícolas).
...
\item[Preço da Terra]  US\$ 5.500-7.000/ha (terras mecanizadas para soja); US\$ 1.900-3.500/ha (áreas mistas/pecuária).
...
\item[Clima]  Subtropical Úmido. Precipitação anual de 1.400-1.600 mm. Tempestades severas de verão com ventos de até 100 km/h.
...
\item[Segurança]  Zona rural tradicionalmente pacata, mas inserida em um departamento com taxas de homicídios moderadas (\textasciitilde 8,5/100k). Vigilância necessária contra furtos de gado e conflitos agrários pontuais.
\item[Leis Local: Município consolidado. Livre de Restrição de Fronteira]  Fora da faixa de 50km da Lei 2532/05, permitindo plena titularidade para brasileiros.
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -23.9833°, -56.3333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.

\begin{itemize}
\tightlist
\item
  \textbf{Homicidios/100k:} \textasciitilde8,5 (Regional).
\end{itemize}
\subsubsection{Indicadores Sociais}
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=66/100.
\item
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -23.9167°, -56.7°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
posicionamento rodoviário. Referencia atual de score: GSS 6.3.
...
\item
  ...
  \tightlist
  \item
    Projetos de investimento em infraestrutura pública (MOPC/BID).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
\tightlist
\item
  \textbf{Funil Logístico:} O controle do entroncamento PY03/PY08 pode
...
Notas (0-10): - A: 4.5 (Entroncamento rodoviário crítico; alvo
estratégico e logístico de alta visibilidade) - B: 5.5 (Alta densidade
metropolitana departamental; risco de convergência em crises) - C: 7.0
(Geologia estável; risco hídrico moderado ligado a arroios urbanos) - D:
8.0 (Recursos agroindustriais e hídricos excepcionais; solo de alta
resposta) - E: 7.0 (Forte presença institucional e serviços de saúde em
franca expansão)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.3

Classificacao: - Moderadamente Seguro (Ideal para quem busca base de
serviços e produção agropecuária consolidada).
...
\item[Fallout]  Ventos predominantes do Nordeste (NE) no verão e Sul/Sudeste (S/SE) no inverno. Baixo risco de fallout direto de alvos internacionais primários.
\item[População]  46.405 habitantes (Censo 2022 Final). É o distrito mais populoso de San Pedro. Perfil 55\% urbano e 45\% rural.
\item[Densidade]  \textasciitilde 17,7 hab/km² (Moderada, com alta concentração no núcleo urbano de Santaní).
...
\item[Custo de Vida]  Médio-baixo (US\$ 600-700/mês para casal); infraestrutura urbana desenvolvida com serviços de utilidade pública acessíveis.
\item[Preço da Terra]  US\$ 5.000-6.500/ha (áreas mecanizadas e produtivas para soja/milho).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.65°, -56.4333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  \tightlist
  \item
    Levantamento pedológico regional (Argissolos/Latossolos).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 6.5 (Localidade remota com alta invisibilidade e
ausência de alvos estratégicos) - B: 7.0 (Baixíssima densidade
demográfica; risco social urbano desprezível) - C: 6.0 (Geologia
estável; penalizado pelo risco de isolamento físico por chuvas) - D: 6.0
(Solo fértil e água pura, mas limitado pela logística de insumos
externa) - E: 5.0 (Município pequeno com infraestrutura institucional e
de segurança limitada)

Calculo: - GSS = ((6.5 * 2.5) + (7.0 * 2.0) + (6.0 * 1.5) + (6.0 * 2.0)
+ (5.0 * 2.0)) / 10 - GSS: 6.1

Classificacao: - Moderadamente Seguro (Ideal para quem busca isolamento
total e autossuficiência básica).
...
\item[Densidade]  \textasciitilde 5,6 hab/km² (Densidade baixíssima, oferecendo excelente isolamento e privacidade estratégica).
...
\item[Preço da Terra]  US\$ 2.500-6.000/ha (terras desenvolvidas para grãos); US\$ 1.000-2.000/ha (áreas de pastagem natural).
...
\item[Qualidade do Solo]  Argissolos e Latossolos (vermelhos/amarelos); férteis, profundos e bem drenados. Alta aptidão para soja, milho, algodão e pastagens.
...
\item[Segurança]  Perfil rural pacato. Comunidade pequena e organizada. Embora o departamento tenha histórico de conflitos, San Pablo encontra-se em zona de menor tensão. Taxa de homicídios regional de \textasciitilde 8,0/100k.
\item[Leis Local: Município consolidado. Livre de Restrição de Fronteira]  Fora da faixa de 50km da Lei 2532/05, sem impedimentos para brasileiros.
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.2333°, -56.6833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Duplicar rotas/logistica quando conectividade viaria=72/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.1°, -57.0833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=21/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=93/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -22.4667°, -56.8°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  conflito.
\item
  Presença de riscos sociais/insurgentes no departamento exige
  vigilância.
\item
...
\item
  ...
  \tightlist
  \item
    Relatórios de cooperação técnica KOICA/MSPBS.
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.0 (Hub logístico principal e alvo estratégico de
saúde; alta visibilidade tática) - B: 6.0 (População em rápido
crescimento com riscos sociais regionais conhecidos) - C: 7.0 (Geologia
estável e riscos naturais climáticos gerenciáveis) - D: 8.5 (Riqueza de
recursos excepcional: solos de elite, gergelim, grãos e água pura) - E:
7.0 (Forte presença institucional e apoio técnico internacional;
liberdade jurídica total)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.6

Classificacao: - Moderadamente Seguro (Altamente recomendado como base
produtiva e de serviços para o Norte paraguaio).
...
\item[Densidade]  \textasciitilde 26,0 hab/km² (Moderada, com núcleo urbano comercial denso sobre as rodovias).
...
\item[Serviços]  Melhor infraestrutura hospitalar do interior paraguaio (Hospital Paraguai-Coreia/KOICA). Presença consolidada de bancos, silos e comércio agroindustrial.
...
\item[Preço da Terra]  US\$ 4.000-8.000/ha (terras agrícolas mecanizadas); US\$ 1.500-3.500/ha (áreas de pecuária/mistas).
...
\item[Leis Local: Município em rápido desenvolvimento e com forte apoio institucional internacional (Coreia do Sul). Livre de Restrição de Fronteira]  Fora da faixa de 50km da Lei 2532/05, sem restrições para brasileiros.
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -23.8833°, -56.4833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=48/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=87/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -23.45°, -56.7333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=49/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=89/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.8°, -56.5167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  priorizado quando risco hidro=23/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=94/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.4167°, -57.1167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Referencia atual de score: GSS 6.9.
...
Notas (0-10): - A: 6.0 (Ponto de conexão estratégica PY08 e divisa
departamental; visibilidade moderada) - B: 7.5 (Baixa densidade
populacional rural; risco de agitação social reduzido) - C: 7.5
(Geologia estável e baixo risco de inundações sistêmicas graves) - D:
7.0 (Bons recursos: solo fértil mecanizável, pecuária e cultivos
diversificados) - E: 7.0 (Município consolidado e estável; plena
liberdade jurídica para estrangeiros)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.9

Classificacao: - Moderadamente Seguro (Excelente opção para refúgios
rurais produtivos no Sul de San Pedro).
...
\item[Densidade]  \textasciitilde 20,4 hab/km² (Baixa densidade, oferecendo excelente isolamento em áreas de fazendas e colônias).
...
\item[Preço da Terra]  US\$ 4.000-7.000/ha (terras mecanizadas para soja); US\$ 1.500-3.000/ha (áreas de pastagem ou mata).
...
\item[Leis Local: Município consolidado. Livre de Restrição de Fronteira]  Fora da faixa de 50km da Lei 2532/05, sem impedimentos legais para proprietários brasileiros.
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.8167°, -56.3333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.

\begin{itemize}
\tightlist
\item
  \textbf{Preço Terra Rural:} US\$ 1.500-7.000/ha.
\end{itemize}
\subsubsection{Indicadores Sociais}
...
região. Referencia atual de score: GSS 6.8.
...
\item
  ...
  \tightlist
  \item
    Mapa de solos e aptidão do Centro-Norte (MAG/Productiva).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 6.0 (Posição de hub de transição entre três
departamentos; visibilidade estratégica moderada) - B: 7.0 (Densidade
rural moderada; risco social urbano e de agitação controlado) - C: 7.5
(Geologia muito estável e baixo risco de grandes inundações) - D: 7.5
(Recursos agrícolas em expansão acelerada; abundância de grãos e
proteína animal) - E: 6.5 (Ambiente institucional funcional; total
liberdade jurídica para estrangeiros)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.8

Classificacao: - Moderadamente Seguro (Excelente para perfis focados em
agronegócio e autossuficiência produtiva).
...
\item[Fallout]  Ventos predominantes do Norte/Nordeste (quentes e úmidos) e Sul (frentes frias). Baixo risco de fallout direto de alvos continentais primários.
\item[População]  12.271 habitantes (Censo 2022 Final).
\item[Densidade]  \textasciitilde 24,1 hab/km² (Densidade moderada-baixa, com população dispersa em áreas de expansão agrícola).
...
\item[Custo de Vida]  Baixo (US\$ 550-800/mês para padrão médio); alimentos básicos produzidos localmente favorecem a economia doméstica.
\item[Preço da Terra]  US\$ 4.500-6.500/ha (terras mecanizadas para soja); US\$ 1.200-2.500/ha (áreas de pecuária ou mistas).
...
\item[Segurança]  Zona rural considerada estável e mais tranquila que o norte do departamento. Riscos focados em conflitos de terra esporádicos e crimes contra o patrimônio em fazendas (abigeato). Taxa de homicídios regional de \textasciitilde 7,9/100k.
\item[Leis Local: Município consolidado pela Lei Orgânica 3966/10. Livre de Restrição de Fronteira]  Fora da faixa de 50km da Lei 2532/05, permitindo plena titularidade para investidores brasileiros.
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -24.4833°, -56.1833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
