...
Média anual: 4.96 kWh/m²/dia. Inclinação recomendada: 26° Norte (anual);
36° inverno; 16° verão.
...
Média anual: \textasciitilde1.573 mm/ano. Estação chuvosa Out-Mai; seca
Jun-Set.
\clearpage
...
\bottomrule\noalign{}
\endlastfoot
Taxa de homicídios (por 100k hab) & 1,74 (2022, fonte INE\footnote{Instituto Nacional de Estadística (Instituto Nacional de Estatística), órgão oficial de dados demográficos e censitários.}/Prosegur) \\
...
Referencia atual de score: GSS 7.6.
...
\item
  ...
  \tightlist
  \item
    Mapa de solos e bacias hidrográficas (MAG/Productiva).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 8.0 (Posicionamento estratégico discreto; fora dos
eixos de conflito primário) - B: 8.7 (Baixíssima densidade demográfica e
alta dispersão rural; excelente segurança social) - C: 6.0 (Geologia
estável; penalizado pelo risco moderado de inundação ribeirinha) - D:
6.5 (Recursos agrícolas abundantes, mas limitado pela logística de
insumos técnicos) - E: 8.2 (Forte estabilidade institucional regional e
baixa criminalidade histórica)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 7.6

Classificacao: - Seguro (Localidade recomendada para isolamento rural
produtivo com segurança superior).
...
\item[Densidade]  \textasciitilde 14,1 hab/km² (Densidade baixíssima, oferecendo excelente isolamento tático e baixa visibilidade).
...
\item[Preço da Terra]  US\$ 2.500-6.000/ha (terras mecanizadas/pastagens); US\$ 15.000/ha (áreas com infraestrutura ou beira de asfalto).
...
\item[Clima]  Subtropical Úmido. Média de 1.600 mm/ano. Inverno com quedas bruscas de temperatura (frentes frias do Sul).
...
\item[Segurança]  Zona rural extremamente pacífica. Guairá tem uma das menores taxas de homicídios do país (\textasciitilde 3,6/100k). Crime comum focado em abigeato (roubo de gado).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.9333°, -56.4833°. Média
...
Taxa de homicídios (est., /100k hab) & 1,74 (2022, fonte INE\footnote{Instituto Nacional de Estadística (Instituto Nacional de Estatística), órgão oficial de dados demográficos e censitários.}/Prosegur) &
dept. \\
...
a robustez econômica e a segurança da localidade. Referencia atual de
score: GSS 6.9.
...
\item
  ...
  \tightlist
  \item
    Relatórios de produção de biocombustíveis (Petropar/MIC).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.0 (Hub industrial estatal Petropar; alvo
estratégico logístico e energético de alta visibilidade) - B: 6.5
(Densidade controlada e estabilidade social garantida pelo mercado
formal de trabalho) - C: 7.0 (Geologia muito estável e risco hídrico
pluvial manejável) - D: 8.5 (Recursos energéticos locais - Etanol - e
solo de elite; abundância alimentar e hídrica) - E: 7.5 (Forte segurança
institucional e baixa criminalidade regional histórica)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.9

Classificacao: - Moderadamente Seguro (Ideal para quem busca base
produtiva com autonomia energética local).
...
\item[Densidade]  \textasciitilde 56,7 hab/km² (Baixa densidade, oferecendo isolamento tático e baixa visibilidade tática fora do núcleo industrial).
...
\item[Preço da Terra]  US\$ 4.500-9.000/ha (áreas mecanizadas de "terra roja" e próximas ao asfalto).
...
\item[Segurança]  Zona industrial e agrícola estável. Guairá mantém uma das menores taxas de criminalidade do país (\textasciitilde 5,3/100k). Influência forte da Petropar na coesão social e emprego local.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.6333°, -56.25°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
diário a serviços urbanos sem interrupções. Referencia atual de score:
GSS 5.2.
...
Notas (0-10): - A: 5.8 (Proximidade com usina industrial estratégica;
visibilidade logística secundária) - B: 4.8 (Densidade moderada, mas
penalizada pela vulnerabilidade extrema de acesso) - C: 3.5 (Geologia
estável; nota baixa devido ao risco crítico de inundação e isolamento
hídrico) - D: 6.2 (Recursos agrícolas focados em cana; água abundante
mas com risco de contaminação superficial) - E: 5.3 (Ambiente
institucional funcional, mas dependente de recursos externos para gestão
de desastres)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 5.2

Classificacao: - Sensivel (Localidade que exige mitigação hidrológica
robusta e autonomia logística).
...
\item[Densidade]  \textasciitilde 26,6 hab/km² (Baixa densidade, mas com núcleos rurais vulneráveis ao isolamento físico).
...
\item[Preço da Terra]  US\$ 5.000-10.000/ha (terras mecanizáveis para cana); valores elevados pela proximidade com a indústria açucareira de Tebicuary.
...
\item[Clima]  Tropical Úmido. Verões com temperaturas extremas e alta pluviosidade (1.600 mm/ano).
...
\item[Segurança]  Zona rural pacata. Guairá é um dos departamentos mais seguros do Paraguai (\textasciitilde 6,0/100k homicídios). Conflitos sociais ocasionais ligados a preços de cana-de-açúcar e logística industrial.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.75°, -56.6167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
a limitação institucional. Referencia atual de score: GSS 6.0.
...
Notas (0-10): - A: 6.5 (Localização remota e discreta; altíssima
invisibilidade tática e ausência de alvos estratégicos) - B: 7.5
(Baixíssima densidade demográfica; o distrito mais vazio de Guairá) - C:
6.5 (Geologia estável e riscos climáticos típicos manejáveis) - D: 6.0
(Solo fértil e abundância hídrica básica, limitado pela infraestrutura
logística de insumos) - E: 4.0 (Município pequeno com infraestrutura
institucional e de saúde mínima)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.0

Classificacao: - Moderadamente Seguro (Ideal para quem busca o máximo de
isolamento demográfico e discrição em uma região segura).

\begin{itemize}
\tightlist
\item
  Fonte MOPC infraestrutura: Pavimentação urbana recente (2025).
\end{itemize}
...
\item[Densidade]  \textasciitilde 17,4 hab/km² (Densidade baixíssima, oferecendo excelente isolamento social e privacidade estratégica).
...
\item[Preço da Terra]  US\$ 3.000-6.000/ha (áreas rurais agrícolas); valorização potencial devido às recentes melhorias nas vias de acesso.
...
\item[Segurança]  Zona rural extremamente pacífica e segura. Taxa de homicídios no departamento de Guairá entre as menores do país (\textasciitilde 3,6/100k). Coesão social forte e baixíssima visibilidade para conflitos externos.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.7333°, -56.35°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Duplicar rotas/logistica quando conectividade viaria=59/100 for
...
Notas (0-10): - A: 7.7 - B: 7.5 - C: 7.0 - D: 6.7 - E: 7.9

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (59/100) e exposicao hidro
(37/100). - B (infraestrutura): combina conectividade (59/100) e escala
populacional (180336 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (37/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (73.0 hab/km2) e risco hidro. - E
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.75°, -56.5167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
pacíficas do país. Referencia atual de score: GSS 6.5.
...
\item
  ...
  \tightlist
  \item
    Mapa de hidrografia e nascentes (MADES/Portal Geoestadístico).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 6.5 (Proteção natural massiva pela Cordilheira do
Ybytyruzú; excelente invisibilidade tática) - B: 7.0 (Baixa densidade
demográfica e alta estabilidade social rural; risco social urbano nulo)
- C: 6.0 (Geologia muito estável; penalizado pelo risco moderado de
enxurradas orográficas) - D: 7.0 (Excelentes recursos hídricos de
nascente e proteína animal; solo limitado pela topografia) - E: 5.0
(Município estável e seguro, mas com infraestrutura institucional e de
saúde limitada)
...
natural massivo e autonomia hídrica).
...
\item[Densidade]  \textasciitilde 24,2 hab/km² (Baixa densidade, oferecendo isolamento tático superior em áreas de mata e serrania).
...
\item[Custo de Vida]  Baixo; economia baseada no ecoturismo e agropecuária de subsistência/pequena escala.
\item[Preço da Terra]  US\$ 1.000-2.500/ha (campos e áreas de mata); US\$ 5.000-10.000/ha (áreas com potencial turístico ou infraestrutura residencial).
...
\item[Energia]  Rede nacional (Itaipu); instabilidade frequente em áreas de serrania durante eventos climáticos (ventos/raios).
...
\item[Segurança]  Uma das zonas mais seguras do Paraguai. Taxa de homicídios no departamento de Guairá entre as menores do país (\textasciitilde 3,6/100k). Comunidade rural coesa e avessa a agitações externas.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.8833°, -56.2833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=61/100.
\item
...
Notas (0-10): - A: 7.9 - B: 9.0 - C: 5.1 - D: 7.6 - E: 8.2

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (92/100) e exposicao hidro
(61/100). - B (infraestrutura): combina conectividade (92/100) e escala
populacional (197496 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (61/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (109.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.7°, -56.1833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Referencia atual de score: GSS 6.6.
...
E - Institucional & 8.5 & Altíssima segurança institucional e coesão social comunitária/religiosa \\
...
Notas (0-10): - A: 5.5 (Localização discreta e protegida de rotas
principais, mas com visibilidade turística alta) - B: 6.5 (População
pequena e densidade controlada; risco social urbano desprezível) - C:
5.5 (Geologia estável; penalizado pelo risco crítico de inundação
fluvial cíclica) - D: 7.5 (Excelentes recursos hídricos, pesca e solo
fértil para autossuficiência) - E: 8.5 (Altíssima segurança
institucional e coesão social comunitária/religiosa)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.6

Classificacao: - Moderadamente Seguro (Ideal para quem busca paz social
e recursos hídricos, com preparo para riscos de cheias).
...
\item[Densidade]  \textasciitilde 37,5 hab/km² (Baixa densidade, oferecendo isolamento relativo com bom suporte social local).
...
\item[Preço da Terra]  US\$ 4.000-8.000/ha (áreas rurais); lotes próximos ao santuário e rio possuem valorização turística elevada.
...
\item[Segurança]  Zona extremamente pacífica. Taxa de homicídios no departamento de Guairá entre as menores do Paraguai (\textasciitilde 3,6/100k). Coesão social muito alta baseada em tradições culturais e na influência do santuário nacional.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.85°, -56.6167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 7.6 - B: 6.9 - C: 8.4 - D: 6.2 - E: 8.0

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (39/100) e exposicao hidro
(20/100). - B (infraestrutura): combina conectividade (39/100) e escala
populacional (198580 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (20/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (43.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -26.0667°, -56.4833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=55/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=77/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Notas (0-10): - A: 7.7 - B: 7.0 - C: 5.6 - D: 7.3 - E: 7.0

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (77/100) e exposicao hidro
(55/100). - B (infraestrutura): combina conectividade (77/100) e escala
populacional (73941 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (55/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (308.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.9833°, -56.1167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Uso recomendado como candidato em analise multicriterio, condicionado ao
cumprimento das pre-condicoes acima. Referencia atual de score: GSS 8.6;
risco predominante: baixo.
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=26/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=91/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Notas (0-10): - A: 9.0 - B: 8.8 - C: 7.9 - D: 8.1 - E: 8.8

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (91/100) e exposicao hidro
(26/100). - B (infraestrutura): combina conectividade (91/100) e escala
populacional (184084 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (26/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (90.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
Classificacao: - Muito Seguro (alto potencial de resiliencia).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.7167°, -56.4°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
a segurança institucional da localidade. Referencia atual de score: GSS
6.3.
...
\item
  ...
  \tightlist
  \item
    Relatórios de produção de cana e vitivinicultura (MAG/MIC).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.5 (Posicionamento estratégico na PY08 e proximidade
com hub industrial de Troche) - B: 6.5 (População pequena e densidade
controlada; baixo risco de agitação urbana) - C: 7.0 (Geologia muito
estável e riscos climáticos típicos manejáveis) - D: 7.0 (Excelentes
recursos: solo de elite, produção de cana, vinho e água abundante) - E:
5.5 (Ambiente institucional seguro, mas com infraestrutura pública local
limitada)
...
agroindustrial com segurança social).
...
\item[Densidade]  \textasciitilde 53,4 hab/km² (Baixa densidade, com núcleo urbano pequeno e áreas rurais produtivas dispersas).
...
\item[Preço da Terra]  US\$ 5.000-9.000/ha (áreas mecanizadas de "terra roja"); lotes urbanos/industriais com valorização moderada.
...
\item[Segurança]  Zona extremamente pacífica e estável. Taxa de homicídios no departamento entre as menores do país (\textasciitilde 3,6/100k). Baixa incidência de crimes violentos.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.6333°, -56.3167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.

\begin{itemize}
\tightlist
\item
  \textbf{Homicidios/100k:} \textasciitilde3,6 (Regional/Guairá).
\end{itemize}
\subsubsection{Indicadores Sociais}
...
física e institucional da localidade. Referencia atual de score: GSS
7.6.
...
conectado; fora de eixos de conflito) - B: 7.8 (Baixíssima densidade
demográfica e alta estabilidade social; isolamento tático superior) - C:
6.2 (Geologia muito estável e riscos climáticos manejáveis) - D: 7.8
(Excelentes recursos: solo fértil, água de cordilheira e proteína
animal) - E: 7.7 (Forte estabilidade institucional regional e baixa
...
busca isolamento rural com segurança superior e recursos naturais
abundantes).
...
\item[Densidade]  \textasciitilde 23,1 hab/km² (Baixa densidade, oferecendo excelente isolamento tático e privacidade estratégica).
...
\item[Preço da Terra]  US\$ 2.500-5.000/ha (áreas rurais); US\$ 8.000-12.000/ha (áreas próximas à rota ou com potencial turístico).
...
\item[Clima]  Subtropical subúmido. Microclima influenciado pela proximidade com as elevações do Ybytyruzú. Precipitação média 1.600 mm/ano.
...
\item[Segurança]  Zona extremamente pacífica e segura. Taxa de homicídios no departamento entre as menores do país (\textasciitilde 3,6/100k). Coesão social forte e baixa visibilidade externa.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.9333°, -56.3167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
ambiente. Referencia atual de score: GSS 6.0.
...
Notas (0-10): - A: 5.5 (Riqueza mineral estratégica; alvo tático
prioritário em conflitos por recursos e ouro) - B: 6.5 (População
significativa e densidade controlada; risco social por migração laboral)
- C: 5.0 (Geologia estável; nota penalizada pelo risco crítico de
contaminação hídrica industrial) - D: 7.5 (Recursos minerais
excepcionais - Ouro - e solo fértil para erva-mate e proteína) - E: 5.0
(Município sob tensão de segurança e desafios institucionais ligados ao
extrativismo)
...
táticos com interesse na extração de recursos minerais).
...
\item[Densidade]  \textasciitilde 30,7 hab/km² (Moderada, com alta concentração em áreas de garimpo e núcleos urbanos).
...
\item[Preço da Terra]  US\$ 1.300-2.500/ha (áreas de mata ou relevo acidentado); valores muito superiores em áreas com potencial mineral comprovado.
...
\item[Clima]  Subtropical Úmido. Média pluvial de 1.600 mm/ano. Tempestades severas podem causar deslizamentos em áreas de encosta mineradas.
...
\item[Segurança]  Zona de Risco Moderado a Alto. Histórico de conflitos por posse de terras e direitos minerários. Presença de grupos irregulares e aumento de assaltos violentos registrados em 2025/2026. Exige segurança privada robusta e perfil tático defensivo.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.7167°, -55.9833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
local. Referencia atual de score: GSS 5.8.
...
Notas (0-10): - A: 6.0 (Posicionamento estratégico discreto e fora de
eixos de conflito; boa invisibilidade tática) - B: 7.0 (População
reduzida e densidade controlada; baixíssimo risco social urbano) - C:
6.5 (Geologia muito estável; riscos climáticos sazonais moderados) - D:
6.0 (Bons recursos naturais - gado e água - mas limitado pela
infraestrutura logística local) - E: 4.0 (Município pequeno com
infraestrutura institucional e de saúde limitada)
...
\item[Alvos Estratégicos]  Áreas de produção pecuária; Antiga estação ferroviária (valor histórico/patrimonial). Ausência absoluta de alvos militares ou industriais de grande porte, oferecendo excelente invisibilidade tática e discrição.
\item[Fallout]  Ventos predominantes do Leste (E) e Nordeste (NE). Baixo risco de fallout direto.
...
\item[Densidade]  \textasciitilde 18,3 hab/km² (Densidade baixíssima, oferecendo isolamento social tático e privacidade).
...
\item[Preço da Terra]  US\$ 3.000-5.800/ha (áreas mecanizáveis ou pastagens consolidadas).
\item[Hidrologia]  Baixo risco de inundações sistêmicas catastróficas. Presença de arroios locais que favorecem a pequena pecuária. Danos pontuais em estradas de terra durante temporais severos (média pluvial 1.600 mm/ano).
...
\item[Segurança]  Zona rural extremamente pacífica. Taxa de homicídios no departamento de Guairá entre as menores do país (\textasciitilde 3,6/100k). Coesão comunitária forte baseada em famílias tradicionais da região.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.8333°, -56.5°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
a solidez institucional da localidade. Referencia atual de score: GSS
7.5.
...
Notas (0-10): - A: 7.7 (Hub industrial e logístico estável; alvo tático
secundário, mas com forte proteção institucional) - B: 7.0 (Baixíssima
densidade demográfica combinada com infraestrutura industrial urbana) -
C: 7.7 (Geologia muito estável e riscos naturais climáticos bem
manejados) - D: 7.2 (Excelentes recursos agrícolas e hídricos; solo de
elite para cana e grãos) - E: 7.8 (Forte segurança institucional e
estabilidade social baseada no emprego formal)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.5

Classificacao: - Seguro (Localidade altamente recomendada para quem
busca estabilidade econômica e segurança institucional).
...
\item[Densidade]  \textasciitilde 33,4 hab/km² (Baixa densidade, com núcleo urbano industrial compacto e ordenado).
...
\item[Preço da Terra]  US\$ 6.000-10.000/ha (terras mecanizadas para cana); lotes urbanos/industriais valorizados pela estabilidade econômica local.
...
\item[Segurança]  Zona industrial extremamente estável e segura. Taxa de homicídios no departamento de Guairá entre as menores do país (\textasciitilde 3,6/100k). Forte coesão social em torno da cultura do trabalho industrial e tradição da AZPA.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.6667°, -56.6333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 5.0 (Capital departamental e nó logístico; alvo
estratégico tático administrativo) - B: 5.5 (Densidade urbana
metropolitana significativa; risco social em crises de suprimento) - C:
7.0 (Geologia muito estável e riscos climáticos manejáveis) - D: 7.5
(Excelentes recursos agroindustriais: açúcar, gado e solos de elite) -
E: 8.0 (Forte segurança institucional e serviços de saúde de alta
complexidade)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.5

Classificacao: - Moderadamente Seguro (Ideal como base administrativa e
...
\item[Densidade]  \textasciitilde 309 hab/km² (Densidade urbana elevada, indicando alta vulnerabilidade social em cenários de ruptura de suprimentos urbana).
...
\item[Preço da Terra]  US\$ 3.000-8.000/ha (terras rurais produtivas); lotes residenciais valorizados em condomínios de montanha (US\$ 40.000-50.000/lote).
...
\item[Segurança]  Um dos departamentos mais seguros do país. Taxa de homicídios regional entre 6,6 e 7,8/100k. Ambiente urbano com perfil cultural e universitário elevado, reduzindo a incidência de crimes violentos graves.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.75°, -56.4333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Referencia atual de score: GSS 7.3.
...
Notas (0-10): - A: 7.5 (Posicionamento estratégico discreto mas bem
conectado; baixa visibilidade tática militar) - B: 8.9 (Densidade
demográfica equilibrada e excelente segurança social urbana) - C: 5.1
(Geologia estável; nota penalizada por riscos hidrometeorológicos
moderados sazonais) - D: 6.4 (Bons recursos naturais e abundância
hídrica; limitado pela escala produtiva local) - E: 8.2 (Altíssima
segurança institucional e estabilidade comunitária exemplar)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.3

Classificacao: - Seguro (Localidade altamente recomendada para quem
busca qualidade de vida, cultura e segurança superior).
...
\item[Densidade]  \textasciitilde 37,6 hab/km² (Baixa densidade, com núcleo urbano histórico e áreas rurais integradas).
...
\item[Preço da Terra]  US\$ 5.000-10.000/ha (áreas rurais); lotes urbanos com valorização cultural e residencial.
...
\item[Clima]  Subtropical Úmido. Verões quentes; média pluvial de 1.600 mm/ano bem distribuída.
...
\item[Segurança]  Zona extremamente segura. Guairá mantém uma das menores taxas de criminalidade do país (\textasciitilde 3,6/100k). Alta coesão social comunitária e preservação da ordem pública baseada em tradições locais.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.7°, -56.3833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
