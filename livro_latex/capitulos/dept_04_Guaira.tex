...
\midrule
 \textbf{GSS FINAL} & \textbf{7.6} & \textbf{Seguro (Localidade recomendada para isolamento rural produtivo com segurança superior).} \\ \bottomrule
 \end{tabular}
\end{table}
...
\midrule
 \textbf{GSS FINAL} & \textbf{6.9} & \textbf{Moderadamente Seguro (Ideal para quem busca base produtiva com autonomia energética local).} \\ \bottomrule
 \end{tabular}
\end{table}
\subsubsection{Vulnerabilidades e
...
\midrule
 \textbf{GSS FINAL} & \textbf{6.5} & \textbf{Moderadamente Seguro (Ideal para quem busca isolamento natural massivo e autonomia hídrica).} \\ \bottomrule
 \end{tabular}
\end{table}
\subsubsection{Vulnerabilidades e
...
E - Institucional & 8.8 & - \\
\midrule
 \textbf{GSS FINAL} & \textbf{8.6} & \textbf{Muito Seguro (alto potencial de resiliencia).} \\ \bottomrule
 \end{tabular}
\end{table}
\subsubsection{Vulnerabilidades e
...
\midrule
 \textbf{GSS FINAL} & \textbf{7.3} & \textbf{Seguro (Localidade altamente recomendada para quem busca qualidade de vida, cultura e segurança superior).} \\ \bottomrule
 \end{tabular}
\end{table}
\subsubsection{Vulnerabilidades e
