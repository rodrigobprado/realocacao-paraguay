...
Média anual: 4.90 kWh/m²/dia. Inclinação recomendada: 27° Norte (anual);
37° inverno; 17° verão.
...
Média anual: \textasciitilde1.416 mm/ano. Estação chuvosa Out-Jan; seca
Jul-Ago.
\clearpage
...
mais baixa do país) \\
Crimes registrados (total/ano) & muito baixo (população pequena e
ambiente rural) \\
...
ou projetos de pecuária/rizicultura. Exige planejamento de construção
...
Notas (0-10): - A: 7.5 (Isolamento geográfico estratégico; longe de
alvos militares primários e eixos de fallout) - B: 7.5 (População
pequena e gerenciável; baixa densidade demográfica total) - C: 5.0
(Risco crítico de inundação; nota penalizada pela dependência de muros
de defesa) - D: 7.0 (Excelentes recursos de proteína animal e água; hub
de suprimentos importados) - E: 6.5 (Comunidade resiliente e segura;
forte presença institucional de fronteira)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.9

Classificacao: - Moderadamente Seguro (Recomendado para quem busca
isolamento tático, desde que mitigados os riscos hídricos).
...
\item[Densidade]  \textasciitilde 33,9 hab/km² (Densidade baixa, embora concentrada no núcleo urbano orla-rio). Oferece excelente isolamento social em relação aos grandes centros urbanos paraguaios.
\item[Vias de Acesso]  A nova Ruta PY19 (pavimentada) rompeu o isolamento histórico, conectando Alberdi a Villeta/Assunção ao norte e a Pilar ao sul. Acesso fluvial contínuo para a Argentina.
...
\item[Preço da Terra]  US\$ 1.500-2.500/ha (campos para pecuária/arroz); US\$ 35-55/m² (Urbano).
...
\item[Clima]  Subtropical Úmido. Verões intensos e úmidos; invernos suaves. Média de precipitação de 1.500 mm/ano.
\item[Energia]  Rede nacional (Itaipu/Yacyretá); vulnerável a interrupções em tempestades devido à extensão das linhas de transmissão rurais.
...
\item[Leis Local: Município consolidado com regime de comércio de fronteira. Restrição de Fronteira (Lei 2532/05)]  Aplicável a terras rurais na faixa de 50km da fronteira argentina.
\end{description}
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -26.1667°, -58.1333°. Média
...
Taxa de homicídios (est., /100k hab) & 0,2--0,4 (2019--2020, fonte INE
...
localidade. Referencia atual de score: GSS 7.1.
...
\item
  ...
  \tightlist
  \item
    Relatórios de monitoramento fluvial do Rio Paraná (EBY/ANNP).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 7.5 (Posição tática protegida por colina; margem do
rio e isolamento geográfico superior; baixa visibilidade de alvos) - B:
8.5 (Densidade populacional extremamente baixa; isolamento social de
alto nível e privacidade absoluta) - C: 6.0 (Risco hidrológico elevado;
nota penalizada pela vulnerabilidade a inundações sazonais severas) - D:
7.5 (Excelentes recursos pesqueiros e de proteína animal; água fluvial
ilimitada) - E: 6.0 (Ambiente social seguro e estável, mas com suporte
institucional limitado regionalmente)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.1

Classificacao: - Seguro (Altamente recomendado para quem busca
isolamento tático fluvial e anonimato em ambiente natural seguro).
...
\item[Densidade]  \textasciitilde 6,4 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência de riscos sociais de massa urbana).
...
\item[Preço da Terra]  US\$ 2.000-4.000/ha (áreas com costa de rio); US\$ 800-1.200/ha (campos baixos).
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); instável em áreas rurais remotas.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -27.3333°, -57.6667°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 8.0 (Isolamento tático profundo; baixíssima
visibilidade estratégica e ausência de alvos) - B: 8.5 (Densidade
populacional próxima de zero; segurança contra riscos de massa absoluta)
- C: 6.0 (Risco hidrológico elevado; nota penalizada pela
vulnerabilidade a inundações sazonais) - D: 7.5 (Excelentes recursos de
proteína animal e água; limitado pela inacessibilidade comercial) - E:
7.0 (Ambiente social estável e pacífico; governança comunitária
funcional para o isolamento)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.5

Classificacao: - Seguro (Altamente recomendado para quem busca
isolamento tático radical e anonimato absoluto, aceitando os desafios do
isolamento hídrico).
...
\item[Densidade]  \textasciitilde 4,2 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência total de riscos sociais de massa urbana).
...
\item[Preço da Terra]  US\$ 700-1.100/ha (campos baixos para pecuária). Valores de entrada entre os menores do Paraguai oriental.
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); instável em áreas rurais isoladas.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -27.0333°, -58.0333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
...
e riscos naturais. Referencia atual de score: GSS 6.5.
...
Notas (0-10): - A: 7.5 (Localização remota e discreta; excelente
invisibilidade tática e ausência de alvos estratégicos) - B: 8.0
(Densidade demográfica extremamente baixa; isolamento social superior) -
C: 4.5 (Risco crítico de inundação e isolamento pluvial; solo saturável)
- D: 6.5 (Bons recursos de proteína animal; limitado pela infraestrutura
de transporte) - E: 5.5 (Ambiente social seguro e estável, mas com
serviços institucionais mínimos)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.5

Classificacao: - Moderadamente Seguro (Ideal para perfis que busquem
isolamento total e autossuficiência pecuária, aceitando os desafios
logísticos).
...
\item[Densidade]  \textasciitilde 10,8 hab/km² (Densidade extremamente baixa, ideal para isolamento social tático e privacidade absoluta).
...
\item[Preço da Terra]  US\$ 800-1.200/ha (campos baixos para pecuária). Valores de entrada muito baixos comparados à região metropolitana.
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); instável e sujeita a cortes frequentes devido à exposição das linhas rurais.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -27.1667°, -58.4167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.

\begin{itemize}
\tightlist
\item
  \textbf{Homicidios/100k:} \textasciitilde4,0 (Muito abaixo da média
  nacional).
\end{itemize}
\subsubsection{Indicadores Sociais}
...
dos humedales. Referencia atual de score: GSS 6.4.
...
\item
  ...
  pesada/trator e manutenção de estoque de segurança de suprimentos e
...
Notas (0-10): - A: 7.5 (Isolamento tático de alto nível; invisibilidade
total e ausência de alvos estratégicos) - B: 8.5 (Densidade populacional
próxima de zero; segurança contra riscos de massa absoluta) - C: 4.0
(Risco hidrológico extremo; nota penalizada pela vulnerabilidade a
inundações sazonais) - D: 6.5 (Abundância de proteína animal; limitado
pela inacessibilidade a insumos técnicos) - E: 5.0 (Ambiente social
estável e seguro, mas com suporte institucional mínimo)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.4

Classificacao: - Moderadamente Seguro (Indicado para refúgio tático
extremo de baixo perfil, exigindo alta autonomia logística).
...
\item[Densidade]  \textasciitilde 1,2 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência de riscos sociais de massa).
...
\item[Preço da Terra]  US\$ 700-1.000/ha (campos baixos para pecuária extensiva). Um dos menores valores de terra da Região Oriental.
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); altamente instável devido ao isolamento das linhas rurais e falta de redundância.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -26.9833°, -58.1833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
recursos naturais da localidade. Referencia atual de score: GSS 7.9.
...
Notas (0-10): - A: 8.0 (Posição tática defensiva histórica; curva do rio
e isolamento geográfico superior; baixíssima visibilidade de alvos
industriais) - B: 8.5 (Densidade populacional extremamente baixa;
isolamento social de alto nível e privacidade absoluta) - C: 7.0
(Geologia muito estável e segurança relativa contra inundações na zona
urbana histórica) - D: 8.5 (Recursos hídricos e de proteína animal
ilimitados; solo diversificado para pastagens) - E: 7.5 (Forte segurança
institucional naval e suporte social baseado na identidade heroica)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.9

Classificacao: - Seguro (Altamente recomendado para quem busca
isolamento tático fluvial e anonimato em ambiente histórico seguro).
...
\item[Densidade]  \textasciitilde 7,4 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência de riscos sociais de massa urbana).
\item[Vias de Acesso]  Acesso via Ruta PY04 e ramais de terra/empedrados secundários. Localização em "bolsão de segurança" geográfico, afastada dos grandes eixos de trânsito comercial, o que favorece o anonimato estratégico. Acesso fluvial contínuo.
...
\item[Preço da Terra]  US\$ 1.500-3.000/ha (áreas com costa de rio); US\$ 800-1.200/ha (campos baixos).
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); instável em áreas remotas.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -27.0667°, -58.5°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 8.5 (Posição tática excepcional; ``ilha'' de solo
firme, isolamento de baixo perfil e proximidade com suporte
institucional capital) - B: 9.0 (Densidade populacional extremamente
baixa; isolamento social de alto nível e privacidade absoluta) - C: 7.5
(Segurança superior contra inundações na região dos esteros; geologia
muito estável) - D: 8.5 (Excelentes recursos de proteína animal e água
mineral; solo diversificado) - E: 9.0 (Máxima segurança social e suporte
institucional capital adjacente; governança comunitária exemplar)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 8.6

Classificacao: - Seguro (A localidade nº 2 do Paraguai para relocação
estratégica; oferece o máximo em privacidade, recursos básicos e
proximidade com infraestrutura capital).
...
\item[Densidade]  \textasciitilde 4,5 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência de riscos sociais de massa urbana).
...
\item[Preço da Terra]  US\$ 1.500-2.500/ha (campos pecuários); US\$ 30-50/m² (Urbano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -26.9°, -58.2°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  privado e sistema de evacuação aérea/fluvial).
\item
...
Notas (0-10): - A: 7.0 (Isolamento geográfico profundo; invisibilidade
estratégica total e ausência de alvos) - B: 8.0 (Densidade populacional
insignificante; segurança contra riscos de massa absoluta) - C: 3.5
(Risco hidrológico extremo; nota penalizada pela vulnerabilidade a
inundações prolongadas) - D: 6.0 (Bons recursos de gado; severamente
limitado pela inacessibilidade a insumos) - E: 2.0 (Nota penalizada no
ranking nacional para refletir a dependência extrema de cadeias externas
e infraestrutura de saúde mínima local - GSS 5.5 total)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 5.5

Classificacao: - Moderadamente Seguro (Indicado apenas para projetos de
isolamento tático extremo que possuam autonomia total de saúde e
logística).
...
\item[Densidade]  \textasciitilde 2,9 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência total de riscos sociais de massa urbana).
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); sujeita a interrupções prolongadas devido à localização em final de rede rural e dificuldade de manutenção de acesso.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -27.25°, -58.0167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.

\begin{itemize}
\tightlist
\item
  \textbf{Homicidios/100k:} \textasciitilde0,0 (Paz absoluta).
\end{itemize}
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 7.0 (Posição tática estratégica; margem do rio e
isolamento geográfico satisfatório; baixíssima visibilidade de alvos) -
B: 8.0 (Densidade populacional baixa; isolamento social de bom nível e
privacidade garantida) - C: 6.5 (Geologia estável; nota penalizada pela
vulnerabilidade a inundações ribeirinhas) - D: 7.5 (Excelentes recursos
de proteína animal e água fluvial ilimitada) - E: 7.0 (Estabilidade
institucional e segurança regional funcional próxima à capital)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.3

Classificacao: - Seguro (Altamente recomendado para quem busca
isolamento tático rural com proximidade logística a Pilar).
...
\item[Densidade]  \textasciitilde 16,8 hab/km² (Densidade baixa, garantindo privacidade absoluta e ausência de riscos sociais de massa urbana).
...
\item[Preço da Terra]  US\$ 1.500-2.500/ha (áreas ribeirinhas); US\$ 800-1.200/ha (campos baixos).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -27.0167°, -58.3333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  \tightlist
  \item
    Registros históricos de cheias dos rios Paraguai e Paraná (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/DMH).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 7.0 (Posicionamento geopolítico estratégico em
confluência fluvial; remoto e discreto) - B: 8.0 (População minúscula e
densidade demográfica irrelevante; isolamento social superior) - C: 4.0
(Risco hidrológico extremo; nota penalizada pela vulnerabilidade a
cheias dos dois grandes rios) - D: 7.0 (Recursos hídricos e de proteína
animal ilimitados; limitado pelo acesso logístico) - E: 5.0 (Ambiente
social estável e seguro, mas com suporte institucional local mínimo)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.3

Classificacao: - Moderadamente Seguro (Ideal para quem busca isolamento
tático fluvial e abundância de recursos hídricos, aceitando os riscos
das cheias).

\begin{itemize}
\tightlist
\item
  Fonte MOPC infraestrutura: Relatórios de acessibilidade em Ñeembucú
  Sul.
\end{itemize}
...
\item[Densidade]  \textasciitilde 7,5 hab/km² (Densidade extremamente baixa, garantindo privacidade tática absoluta e ausência de riscos sociais urbanos).
...
\item[Custo de Vida]  Muito baixo; economia baseada na pesca, pecuária extensiva e serviços de turismo histórico/pesca.
\item[Preço da Terra]  US\$ 1.500-2.500/ha (áreas com costa de rio); US\$ 800-1.200/ha (campos baixos de interior).
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); instável e sujeita a cortes frequentes devido à localização em final de linha rural.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -27.2667°, -58.5667°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
combinação de suporte estatal (saúde/educação) com abundância de
recursos básicos (água/proteína). O único fator de atenção crítica é o
...
hídrico. Referencia atual de score: GSS 7.7.
...
\item
  ...
  PY04/PY19 (Mitigação: aproveitar a infraestrutura portuária para
...
Notas (0-10): - A: 8.0 (Capital departamental remota e discreta;
isolamento tático superior e baixa visibilidade de alvos continentais) -
B: 7.5 (População gerenciável e densidade baixa; excelente
infraestrutura institucional regional) - C: 5.5 (Risco crítico de
inundação; nota penalizada pela dependência vital de sistemas de
bombeamento) - D: 8.5 (Recursos excepcionais: hub portuário, proteína
animal abundante e suporte industrial têxtil) - E: 8.5 (Máxima segurança
institucional e serviços de saúde de referência regional)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.7

Classificacao: - Seguro (Localidade de elite para suporte logístico e
residência tática, desde que mitigados os riscos hídricos).

\begin{itemize}
\tightlist
\item
  Fonte MOPC infraestrutura: Projeto de Defesa Costeira de Pilar (Fase
  II).
\end{itemize}
...
\item[Densidade]  \textasciitilde 30,7 hab/km² (Densidade baixa, oferecendo excelente equilíbrio entre infraestrutura urbana e isolamento social periférico).
...
\item[Preço da Terra]  US\$ 2.000-3.500/ha (áreas com potencial agrícola/pecuário); US\$ 40-80/m² (Urbano).
...
\item[Clima]  Subtropical Úmido. Verões muito quentes e úmidos; invernos suaves com entradas de ar frio que limpam a atmosfera. Precipitação média 1.500 mm/ano.
\item[Energia]  Rede nacional (Itaipu/Yacyretá); nodo central de distribuição departamental com melhor estabilidade que o interior do departamento.
...
\item[Leis Local]  Capital departamental com regime de incentivo industrial. \\ \textbf{Livre de Restrição} de Fronteira para propriedades urbanas centrais, mas vigilância em zonas rurais ribeirinhas (Lei 2532/05). \\ \textit{Aquisição de terra rural proibida para estrangeiros limítrofes.}
\end{description}
...
Média anual: 4.90 kWh/m²/dia. Mínimo: Jun (2.73) \textbar{} Máximo:
Jan/Dez (6.76).

\textbf{Precipitação (mm/mês → mm/ano \textasciitilde1.416):}
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -26.85°, -58.2833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 8.0 (Isolamento tático de alto nível; centro
geográfico dos esteros e baixíssima visibilidade estratégica) - B: 8.5
(Densidade populacional extremamente baixa; segurança contra riscos de
massa absoluta) - C: 6.0 (Risco hidrológico elevado; nota penalizada
pela vulnerabilidade a inundações sazonais severas) - D: 8.0 (Excelentes
recursos de proteína animal e abundância hídrica superficial) - E: 7.5
(Ambiente social muito seguro e estável; suporte institucional funcional
para o contexto rural)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.7

Classificacao: - Seguro (Altamente recomendado para quem busca
isolamento tático radical e autossuficiência proteica, aceitando os
desafios do isolamento hídrico).
...
\item[Densidade]  \textasciitilde 2,9 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência de riscos sociais de massa urbana).
...
\item[Preço da Terra]  US\$ 800-1.200/ha (campos baixos para pecuária extensiva).
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); altamente instável devido ao isolamento da rede rural e dificuldade de manutenção de acessos.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -26.65°, -57.9333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
...
hidrológica dos esteros. Referencia atual de score: GSS 6.3.
...
Notas (0-10): - A: 7.0 (Localização remota, mas com bom acesso via PY04;
excelente invisibilidade tática) - B: 8.0 (Densidade populacional
extremamente baixa; isolamento social superior) - C: 4.5 (Risco crítico
de inundação nos esteros; nota penalizada pela saturação do solo) - D:
6.5 (Bons recursos de proteína animal; limitado pela falta de
diversidade comercial local) - E: 5.0 (Ambiente social seguro e estável,
mas com suporte institucional local mínimo)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.3

Classificacao: - Moderadamente Seguro (Ideal para quem busca isolamento
rural com facilidade de acesso logístico via rodovia pavimentada).
...
\item[Densidade]  \textasciitilde 2,7 hab/km² (Densidade extremamente baixa, ideal para isolamento social tático e privacidade absoluta fora do eixo rodoviário).
...
\item[Custo de Vida]  Muito baixo; economia baseada na pecuária e agricultura de subsistência.
\item[Preço da Terra]  US\$ 1.000-1.500/ha (campos baixos para pecuária e arroz).
...
\item[Clima]  Subtropical Úmido. Verões intensos; invernos amenos com alta umidade relativa (média 1.500 mm/ano).
\item[Energia]  Rede nacional (Itaipu/Yacyretá); sujeita a interrupções frequentes em áreas rurais devido à exposição da rede.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -26.85°, -58.1333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\small \begin{tabular}{p{3.0cm}p{0.8cm}p{6.0cm}} \toprule
\textbf{Critério} & \textbf{Nota} & \textbf{Justificativa} \\ \midrule
A - Ameaças Estratégicas & 8.5 & Isolamento tático extremo e ausência total de interesse estratégico/militar \\
...
Notas (0-10): - A: 8.5 (Isolamento tático extremo e ausência total de
interesse estratégico/militar) - B: 9.0 (Densidade populacional ínfima;
segurança contra riscos de massa absoluta) - C: 3.5 (Risco hidrológico
crítico; nota penalizada pela vulnerabilidade total a cheias) - D: 6.5
(Vastidão de terras para gado; limitado pela inacessibilidade a
mercados) - E: 4.5 (Ambiente social estável e pacífico, mas com suporte
institucional quase inexistente)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.7

Classificacao: - Moderadamente Seguro (Indicado exclusivamente para
projetos de isolamento tático extremo que busquem o máximo anonimato,
aceitando a barreira das águas).
...
\item[Densidade]  \textasciitilde 0,7 hab/km² (Densidade próxima de zero, garantindo privacidade absoluta e ausência total de riscos sociais de massa urbana).
...
\item[Preço da Terra]  US\$ 700-1.000/ha (campos baixos para pecuária extensiva). Um dos menores valores de terra do país.
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); altamente instável e sujeita a falhas prolongadas devido ao isolamento da rede rural.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -26.2833°, -58.2°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.

\begin{itemize}
\tightlist
\item
  \textbf{Homicidios/100k:} \textasciitilde0,0 (Paz total).
\end{itemize}
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 8.0 (Isolamento tático estratégico com acesso
asfaltado novo; excelente invisibilidade) - B: 8.5 (Densidade
populacional extremamente baixa; isolamento social de alto nível) - C:
4.5 (Risco crítico de inundação ribeirinha; nota penalizada pela
saturação do solo) - D: 7.0 (Excelentes recursos de proteína animal e
água; limitado pela falta de comércio local) - E: 5.5 (Ambiente social
seguro e estável, mas com serviços institucionais mínimos)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.8

Classificacao: - Seguro (Altamente recomendado para quem busca
isolamento rural produtivo com boa conectividade logística moderna).
...
\item[Densidade]  \textasciitilde 2,1 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e baixíssimo risco social de massa).
\item[Vias de Acesso]  Localização privilegiada sobre a nova Ruta PY19 (pavimentada), que conecta o distrito ao polo de Villeta/Assunção ao norte e a Alberdi/Pilar ao sul. A nova rodovia reduziu o isolamento histórico, mantendo a localidade "fora do radar" populacional.
...
\item[Custo de Vida]  Muito baixo; economia baseada na pecuária bovina e pesca comercial/esportiva.
\item[Preço da Terra]  US\$ 1.500-2.500/ha (áreas com costa de rio ou aptidão para arroz); US\$ 800-1.200/ha (campos baixos para gado).
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); instável em áreas rurais remotas durante temporais.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -26.0167°, -57.85°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
...
invisibilidade tática e ausência de alvos) - B: 8.0 (Densidade
populacional extremamente baixa; isolamento social superior) - C: 4.0
(Risco hidrológico extremo; nota penalizada pela vulnerabilidade a
inundações prolongadas) - D: 6.0 (Recursos de gado; limitado pela
inacessibilidade geográfica a insumos técnicos) - E: 4.0 (Ambiente
social seguro e pacífico, mas com suporte institucional quase nulo)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.0

Classificacao: - Moderadamente Seguro (Ideal para quem busca isolamento
tático ``low profile'' extremo, aceitando a precariedade logística).
...
\item[Densidade]  \textasciitilde 4,2 hab/km² (Densidade extremamente baixa, garantindo privacidade absoluta e ausência de riscos sociais de massa urbana).
...
\item[Preço da Terra]  US\$ 800-1.200/ha (campos baixos para pecuária).
...
\item[Energia]  Rede nacional (Itaipu/Yacyretá); sujeita a interrupções frequentes devido à localização em rede rural isolada e exposição climática.
...
\item[Leis Local: Município consolidado. Restrição de Fronteira (Lei 2532/05)]  Aplicável a terras rurais na faixa de 50km da fronteira argentina (limite tático dos esteros).
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -27.0833°, -58.2°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
