...
\tightlist
\item
  Coronel Oviedo é o nó rodoviário nacional (cruzamento PY02/PY08) e
...
Média anual: 4.96 kWh/m²/dia. Inclinação recomendada: 25° Norte (anual);
35° inverno; 15° verão.
...
Mata / reserva & 1.800 & 1.000 -- 3.000 & → \\
\end{longtable}
}
...
institucional da região. Referencia atual de score: GSS 6.8.
...
\item
  ...
  \tightlist
  \item
    Relatórios de indústria madeireira e agrícola (MIC/MAG).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.5 (Hub logístico tático vital na PY02; visibilidade
estratégica elevada) - B: 6.0 (Densidade metropolitana significativa;
risco social em crises de suprimento urbana) - C: 7.0 (Geologia muito
estável e baixo risco de grandes desastres naturais) - D: 8.5 (Recursos
agroindustriais de elite: solos férteis, madeira, proteína animal e
água) - E: 8.0 (Forte segurança institucional e serviços de saúde
...
\item[Densidade]  \textasciitilde 100,5 hab/km² (Densidade urbana elevada, indicando vulnerabilidade social e risco de desabastecimento rápido em crises urbanas agudas).
...
\item[Preço da Terra]  US\$ 4.000-7.000/ha (áreas rurais agrícolas); lotes industriais e residenciais urbanos com alta valorização (US\$ 25.000-50.000/lote).
\item[Hidrologia]  Diversos arroios cruzam o distrito (ex: Tapiracuái). Baixo risco de inundações catastróficas sistêmicas, mas vulnerabilidade localizada em bairros baixos durante tempestades severas (média pluvial 1.600 mm/ano).
...
\item[Água]  Captação via poços artesianos profundos e sistemas de distribuição urbana (ESSAP\footnote{Empresa de Servicios Sanitarios del Paraguay (Empresa de Serviços Sanitários do Paraguai), responsável pelo saneamento e água urbana.}/Juntas).
...
\item[Segurança]  Cidade com dinamismo comercial intenso. Criminalidade urbana comum presente (furtos/roubos). Estabilidade social sustentada pelo setor industrial e agropecuário. Patrulhamento policial reforçado por ser um corredor logístico internacional.
...
Taxa de homicídios (est., /100k hab) & \textasciitilde6--8 (estimativa,
...
local. Referencia atual de score: GSS 6.7.
...
principais; alta invisibilidade estratégica) - B: 7.5 (Baixíssima
densidade demográfica; risco social urbano desprezível) - C: 7.0
(Geologia muito estável e riscos climáticos típicos manejáveis) - D: 7.0
(Bons recursos naturais - gado e água - mas limitado pela logística de
insumos técnicos) - E: 5.5 (Ambiente institucional seguro, mas com
infraestrutura pública local limitada)
...
\item[Densidade]  \textasciitilde 11,8 hab/km² (Densidade baixíssima, oferecendo isolamento social superior e privacidade estratégica).
\item[Vias de Acesso]  Acesso facilitado pela Ruta PY08 (Dr. Blas Garay). Dependência de estradas vicinais de terra para o interior do distrito, que podem apresentar dificuldades de trafegabilidade em períodos de chuva extrema (média 1.600 mm/ano).
...
\item[Preço da Terra]  US\$ 2.000-4.000/ha (áreas de pecuária ou mata); US\$ 5.500/ha (áreas com aptidão agrícola mecanizada).
...
\item
  ...
  \tightlist
  \item
    Mapa geológico e de riscos hídricos (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/DMH).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
  ...
  \tightlist
  \item
    Registro de investimentos em saúde pública (BID/MOPC).
  \end{enumerate}
...
Notas (0-10): - A: 4.5 (Entroncamento logístico nevrálgico nacional;
alvo estratégico prioritário de alta visibilidade) - B: 5.5 (População
regional elevada e densidade urbana significativa; risco social em
crises) - C: 7.0 (Geologia muito estável e baixo risco de grandes
desastres naturais) - D: 7.5 (Riqueza em recursos: hub de suprimentos,
água abundante e solos de elite) - E: 8.0 (Forte segurança institucional
e melhor infraestrutura hospitalar do interior)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.3

Classificacao: - Moderadamente Seguro (Ideal como centro de operações
administrativas e de saúde para o projeto).
...
\item[Densidade]  \textasciitilde 111,9 hab/km² (Densidade urbana elevada, indicando alta vulnerabilidade social e pressão sobre serviços em crises de massa).
...
\item[Preço da Terra]  US\$ 5.000-10.000/ha (áreas rurais valorizadas); lotes urbanos e industriais com preços de mercado metropolitano.
...
\item[Segurança]  Centro urbano dinâmico com criminalidade urbana típica (furtos/roubos). Segurança institucional forte através da Direção de Polícia Departamental. Sensível a bloqueios rodoviários e manifestações sociais devido ao papel estratégico do cruzamento rodoviário.
...
\item
  ...
  priorizado quando risco hidro=34/100.
\item
  Duplicar rotas/logistica quando conectividade viaria=74/100 for
...
Notas (0-10): - A: 8.2 - B: 6.6 - C: 7.3 - D: 6.8 - E: 7.2

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (74/100) e exposicao hidro
(34/100). - B (infraestrutura): combina conectividade (74/100) e escala
populacional (50274 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (34/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (29.0 hab/km2) e risco hidro. - E
...
institucional da localidade. Referencia atual de score: GSS 6.9.
...
\item
  ...
  \tightlist
  \item
    Relatórios de produção de laticínios e grãos (Lactolanda/CAPAINLAC).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.0 (Hub agroindustrial vital; alvo estratégico de
interesse nacional para controle de suprimentos) - B: 6.5 (População
significativa e densidade controlada; forte coesão social
cooperativista) - C: 7.0 (Geologia muito estável e baixo risco de
grandes desastres naturais) - D: 9.0 (Recursos alimentares excepcionais:
Lactolanda, moinhos e solos de elite; autossuficiência de nível
superior) - E: 7.5 (Forte segurança institucional e social sustentada
pelo setor privado cooperativo)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.9

Classificacao: - Moderadamente Seguro (Localidade de elite para suporte
logístico e produção de recursos de sobrevivência).
...
\item[Densidade]  \textasciitilde 61,8 hab/km² (Densidade moderada, com núcleo urbano industrial compacto e colônias rurais altamente produtivas).
...
\item[Preço da Terra]  US\$ 6.000-10.000/ha (áreas de elite mecanizadas); lotes industriais com alta valorização nacional.
...
\item[Clima]  Subtropical Úmido. Chuvas abundantes e bem distribuídas (1.600-1.800 mm/ano). Verões com alta incidência solar, favorecendo a produtividade agrícola.
\item[Energia]  Rede nacional (Itaipu); subestações industriais de alta carga. Muitas unidades produtivas possuem sistemas de geração térmica/biomassa de reserva.
...
Notas (0-10): - A: 8.1 - B: 8.0 - C: 7.0 - D: 6.8 - E: 8.1

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (74/100) e exposicao hidro
(38/100). - B (infraestrutura): combina conectividade (74/100) e escala
populacional (172480 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (38/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (388.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
Notas (0-10): - A: 5.0 (Posicionamento estratégico na PY02 e proximidade
com reservatório vital; visibilidade tática moderada) - B: 6.5
(População pequena e densidade controlada; risco social urbano
desprezível) - C: 7.0 (Geologia muito estável e riscos naturais
climáticos típicos manejáveis) - D: 7.5 (Excelentes recursos: solo
fértil, abundância hídrica massiva e potencial de pesca) - E: 6.0
(Ambiente institucional estável, mas dependente de serviços de cidades
vizinhas)
...
integração agrícola com abundância de recursos hídricos).
...
\item[Densidade]  \textasciitilde 45,4 hab/km² (Baixa densidade, oferecendo isolamento relativo em áreas de colônias).
...
\item[Preço da Terra]  US\$ 4.000-7.000/ha (áreas rurais agrícolas); US\$ 2.000-3.500/ha (áreas de campo/pecuária).
...
\item[Recursos Locais]  Produção de gado de corte, grãos e pesca comercial/subsistência no lago. Elevado potencial para autossuficiência alimentar e hídrica em nível de propriedade.
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=29/100.
\item
...
Notas (0-10): - A: 7.7 - B: 5.2 - C: 7.7 - D: 7.7 - E: 6.5

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (52/100) e exposicao hidro
(29/100). - B (infraestrutura): combina conectividade (52/100) e escala
populacional (10884 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (29/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (238.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
Notas (0-10): - A: 8.7 - B: 6.9 - C: 8.2 - D: 7.0 - E: 7.6

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (80/100) e exposicao hidro
(23/100). - B (infraestrutura): combina conectividade (80/100) e escala
populacional (60561 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (23/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (410.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=28/100.
\item
...
Notas (0-10): - A: 7.8 - B: 6.6 - C: 7.8 - D: 6.2 - E: 7.5

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (54/100) e exposicao hidro
(28/100). - B (infraestrutura): combina conectividade (54/100) e escala
populacional (122918 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (28/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (19.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
institucional local. Referencia atual de score: GSS 5.7.
...
Notas (0-10): - A: 6.0 (Localização discreta e fora dos eixos de
conflito primário; excelente invisibilidade tática) - B: 7.0 (População
pequena e baixíssima densidade; risco social urbano desprezível) - C:
6.5 (Geologia muito estável; penalizado pelo risco moderado de
isolamento pluvial) - D: 6.5 (Bons recursos: soja, milho e gado, porém
limitado pela infraestrutura logística local) - E: 4.5 (Município
pequeno com infraestrutura institucional e de saúde mínima)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 5.7

Classificacao: - Moderadamente Seguro (Ideal para quem busca o máximo de
isolamento demográfico em uma região agrícola próspera).

\begin{itemize}
\tightlist
\item
  Fonte MOPC infraestrutura: Pavimentação trecho Nueva Toledo-Vaquería
  (2024).
\end{itemize}
...
\item[Densidade]  \textasciitilde 8,0 hab/km² (Densidade baixíssima, oferecendo isolamento tático superior e privacidade estratégica).
\item[Vias de Acesso]  Acesso via Rota D024, recentemente beneficiada pela pavimentação asfáltica do trecho Nueva Toledo – Vaquería (20 km). Conectividade interna dependente de estradas vicinais de terra que podem ser críticas em períodos chuvosos intensos (média 1.600 mm/ano).
...
\item[Preço da Terra]  US\$ 5.000-8.500/ha (áreas rurais mecanizadas para soja); US\$ 2.500-4.000/ha (áreas de pecuária ou campo natural).
...
Notas (0-10): - A: 7.9 - B: 6.0 - C: 8.4 - D: 6.2 - E: 7.2

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (51/100) e exposicao hidro
(20/100). - B (infraestrutura): combina conectividade (51/100) e escala
populacional (77186 hab). - C (riscos naturais): derivada da exposicao
...
região próspera. Referencia atual de score: GSS 6.5.
...
Notas (0-10): - A: 6.0 (Localização discreta e fora dos eixos de
conflito primário; boa invisibilidade estratégica) - B: 7.0 (População
...
- D: 7.5 (Riqueza em recursos: solo de elite, gado e proximidade com o
reservatório de Yguazú) - E: 5.0 (Município consolidado com segurança
social, mas infraestrutura de serviços dependente de vizinhos)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.5

Classificacao: - Moderadamente Seguro (Ideal para quem busca isolamento
demográfico em terras de altíssima produtividade).
...
\item[Densidade]  \textasciitilde 20,1 hab/km² (Baixa densidade, oferecendo excelente isolamento tático e privacidade estratégica).
\item[Vias de Acesso]  Acesso via ramais da Ruta PY13. Conectividade interna por estradas de terra batida que exigem manutenção e veículos robustos em períodos de chuva intensa (média 1.600 mm/ano).
...
\item[Preço da Terra]  US\$ 5.000-8.000/ha (terras mecanizadas de elite); US\$ 2.500-4.000/ha (áreas de campo natural/pecuária).
...
\tightlist
\item
  \textbf{Homicidios/100k:} \textasciitilde8,5 (Regional/Caaguazú).
\end{itemize}
\subsubsection{Indicadores Sociais}
...
projetos de autossuficiência de médio/largo porte que priorizam a
...
médio/grande porte que busquem isolamento demográfico em uma região
...
densidade demográfica em território vasto; isolamento social superior) -
C: 7.0 (Geologia muito estável e riscos naturais climáticos típicos
manejáveis) - D: 7.0 (Bons recursos: abundância hídrica, gado e solos
aptos para policultivos) - E: 5.5 (Ambiente institucional seguro, mas
...
\item[Densidade]  \textasciitilde 24,2 hab/km² (Baixa densidade, considerando a grande extensão territorial, oferecendo excelente isolamento tático).
\item[Vias de Acesso]  Acesso asfáltico conectando à cidade de Caaguazú e à Ruta PY02. Malha interna de estradas de terra batida que exigem manutenção contra erosão e veículos robustos em períodos chuvosos (média 1.600 mm/ano).
...
\item[Preço da Terra]  US\$ 2.500-5.000/ha (áreas rurais agrícolas/mistas); US\$ 1.200-2.000/ha (áreas de pastagem natural ou campo baixo).
...
pequeno/médio porte que valorizem a segurança social e a paz rural.
...
limitação institucional local. Referencia atual de score: GSS 6.2.
...
Notas (0-10): - A: 6.0 (Posicionamento estratégico discreto e protegido
de fluxos rodoviários massivos; alta invisibilidade tática) - B: 6.5
(População pequena e densidade controlada; baixíssimo risco social
urbano) - C: 7.0 (Geologia muito estável e riscos naturais climáticos
manejáveis) - D: 6.5 (Bons recursos naturais - gado e água - mas
limitado pela infraestrutura logística de acesso) - E: 5.0 (Município
histórico seguro, mas com infraestrutura institucional e de saúde básica
limitada)
...
Classificacao: - Moderadamente Seguro (Ideal para quem busca isolamento
rural estável em região historicamente segura).
...
\item[Densidade]  \textasciitilde 52,9 hab/km² (Densidade moderada-baixa, oferecendo isolamento relativo em áreas de propriedades tradicionais).
...
\item[Preço da Terra]  US\$ 3.000-5.500/ha (áreas rurais agrícolas); US\$ 1.500-2.500/ha (áreas de pastagem natural).
\item[Hidrologia]  Baixo risco de inundações sistêmicas catastróficas. Presença de arroios locais que favorecem a pequena pecuária. Risco moderado de isolamento de caminhos vicinais de terra em tempestades severas (média pluvial 1.600 mm/ano).
...
\item[Segurança]  Zona extremamente pacífica e estável. Taxa de homicídios regional de \textasciitilde 8,5/100k. Coesão social baseada na tradição histórica e religiosa (missão jesuítica). Baixíssima incidência de crimes violentos graves.
...
\item
  ...
  (bloqueios/refugiados). Mitigação: Mapear rotas secundárias por
  caminhos de terra.
\item
...
\item[Densidade]  \textasciitilde 15,70 hab/km² (Baixa densidade, excelente para segurança social e isolamento relativo).
...
\item[Seguranca]  Taxa de homicídios departamental de 3,5/100k hab (2022). Baixa criminalidade urbana.
...
\item[Densidade]  \textasciitilde 28,4 hab/km².
...
\item
  Duplicar rotas/logistica quando conectividade viaria=50/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Notas (0-10): - A: 7.8 - B: 6.1 - C: 8.1 - D: 7.2 - E: 7.3

Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (50/100) e exposicao hidro
(24/100). - B (infraestrutura): combina conectividade (50/100) e escala
populacional (92643 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (24/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (293.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
um ambiente de isolamento natural. Referencia atual de score: GSS 6.5.
...
\item
  ...
  \tightlist
  \item
    Mapa hidrológico do reservatório de Yguazú (ANDE\footnote{Administración Nacional de Electricidade (Administração Nacional de Eletricidade), companhia estatal de energia.}/SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 6.0 (Posicionamento peninsular discreto e protegido;
excelente invisibilidade tática) - B: 7.0 (População pequena e baixa
densidade demográfica; risco social urbano nulo) - C: 6.5 (Geologia
muito estável; penalizado pelo risco moderado de isolamento hídrico e
tempestades) - D: 8.0 (Recursos alimentares e hídricos excepcionais;
capital nacional da banana) - E: 5.0 (Município recente com
...
Classificacao: - Moderadamente Seguro (Ideal para quem busca isolamento
demográfico em região de alta produtividade de alimentos).
...
\item[Densidade]  \textasciitilde 29,0 hab/km² (Baixa densidade, oferecendo isolamento tático superior e privacidade estratégica facilitada pela geografia peninsular).
...
\item[Preço da Terra]  US\$ 4.000-7.000/ha (áreas mecanizáveis ou com plantios de banana consolidados); áreas próximas ao lago com valorização turística e residencial.
...
\item[Clima]  Subtropical Úmido com forte influência termorreguladora da massa de água do lago. Verões quentes e chuvosos (média 1.700 mm/ano).
\item[Energia]  Rede nacional (Itaipu); instável em áreas rurais remotas.
...
\item[Densidade]  \textasciitilde 35,0 hab/km².
...
\item[Sismicidade]  Nula/Baixa.
\item[Solo]  Oxisois/Alfisois, altamente produtivos.
...
\item
  ...
  locais.
\item
  \textbf{Comunicação:} Sinal de telefonia/internet instável em áreas
...
\item[Densidade]  \textasciitilde 9,1 hab/km² (Extremamente baixa, ideal para segurança e isolamento).
...
\item
  Mapeamento de solos (MAG/INE\footnote{Instituto Nacional de Estadística (Instituto Nacional de Estatística), órgão oficial de dados demográficos e censitários.}).
\item
...
\item[Densidade]  \textasciitilde 33,2 hab/km².
...
\item[Seguranca]  Zoneamento urbano e rural seguro. Taxa de homicídios acompanhando a média departamental baixa (3,5/100k).
