...
Média anual: 4.87 kWh/m²/dia. Inclinação recomendada: 26° Norte (anual);
36° inverno; 16° verão.
...
Média anual: \textasciitilde1.587 mm/ano. Estação chuvosa Out-Mai; seca
Jun-Set.
\clearpage
...
pequeno/médio porte com foco em fruticultura ou pecuária sustentável.
...
naturais da localidade. Referencia atual de score: GSS 7.3.
...
\item
  ...
  \tightlist
  \item
    Mapa de bacias hidrográficas do Rio Pirapó (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/DMH).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Classificacao: - Seguro (Localidade recomendada para quem busca
...
\item[Alvos Estratégicos]  Áreas de produção citrícola (Laranja/Tangerina); Ponto de conexão rodoviária entre Caazapá e Itapúa. Ausência de alvos militares primários, oferecendo boa invisibilidade tática.
...
\item[Densidade]  \textasciitilde 27,6 hab/km² (Baixa densidade, oferecendo excelente isolamento relativo em áreas de produção agrícola).
\item[Vias de Acesso]  Acesso via ramais asfálticos e estradas vicinais de terra batida. Obras recentes de pavimentação no trecho Lima - Tatú Kua melhoraram a logística regional. Risco de isolamento parcial em eventos de chuva extrema (>1.600 mm/ano).
...
\item[Preço da Terra]  US\$ 2.500-4.500/ha (áreas mistas/pecuária); US\$ 5.000-7.500/ha (áreas mecanizáveis ou com citricultura).
...
reflete a força econômica e a segurança da localidade. Referencia atual
de score: GSS 7.4.
...
\item[Densidade]  \textasciitilde 20,1 hab/km² (Baixa densidade, considerando a grande extensão territorial, oferecendo isolamento tático e privacidade estratégica).
\item[Vias de Acesso]  Acesso via ramais asfálticos recentes (Rota da Integração) que melhoraram drasticamente a conexão com Ciudad del Este e polos de Alto Paraná. Conectividade interna por estradas de terra que exigem veículos robustos em períodos chuvosos (média 1.700 mm/ano).
...
\item[Preço da Terra]  US\$ 5.000-8.500/ha (terras mecanizadas de elite); US\$ 2.500-4.000/ha (áreas de campo natural/pecuária).
...
\tightlist
\item
  \textbf{Homicidios/100k:} \textasciitilde7,0 (Regional/Caazapá).
\end{itemize}
\subsubsection{Indicadores Sociais}
...
Altamente indicado para estabelecimentos de autossuficiência de
pequeno/médio porte que valorizem a privacidade demográfica e a
...
recursos e a segurança social da localidade. Referencia atual de score:
GSS 6.7.
...
\item[Densidade]  \textasciitilde 50,1 hab/km² (Densidade moderada-baixa, oferecendo isolamento relativo em propriedades rurais integradas).
...
\item[Custo de Vida]  Muito baixo; economia baseada na citricultura familiar e pecuária de pequena/média escala.
\item[Preço da Terra]  US\$ 3.000-5.500/ha (áreas rurais agrícolas); US\$ 1.500-2.500/ha (áreas de campo natural/mata).
...
\item[Qualidade do Solo]  Latossolo Vermelho e solos podzólicos; férteis e profundos, excelentes para citros (laranja/tangerina), mandioca e pastagens.
...
\item[Segurança]  Zona extremamente pacífica e estável. Taxa de homicídios no departamento de Caazapá entre as menores do país (\textasciitilde 7,0/100k). Coesão social forte baseada em tradições rurais conservadoras. Baixíssima incidência de crimes violentos graves.
...
institucional da localidade. Referencia atual de score: GSS 7.0.
...
Classificacao: - Seguro (Ideal como base administrativa e residencial
...
\item[Densidade]  \textasciitilde 17,4 hab/km² (Baixa densidade, oferecendo isolamento relativo com excelente suporte estatal local).
...
\item[Preço da Terra]  US\$ 4.000-7.000/ha (áreas rurais valorizadas); lotes urbanos com preços estáveis de capital departamental.
...
\item[Segurança]  Uma das capitais mais pacíficas do Paraguai. Taxa de homicídios regional entre as menores do país (\textasciitilde 7,0/100k). Forte segurança institucional e controle social comunitário. Ambiente urbano ordenado e cultural.
...
limitação institucional local. Referencia atual de score: GSS 6.7.
...
\item[Fallout]  Ventos predominantes do Norte (Viento Norte, quente/seco no verão) e Leste. Baixo risco de fallout direto.
\item[População]  5.960 habitantes (Censo 2022 Final). População em declínio, com perfil essencialmente rural (82\%) e laborioso.
\item[Densidade]  \textasciitilde 9,4 hab/km² (Densidade baixíssima, oferecendo isolamento social superior e privacidade estratégica absoluta fora dos núcleos povoados).
\item[Vias de Acesso]  Acesso via ramal asfaltado de 13 km conectando à Ruta PY08 (Blas Garay). Conectividade interna dependente de estradas vicinais de terra que podem sofrer isolamento parcial em períodos de chuva severa (média pluvial 1.600 mm/ano).
...
\item[Preço da Terra]  US\$ 2.500-4.000/ha (áreas de pecuária extensiva); US\$ 5.000/ha (áreas mecanizáveis ou próximas ao asfalto).
...
\item[Segurança]  Zona rural extremamente pacífica e segura. Taxa de homicídios no departamento de Caazapá entre as menores do Paraguai (\textasciitilde 7,0/100k). Coesão social forte baseada em comunidades tradicionais. Baixíssima visibilidade para conflitos externos.
...
\item
  ...
  priorizado quando risco hidro=47/100.
\item
...
(geoestrategia): combina conectividade viaria (72/100) e exposicao hidro
(47/100). - B (infraestrutura): combina conectividade (72/100) e escala
populacional (236455 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (47/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (107.0 hab/km2) e risco hidro. - E
...
(36/100). - B (infraestrutura): combina conectividade (50/100) e escala
populacional (138145 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (36/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (95.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
\item
  Estoque de contingencia para 14 dias (agua/alimentos/combustivel),
  priorizado quando risco hidro=59/100.
\item
...
(59/100). - B (infraestrutura): combina conectividade (80/100) e escala
populacional (207626 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (59/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (386.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
\item[Densidade]  \textasciitilde 27,9 hab/km².
...
\item[Seguranca]  Taxa de homicídios regional estimada em 6,5/100k hab. Segurança rural estável, com foco em conflitos de vizinhança.
...
\item
  Duplicar rotas/logistica quando conectividade viaria=95/100 for
  \textless70; manter rota secundaria mapeada e testada trimestralmente.
\item
  Plano de energia resiliente com autonomia minima de 72h
  (geracao/backup), revisao semestral.
...
Rastreabilidade das notas (base nos indicadores da secao 9): - A
(geoestrategia): combina conectividade viaria (95/100) e exposicao hidro
(26/100). - B (infraestrutura): combina conectividade (95/100) e escala
populacional (111614 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (26/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (65.0 hab/km2) e risco hidro. - E
(ambiente sociopolitico): combinacao conservadora de conectividade,
escala populacional e risco hidro.
...
\item
  Mapeamento hidrológico (DMH/SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}).
\item
...
\item[Densidade]  \textasciitilde 10,4 hab/km² (Excelente para isolamento e segurança social).
