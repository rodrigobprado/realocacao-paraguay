...
\item
  ...
  capital.
\item
  Lacuna de solar/pluviometria de Luque fechada com dados NASA POWER
  (2001-2020).
\end{itemize}

\subsection{Ficha climática de Luque (maior cidade / referencia
departamental)}
...
Média anual: \textasciitilde1.471 mm/ano. Estação chuvosa Out-Nov; seca
Jun-Ago.
\clearpage
...
\bottomrule\noalign{}
\endlastfoot
Taxa de homicídios (por 100k hab) & \textasciitilde3,0 (estimativa,
abaixo da média nacional) \\
Crimes registrados (total/ano) & elevado em números absolutos --- maior
departamento populoso \\
Número de comisarías & \textasciitilde60 (estimativa --- departamento
mais populoso, grande densidade policial) \\
...
\bottomrule\noalign{}
\endlastfoot
Agrícola alta produtividade & 36.000 & 25.000 -- 55.000 & ↑ \\
Pastagem / uso misto & 20.000 & 12.000 -- 30.000 & ↑ \\
Mata / reserva & 10.000 & 6.000 -- 18.000 & ↑ \\
\end{longtable}
}
...
Referencia atual de score: GSS 5.9.
...
\item
  ...
  \tightlist
  \item
    Relatórios de poluição hídrica e saneamento (MADES/ESSAP\footnote{Empresa de Servicios Sanitarios del Paraguay (Empresa de Serviços Sanitários do Paraguai), responsável pelo saneamento e água urbana.}).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.0 (Capital departamental e hub administrativo;
visibilidade tática e administrativa elevada) - B: 5.0 (Alta densidade
demográfica metropolitana; risco de agitação social em crises) - C: 6.5
(Geologia estável; nota penalizada pela poluição sanitária crítica do
lago) - D: 6.0 (Bons recursos: polo de morangos e hortifrúti, mas
dependente de logística externa) - E: 7.5 (Forte segurança institucional
por ser a sede do governo departamental)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 5.9

Classificacao: - Moderadamente Seguro (Indicado como base administrativa
próxima à capital, requer preparo para autonomia total).
...
\item[Densidade]  \textasciitilde 739,5 hab/km² (Densidade elevada, indicando alta vulnerabilidade social e pressão sobre serviços básicos em cenários de ruptura sistêmica).
...
\item[Preço da Terra]  US\$ 60-120/m² (lotes urbanos); chácaras rurais residenciais a partir de US\$ 40.000/ha.
\item[Hidrologia]  Risco Sanitário Crítico. Poluição severa do Lago Ypacaraí torna a água superficial imprópria para consumo. Áreas ribeirinhas baixas vulneráveis a inundações localizadas durante chuvas intensas (média 1.600 mm/ano).
...
\item[Qualidade do Solo]  Solo argiloso e arenoso; excelente para olaria/cerâmica e cultivos específicos como morango.
...
\item[Segurança]  Cidade com perfil turístico e residencial. Criminalidade urbana comum presente (furtos/assaltos). Segurança institucional presente através da sede da polícia departamental e patrulhamento turístico.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3°, -57.3833°. Média
...
Taxa de homicídios (est., /100k hab) & \textasciitilde3,0 (estimativa,
...
Farmácia & sim \\
Distância ao hospital de referência & \textasciitilde30 km (Luque /
Asunción) \\
\end{longtable}
}

\textbf{Principais estabelecimentos:} Hospital Distrital de Areguá
(Mcal. López c/ Mcal. Estigarribia)
...
\item
  ...
  priorizado quando risco hidro=36/100.
\item
...
Notas (0-10): - A: 7.0 - B: 7.3 - C: 7.1 - D: 6.4 - E: 7.9
...
(36/100). - B (infraestrutura): combina conectividade (37/100) e escala
populacional (232757 hab). - C (riscos naturais): derivada da exposicao
hidrometeorologica (36/100). - D (autossuficiencia): combina
conectividade, ajuste de densidade (311.0 hab/km2) e risco hidro. - E
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.35°, -57.45°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
fragilidade demográfica. Referencia atual de score: GSS 6.9.
...
\item
  ...
  \tightlist
  \item
    Levantamento de densidade demográfica nacional (INE\footnote{Instituto Nacional de Estadística (Instituto Nacional de Estatística), órgão oficial de dados demográficos e censitários.}).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
  ...
  \tightlist
  \item
    Mapa de raudales e riscos urbanos (MOPC/Municipalidade).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.0 (Corredor rodoviário vital para a capital; alvo
logístico de visibilidade elevada) - B: 5.0 (Extrema densidade
populacional; risco social e de agitação urbana crítico) - C: 7.5
(Geologia muito estável e baixo risco de grandes desastres naturais) -
D: 8.5 (Melhor infraestrutura comercial e de suprimentos do país;
abundância residencial) - E: 8.5 (Forte segurança institucional e
serviços de saúde de elite integrados)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.9

Classificacao: - Moderadamente Seguro (Recomendado como base logística e
residencial de apoio, não para sobrevivência isolada).
...
\item[Alvos Estratégicos]  Corredor Logístico da Ruta PY02 (Eixo vital de entrada/saída da capital); Importantes centros de distribuição e logística comercial (Zona Norte e Sul); Proximidade crítica com sedes administrativas em Assunção. Ausência de bases militares diretas, mas é um ponto de estrangulamento rodoviário tático.
...
\item[Densidade]  \textasciitilde 5.512,7 hab/km² (O distrito mais densamente povoado do Paraguai). Indica vulnerabilidade social extrema e risco de desabastecimento crítico em cenários de ruptura sistêmica urbana.
...
\item[Preço da Terra]  US\$ 150-350/m² (Urbano/Comercial).
...
\item[Segurança]  Índices de criminalidade urbana típicos de alta densidade metropolitana (assaltos/furtos). Em crises, é uma das zonas de maior risco para distúrbios civis e saques devido à concentração de depósitos e comércio.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3167°, -57.5333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
vulnerabilidade demográfica. Referencia atual de score: GSS 6.4.
...
Notas (0-10): - A: 5.5 (Hub industrial açucareiro e nó logístico
secundário; visibilidade estratégica moderada) - B: 5.5 (População
significativa e densidade urbana elevada; risco social em crises
metropolitana) - C: 7.0 (Geologia muito estável e baixo risco de grandes
desastres naturais) - D: 7.5 (Excelentes recursos: polo açucareiro,
abundância hídrica e solo fértil) - E: 6.5 (Estabilidade institucional e
forte coesão social comunitária tradicional)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.4

Classificacao: - Moderadamente Seguro (Ideal como base agroindustrial e
de serviços próxima à capital).

\begin{itemize}
\tightlist
\item
  Fonte MOPC infraestrutura: Projeto Central III pavimentação.
\end{itemize}
...
\item[Densidade]  \textasciitilde 1.241,5 hab/km² (Densidade elevada, indicando vulnerabilidade social e pressão sobre serviços em crises de massa metropolitana).
...
\item[Preço da Terra]  US\$ 20-50/m² (Urbano); US\$ 15.000-30.000/ha (Rurais/Industriais).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.4833°, -57.4667°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
\item
  ...
  \tightlist
  \item
    Relatórios de produção artesanal e industrial (MIC/IPA).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.5 (Posicionamento estratégico no eixo PY01; hub
artesanal e de suprimentos tático) - B: 5.5 (População significativa e
densidade urbana em crescimento metropolitano) - C: 7.0 (Geologia muito
estável e baixo risco de desastres naturais graves) - D: 7.0 (Bons
recursos: polo de cerâmica, hortifrúti e água abundante por poços) - E:
6.0 (Estabilidade institucional e forte coesão social comunitária
tradicional)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.0

Classificacao: - Moderadamente Seguro (Ideal para quem busca refúgio
rural produtivo próximo à infraestrutura da capital).
...
\item[Densidade]  \textasciitilde 450,7 hab/km² (Densidade elevada, mas inferior à média do núcleo metropolitano de Central, oferecendo melhor isolamento em suas companhias rurais).
...
\item[Preço da Terra]  US\$ 20-50/m² (Urbano); US\$ 15.000-30.000/ha (Rurais/Agrícolas).
\item[Hidrologia]  Baixo risco de inundações sistêmicas catastróficas. Presença da Lagoa de Itá no centro urbano. Vulnerabilidade em drenagem pluvial em bairros baixos durante chuvas intensas (média 1.600 mm/ano).
...
\item[Qualidade do Solo]  Solo argiloso e arenoso (avermelhado); excelente para olaria/cerâmica e muito apto para hortifrúti, mandioca e pastagens.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.5°, -57.35°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
Notas (0-10): - A: 6.0 (Hub de saúde e logístico vital; alvo estratégico
tático de alta visibilidade e proteção) - B: 6.0 (População regional
elevada e densidade urbana manejada para o padrão Central) - C: 7.0
(Geologia muito estável e baixo risco de grandes desastres naturais) -
D: 8.5 (Recursos agroindustriais e hídricos excepcionais; solo de elite
e polo têxtil) - E: 8.5 (Fortíssima segurança institucional e melhor
suporte hospitalar do país)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.4

Classificacao: - Seguro (Localidade altamente recomendada como base de
suporte médico e logístico para o projeto).
...
\item[População]  111.203 habitantes (Censo 2022 Final). Distrito com forte componente demográfico jovem e em plena expansão residencial/industrial.
\item[Densidade]  \textasciitilde 911,5 hab/km² (Densidade urbana elevada, indicando vulnerabilidade social e pressão sobre serviços em crises de massa metropolitana).
...
\item[Preço da Terra]  US\$ 40-90/m² (Urbano); US\$ 30.000-60.000/ha (Zonas industriais mecanizadas).
\item[Hidrologia]  Diversos arroios cruzam o distrito. Baixo risco de inundações sistêmicas catastróficas devido ao relevo favorável. Vulnerabilidade localizada em drenagem pluvial urbana durante tempestades severas (média 1.600 mm/ano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3833°, -57.3333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
metropolitana. Referencia atual de score: GSS 6.8.
...
Notas (0-10): - A: 5.5 (Posicionamento estratégico no eixo PY01; hub de
suprimentos tático alimentar) - B: 6.0 (População moderada e densidade
manejada para o padrão Central; baixo risco social) - C: 7.0 (Geologia
muito estável e baixo risco de grandes desastres naturais) - D: 8.5
(Recursos alimentares excepcionais: cinturão verde de hortifrúti e água
por poços) - E: 6.5 (Estabilidade institucional e segurança social
comunitária estável)
...
Classificacao: - Moderadamente Seguro (Ideal para quem busca refúgio
rural produtivo próximo à capital com foco em segurança alimentar).
...
\item[Densidade]  \textasciitilde 1.766,4 hab/km² (Densidade elevada, indicando vulnerabilidade social e pressão sobre serviços em crises de massa metropolitana).
...
\item[Preço da Terra]  US\$ 15-40/m² (Urbano); US\$ 30.000-50.000/ha (Rurais/Agrícolas).
\item[Hidrologia]  Baixo risco de inundações sistêmicas catastróficas. Vulnerabilidade localizada em drenagem pluvial urbana durante tempestades severas (média 1.600 mm/ano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.45°, -57.4167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
demográfica metropolitana. Referencia atual de score: GSS 7.3.
...
\item
  ...
  \tightlist
  \item
    Mapa de raudales e infraestrutura de drenagem (MOPC/Municipalidade).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.5 (Proximidade crítica com a capital; vulnerável
como rota de escape metropolitana) - B: 5.0 (Densidade urbana elevada e
população significativa; risco social em crises de massa) - C: 7.5
(Geologia muito estável e baixo risco de grandes desastres naturais) -
D: 8.5 (Melhor infraestrutura de serviços e suprimentos do país
adjacente) - E: 8.5 (Forte segurança institucional e social sustentada
pelo perfil residencial de elite)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.0 (Ajustado para 7.3 no ranking refletindo a solidez
institucional residencial)

Classificacao: - Seguro (Indicado como base residencial de elite próxima
à capital, ciente da vulnerabilidade demográfica).
...
\item[Densidade]  \textasciitilde 4.709,3 hab/km² (Densidade urbana muito elevada, indicando vulnerabilidade social crítica e pressão sobre serviços em cenários de ruptura sistêmica).
...
\item[Preço da Terra]  US\$ 100-250/m² (Urbano/Residencial).
...
\item[Segurança]  Zona residencial consolidada com forte presença de segurança privada. Criminalidade urbana comum presente (furtos/assaltos), mas com policiamento ostensivo. Estabilidade social alta em bairros residenciais, desafiada por focos de vulnerabilidade periférica.
\item[Leis Local]  Município consolidado e altamente regulamentado. \\ \textbf{Livre de Restrição} de Fronteira. \\ \textit{Aquisição de terra rural proibida para estrangeiros limítrofes.}
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3333°, -57.6167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
ambiental e tática. Referencia atual de score: GSS 6.5.
...
\item
  ...
  \tightlist
  \item
    Relatórios de monitoramento de cheias do Rio Paraguai (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/DMH).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
\item
  ...
  \tightlist
  \item
    Registro de segurança pública e fluxos rodoviários (MOPC/MDI).
  \end{enumerate}
...
\item
  ...
  elevadas \textgreater110m e longe das margens do Rio Salado/Paraguai).
\item
...
Notas (0-10): - A: 5.0 (Hub logístico vital na PY03; alvo tático como
via de saída da capital) - B: 5.5 (População elevada e densidade
crítica; alto risco social em crises metropolitana) - C: 5.5 (Geologia
estável; nota penalizada pelo risco crítico de inundação fluvial e
pluvial) - D: 7.5 (Excelentes recursos: hub de logística regional,
suprimentos comerciais e água abundante) - E: 6.5 (Estabilidade
institucional e segurança regional metropolitana funcional)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.0 (Ajustado para 6.5 no ranking nacional refletindo
a importância logística)

Classificacao: - Moderadamente Seguro (Ideal como base logística de
apoio, ciente dos riscos hidrológicos e demográficos).
...
\item[Densidade]  \textasciitilde 1.317,5 hab/km² (Densidade elevada, indicando alta vulnerabilidade social e pressão sobre serviços básicos em cenários de crises de massa).
...
\item[Preço da Terra]  US\$ 30-80/m² (Urbano); US\$ 40.000-60.000/ha (Zonas rurais/loteamentos).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.1833°, -57.4833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
próximas aos limites com Areguá/Limpio, mantendo autonomia hídrica e
...
\item
  ...
  \tightlist
  \item
    Relatórios de operação aeroportuária e base aérea (DINAC/MDN).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
  ...
  \tightlist
  \item
    Mapa de raudales e vulnerabilidades urbanas (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 4.0 (Alvo estratégico primário: aeroporto e bases
militares; altíssima visibilidade tática) - B: 5.0 (População massiva e
densidade elevada; risco social e de agitação urbana significativo) - C:
7.0 (Geologia muito estável e riscos naturais climáticos manejáveis) -
D: 8.0 (Recursos industriais e hídricos excepcionais; hub tecnológico e
de aviação) - E: 8.0 (Forte segurança institucional e presença de forças
de segurança de elite permanente)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.2 (Ajustado para 6.7 no ranking nacional refletindo
a infraestrutura tática de elite)

Classificacao: - Moderadamente Seguro (Ideal como base logística e
operacional de alto padrão, requer preparo para visibilidade
estratégica).
...
\item[Densidade]  \textasciitilde 1.279,3 hab/km² (Densidade urbana elevada, indicando alta vulnerabilidade social e pressão sobre serviços em crises de massa).
...
\item[Preço da Terra]  US\$ 50-150/m² (Urbano); US\$ 40.000-80.000/ha (Zonas rurais/industriais).
...
Média anual: 4.95 kWh/m²/dia. Mínimo: Jun (2.83) \textbar{} Máximo: Dez
(6.78).

\textbf{Precipitação (mm/mês → mm/ano \textasciitilde1.471):}
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.2667°, -57.4833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
estratégica da localidade. Referencia atual de score: GSS 6.3.
...
\item
  ...
  \tightlist
  \item
    Relatórios de operação portuária e logística (Porto Fénix/MIC).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
D - Autossuficiência & 8.5 & Recursos comerciais e logísticos massivos: hub de suprimentos e abundância hídrica/industrial \\
...
Notas (0-10): - A: 4.0 (Nó estratégico nevrálgico: Ponte Remanso e Porto
Fénix; alvo logístico de altíssima visibilidade e importância militar) -
B: 4.5 (Alta densidade populacional urbana e risco social crítico em
crises de massa metropolitana) - C: 6.5 (Geologia muito estável; nota
penalizada pelo risco de inundação ribeirinha e raudales) - D: 8.5
(Recursos comerciais e logísticos massivos: hub de suprimentos e
abundância hídrica/industrial) - E: 7.0 (Forte segurança institucional
devido à importância estratégica da ponte e presença policial)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.3

Classificacao: - Moderadamente Seguro (Ideal como hub logístico e
operacional, requer alto preparo para visibilidade estratégica).
...
\item[Densidade]  \textasciitilde 2.744,7 hab/km² (Densidade urbana muito elevada, indicando alta vulnerabilidade social e risco de desabastecimento crítico em crises).
...
\item[Preço da Terra]  US\$ 60-120/m² (Urbano); US\$ 50.000-100.000/ha (Zonas industriais e portuárias valorizadas).
\item[Hidrologia]  Risco Moderado a Alto de Inundação. Bairros ribeirinhas baixos vulneráveis às cheias do Rio Paraguai. Problemas severos de drenagem pluvial urbana (raudales) em eixos comerciais durante tempestades severas (média 1.600 mm/ano).
...
\item[Segurança]  Zona industrial e portuária com índices de criminalidade urbana típicos de polos de trânsito (furtos/assaltos). Em crises, a proximidade com a Ponte Remanso a torna uma zona de alta tensão militar e policial para controle de fluxos nacionais e segurança estratégica da fronteira interna.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.2°, -57.5333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
localidade. Referencia atual de score: GSS 7.5.
...
Notas (0-10): - A: 5.5 (Posicionamento estratégico no Acceso Sur; hub
industrial e de suprimentos tático) - B: 6.0 (População significativa e
densidade urbana manejada para o padrão Central) - C: 7.0 (Geologia
muito estável - base de basalto; baixo risco de desastres naturais) - D:
8.0 (Excelentes recursos logísticos e industriais; abundância hídrica
via poços) - E: 8.5 (Forte segurança institucional e coesão social
baseada no ativismo ecológico local)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.0 (Ajustado para 7.5 no ranking nacional refletindo
a solidez institucional e geológica)

Classificacao: - Seguro (Ideal como base logística e operacional próxima
à capital, ciente da vulnerabilidade demográfica).
...
\item[Densidade]  \textasciitilde 2.909,6 hab/km² (Densidade urbana elevada, indicando vulnerabilidade social e pressão sobre serviços básicos em cenários de ruptura sistêmica).
...
\item[Preço da Terra]  US\$ 50-120/m² (Urbano); US\$ 30.000-60.000/ha (Zonas industriais residuais).
\item[Hidrologia]  Baixo risco de inundações sistêmicas devido à topografia ondulada favorável à drenagem. Vulnerabilidade localizada em drenagem pluvial urbana (raudales) em tempestades severas (média 1.600 mm/ano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3833°, -57.5333°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
autossuficiência de médio/largo porte, exigindo do ocupante autonomia
...
local. Referencia atual de score: GSS 6.1.
...
Notas (0-10): - A: 6.5 (Localização remota e discreta na periferia
metropolitana; excelente invisibilidade tática) - B: 7.5 (Baixíssima
densidade demográfica, a menor de Central; ideal para isolamento social)
- C: 6.5 (Geologia estável; nota penalizada pelo risco moderado de
inundação em áreas de humedais) - D: 7.0 (Bons recursos: gado,
fruticultura e água, limitado pela infraestrutura comercial de insumos)
- E: 5.0 (Município pequeno seguro, mas com infraestrutura institucional
e de saúde mínima)
...
isolamento demográfico ainda dentro do Departamento Central).

\begin{itemize}
\tightlist
\item
  Fonte MOPC infraestrutura: Conectividade Villeta-Alberdi e Acceso Sur.
\end{itemize}
...
\item[Densidade]  \textasciitilde 36,6 hab/km² (Densidade baixíssima, a menor do Departamento Central, oferecendo isolamento social tático e privacidade estratégica inigualáveis na região metropolitana).
...
\item[Preço da Terra]  US\$ 15.000-30.000/ha (Rurais/Agrícolas); US\$ 20-40/m² (Urbano). Valores competitivos para o padrão de Central.
\item[Hidrologia]  Risco Moderado de Inundação. Proximidade com zonas baixas do Rio Paraguai a oeste e presença de arroios tributários. Áreas ribeirinhas vulneráveis em eventos de precipitação extrema (média 1.600 mm/ano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.6167°, -57.5°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
demográfica da localidade. Referencia atual de score: GSS 5.5.
...
\item
  ...
  \tightlist
  \item
    Relatórios de operação portuária nacional (Terport/Sarcom).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 4.0 (Alvo estratégico portuário e de combustíveis;
altíssima visibilidade tática e vulnerabilidade de fronteira interna) -
B: 4.0 (Extrema densidade demográfica metropolitana; alto risco social e
de agitação urbana em crises) - C: 6.5 (Geologia estável; nota
penalizada pelo risco de inundação ribeirinha e raudales) - D: 8.0
(Excelentes recursos industriais e hídricos: polo frigorífico e hub
portuário de containers) - E: 6.5 (Estabilidade institucional
metropolitana e segurança regional média)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 5.5

Classificacao: - Moderadamente Seguro (Indicado exclusivamente como hub
logístico portuário, não recomendado para refúgio tático isolado).
...
\item[Densidade]  \textasciitilde 2.514,9 hab/km² (Densidade urbana muito elevada, indicando alta vulnerabilidade social e risco de desabastecimento crítico em crises).
...
\item[Preço da Terra]  US\$ 40-80/m² (Urbano); US\$ 50.000-100.000/ha (Zonas industriais e portuárias valorizadas).
\item[Hidrologia]  Risco Moderado a Alto de Inundação. Bairros ribeirinhas baixos vulneráveis às cheias do Rio Paraguai. Problemas recorrentes de drenagem pluvial urbana (raudales) em eixos industriais durante tempestades severas (média 1.600 mm/ano).
\item[Clima]  Subtropical Úmido com forte efeito de ilha de calor urbana.
\item[Energia]  Rede nacional (Itaipu). Total dependência da integridade da rede metropolitana.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.4167°, -57.55°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
urbana e social da localidade. Referencia atual de score: GSS 6.1.
...
Notas (0-10): - A: 4.0 (Nó estratégico metropolitano central; campus da
UNA e hospitais; alvo logístico de altíssima visibilidade tática) - B:
4.0 (Extrema densidade populacional metropolitana; altíssimo risco
social e de agitação urbana em crises) - C: 6.5 (Geologia muito estável;
nota penalizada pelo risco crítico de raudales urbanos mortais) - D: 8.5
(Recursos comerciais, industriais e de saúde massivos; abundância
residencial) - E: 7.5 (Forte segurança institucional e presença de
forças de segurança permanente)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.1

Classificacao: - Moderadamente Seguro (Indicado exclusivamente como
centro de serviços e saúde, não recomendado para sobrevivência tática
isolada).
...
\item[Densidade]  \textasciitilde 4.024,9 hab/km² (Extrema densidade urbana, a segunda maior do país). Indica vulnerabilidade social máxima e risco de colapso total de serviços em cenários de ruptura sistêmica.
...
\item[Preço da Terra]  US\$ 100-250/m² (Urbano/Residencial); sem disponibilidade de terras rurais extensas.
...
\item[Segurança]  Índices de criminalidade urbana elevados (assaltos/furtos/microtráfico). Presença permanente de grandes efetivos da Polícia Nacional e Grupo Lince. Componente social jovem e politizado (UNA) que pode gerar focos de agitação civil e manifestações de massa em cenários de instabilidade.
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3333°, -57.5167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
a extrema fragilidade demográfica. Referencia atual de score: GSS 7.1.
...
Notas (0-10): - A: 5.0 (Hub energético de combustíveis; alvo logístico
de altíssima visibilidade tática) - B: 5.0 (Extrema densidade
populacional; risco social e de agitação urbana crítico) - C: 7.0
(Geologia muito estável e baixo risco de grandes desastres naturais) -
D: 8.5 (Recursos logísticos e hídricos excepcionais; abundância
comercial metropolitana) - E: 8.5 (Forte segurança institucional e
serviços de saúde de elite integrados)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.8 (Ajustado para 7.1 no ranking nacional refletindo
a solidez institucional energética)

Classificacao: - Seguro (Indicado como base logística e administrativa
próxima à capital, ciente da vulnerabilidade demográfica).
...
\item[Densidade]  \textasciitilde 5.948,6 hab/km² (Extrema densidade urbana, uma das maiores do país). Indica vulnerabilidade social crítica e risco de desabastecimento rápido em crises.
...
\item[Preço da Terra]  US\$ 80-150/m² (Urbano/Residencial).
...
\item[Segurança]  Cidade com perfil residencial de classe média e zonas industriais portuárias. Criminalidade urbana comum presente (furtos/assaltos). Segurança institucional presente através de patrulhamento metropolitano e vigilância em áreas estratégicas de combustíveis. Estabilidade social média-alta.
\item[Leis Local]  Município consolidado e altamente regulamentado. \\ \textbf{Livre de Restrição} de Fronteira. \\ \textit{Aquisição de terra rural proibida para estrangeiros limítrofes.}
\end{description}
\textbf{Fonte climática:} NASA POWER Climatology API (período 2001-2020)
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.3667°, -57.5833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
da localidade. Referencia atual de score: GSS 7.7.
...
\item
  ...
  \tightlist
  \item
    Relatórios de operação portuária nacional (ANNP/Terport).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
  ...
  \tightlist
  \item
    Mapa de vulnerabilidades hidrológicas e cotas de inundação (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
\item
  ...
  10-15 km do perímetro portuário/industrial).
\item
...
\item
  ...
  rotas rurais para o sul/Nueva Italia).
\end{itemize}

Notas (0-10): - A: 6.0 (Hub estratégico portuário e industrial nacional;
alvo logístico de altíssima visibilidade tática) - B: 7.0 (População
controlada e densidade baixíssima para o padrão Central; isolamento
rural superior) - C: 7.0 (Geologia muito estável; nota penalizada pelo
risco de inundação ribeirinha) - D: 9.0 (Recursos industriais, hídricos
e logísticos de elite; sede das maiores exportadoras) - E: 8.5
(Fortíssima segurança institucional e social sustentada pelo setor
industrial privado)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 7.4 (Ajustado para 7.7 no ranking nacional refletindo
a excepcional força dos recursos portuários)

Classificacao: - Seguro (Localidade de elite para suporte logístico e
produção de recursos, requer preparo para visibilidade estratégica).
...
\item[População]  35.941 habitantes (Censo 2022 Final). População urbana concentrada e vasta área rural/industrial.
\item[Densidade]  \textasciitilde 38,1 hab/km² (Densidade baixíssima para o padrão de Central, oferecendo isolamento tático superior em áreas rurais industriais).
...
\item[Preço da Terra]  US\$ 165.000-200.000/ha (Zonas portuárias beira-rio); US\$ 50.000-100.000/ha (Interior industrial); US\$ 35-55/m² (Urbano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.5°, -57.5667°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
vulnerabilidade tática rodoviária. Referencia atual de score: GSS 6.4.
...
\item
  ...
  \tightlist
  \item
    Relatórios de investimento farmacêutico (Prosalud/MIC 2023).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.5 (Posicionamento estratégico na PY02; hub cultural
e nó logístico metropolitano fundamental) - B: 6.5 (População controlada
e densidade moderada; excelente equilíbrio urbano-rural) - C: 7.0
(Geologia muito estável e baixo risco de grandes desastres naturais) -
D: 7.5 (Excelentes recursos: novo polo farmacêutico, turismo e água
abundante por poços) - E: 6.0 (Estabilidade institucional histórica e
segurança social superior à média metropolitana)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 6.4

Classificacao: - Moderadamente Seguro (Ideal para quem busca integração
cultural e serviços industriais em ambiente seguro próximo à capital).
...
\item[Densidade]  \textasciitilde 189,5 hab/km² (Densidade moderada para o padrão de Central, oferecendo melhor qualidade de vida e menor pressão social imediata que o núcleo metropolitano).
...
\item[Preço da Terra]  US\$ 100.000-140.000/ha (Áreas na Ruta PY02); US\$ 40.000-60.000/ha (Zonas rurais com vista); US\$ 40-80/m² (Urbano).
\item[Hidrologia]  Proximidade com o Lago Ypacaraí. Baixo risco de inundações sistêmicas catastróficas. Vulnerabilidade localizada em drenagem pluvial urbana e áreas baixas ribeirinhas durante chuvas intensas (média 1.600 mm/ano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.4°, -57.2833°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
...
e social da localidade. Referencia atual de score: GSS 5.9.
...
\item
  ...
  \tightlist
  \item
    Relatórios de produção industrial nacional (MIC/Cervepar).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Notas (0-10): - A: 5.0 (Hub logístico no Acceso Sur e polo industrial;
visibilidade tática metropolitana moderada) - B: 5.0 (População em
rápido crescimento e densidade urbana elevada; risco social em crises) -
C: 6.5 (Geologia estável; nota penalizada pelo risco moderado de
inundação e raudales) - D: 7.5 (Excelentes recursos industriais: polo de
bebidas, vidro e eletroeletrônicos; água abundante) - E: 6.0
(Estabilidade institucional metropolitana e segurança regional média
funcional)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) / 10 - GSS: 5.9

Classificacao: - Moderadamente Seguro (Indicado como base industrial e
logística, não recomendado para refúgio tático isolado).
...
\item[Densidade]  \textasciitilde 1.258,5 hab/km² (Densidade elevada, indicando alta vulnerabilidade social e pressão sobre serviços em crises de massa metropolitana).
\item[Vias de Acesso]  Localização estratégica sobre o eixo do Acceso Sur. Conectividade asfáltica de elite para a capital e para o Sul (Villeta/Guarambaré). Risco extremo de paralisia total das vias em cenários de fuga massiva de Assunção.
...
\item[Preço da Terra]  US\$ 80.000-150.000/ha (Zonas logísticas próximas ao Acceso Sur); US\$ 30-60/m² (Urbano).
\item[Hidrologia]  Diversos arroios cruzam o distrito. Risco moderado de inundações em bairros ribeirinhos baixos e problemas de drenagem pluvial urbana (raudales) em períodos de chuva torrencial (média 1.600 mm/ano).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.45°, -57.5167°. Média
ponderada camadas 0-5, 5-15, 15-30 cm.
\subsubsection{Indicadores Sociais}
