...
O pacote 13 cobre o departamento , com 19 localidades. Central e o
...
Ranking nacional (1=melhor) & 2/\allowbreak 18 \\
...
Crimes registrados (total/\allowbreak ano) & elevado em números absolutos --- maior
...
Pastagem /\allowbreak  uso misto & 20.000 & 12.000 -- 30.000 & ↑ \\
Mata /\allowbreak  reserva & 10.000 & 6.000 -- 18.000 & ↑ \\
\end{longtable}
...
\item
  ...
  \tightlist
  \item
    Relatórios de poluição hídrica e saneamento (MADES/\allowbreak ESSAP\footnote{Empresa de Servicios Sanitarios del Paraguay (Empresa de Serviços Sanitários do Paraguai), responsável pelo saneamento e água urbana.}).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Classificação: - Moderadamente Seguro (Indicado como base administrativa
...
\newpage
\secaoDiagnostico{Capiata}{\mapaConteudo{-25.3500}{-57.4500}}{Capiata (Central) apresenta perfil operacional consolidado para
...
(36/\allowbreak 100). - B (infraestrutura): combina conectividade (37/\allowbreak 100) e escala
...
conectividade, ajuste de densidade (311.0 hab/\allowbreak km2) e risco hidro. - E
...
Classificação: - Moderadamente Seguro (Recomendado como base logística e
...
Classificação: - Moderadamente Seguro (Ideal como base agroindustrial e
...
Classificação: - Seguro (Localidade altamente recomendada como base de
...
Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) /\allowbreak  10 - GSS: 7.0 (Ajustado para 7.3 no ranking refletindo a solidez
institucional residencial)

Classificação: - Seguro (Indicado como base residencial de elite próxima
...
\item
  ...
  \tightlist
  \item
    Relatórios de monitoramento de cheias do Rio Paraguai (SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.}/\allowbreak DMH).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
...
Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) /\allowbreak  10 - GSS: 6.0 (Ajustado para 6.5 no ranking nacional refletindo
a importância logística)

Classificação: - Moderadamente Seguro (Ideal como base logística de
...
Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) /\allowbreak  10 - GSS: 6.2 (Ajustado para 6.7 no ranking nacional refletindo
a infraestrutura tática de elite)

Classificação: - Moderadamente Seguro (Ideal como base logística e
...
abundância hídrica/\allowbreak industrial) - E: 7.0 (Forte segurança institucional
devido à importância estratégica da ponte e presença policial)

Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) /\allowbreak  10 - GSS: 6.3

Classificação: - Moderadamente Seguro (Ideal como hub logístico e
...
Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) /\allowbreak  10 - GSS: 7.0 (Ajustado para 7.5 no ranking nacional refletindo
a solidez institucional e geológica)

Classificação: - Seguro (Ideal como base logística e operacional próxima
à capital, ciente da vulnerabilidade demográfica).
...
Classificação: - Moderadamente Seguro (Indicado exclusivamente como
...
Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) /\allowbreak  10 - GSS: 6.8 (Ajustado para 7.1 no ranking nacional refletindo
a solidez institucional energética)

Classificação: - Seguro (Indicado como base logística e administrativa
...
Calculo: - GSS = ((A * 2.5) + (B * 2.0) + (C * 1.5) + (D * 2.0) + (E *
2.0)) /\allowbreak  10 - GSS: 7.4 (Ajustado para 7.7 no ranking nacional refletindo
a excepcional força dos recursos portuários)

Classificação: - Seguro (Localidade de elite para suporte logístico e
...
Classificação: - Moderadamente Seguro (Indicado como base industrial e
