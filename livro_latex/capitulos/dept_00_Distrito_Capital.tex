...
\vfill\clearpage
\section{Distrito Capital / Asuncion}
...
\item
  ...
  de 27-11-2024, já lida para BT/MT no material de apoio.
\item
...
Pastagem / uso misto & 18.000 & 12.000 -- 25.000 & ↑ \\
Mata / reserva & 8.000 & 5.000 -- 12.000 & ↑ \\
\end{longtable}
}
...
\clearpage
\newpage
\secaoDiagnostico{Asuncion}{\mapaDistrito{0000}}{Asunción é uma capital segura para os padrões globais, mas sofre dos
...
ou Itapúa). Referencia atual de score: GSS 6.5. A leitura do pacote
...
\item
  ...
  \tightlist
  \item
    Mapas de inundação e clima (DMH/SEN\footnote{Secretaría de Emergencia Nacional (Secretaria de Emergência Nacional), órgão governamental de resposta a desastres.} 2026).
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi})}
  ...
  \end{enumerate}
\end{itemize}}{dist:00_Distrito_Capital:Asuncion}
\begin{table}[ht!]
...
\item
  ...
  (Mitigação: localização fora do eixo central/administrativo).
\end{itemize}

Notas (0-10): - A: 5.0 (Capital nacional; alvos militares e
governamentais presentes) - B: 5.0 (Alta densidade metropolitana; risco
de convergência de refugiados) - C: 7.5 (Geologia estável;
vulnerabilidade hídrica em áreas específicas) - D: 7.0 (Abundância
nacional de energia e água; solo fértil periférico) - E: 8.5 (Forte
segurança institucional; baixa taxa de criminalidade violenta)

Calculo: - GSS = ((A x 2.5) + (B x 2.0) + (C x 1.5) + (D x 2.0) + (E x
2.0)) / 10 - GSS: 6.5

Classificacao: - Moderadamente Seguro (Recomendado para centros de
operação com apoio rural).
...
\item[Alvos Estratégicos]  Palácio de los López (Governo), Porto Sajonia (Marinha), Base Ñu Guasu (Aeronáutica/Exército), Aeroporto Silvio Pettirossi (Luque), Hub elétrico de transmissão de Itaipu.
...
\item[Mídia local]  Principais meios incluem ABC Color, Última Hora, NPY, SNT e rádios AM/FM locais. Cobertura 4G ampla na área urbana.
...
\item[Densidade]  \textasciitilde 3.950 hab/km² (Núcleo urbano denso).
...
\item[Custo de Vida]  US\$ 600-1.550/mês (dependendo do padrão). Terrenos urbanos: US\$ 400-650/m².
...
\item[Clima]  Tropical/Subtropical. Verões com temperaturas >40°C. Tempestades severas com rajadas de vento de até 160 km/h.
...
\item[Energia]  Dependência total da rede nacional (Itaipu), mas com a energia mais barata da região (\textasciitilde US\$ 0,05/kWh).
...
\item[Solo]  Solo fértil na Região Oriental, mas área urbana saturada. Potencial agrícola nos arredores (Central/Chaco'i).
...
\item[Poços e águas subterrâneas]  não há profundidade média oficial consolidada para poços artesianos em Asunción; a regulação permanece com MADES e Lei 3239/07.
...
\item[Segurança]  Taxa de homicídios baixa para padrões latinos (7.1/100k). Criminalidade focada em delitos contra o patrimônio. Áreas nobres e corporativas são consideradas seguras.
\item[Leis Local]  Sede do governo central. Direitos de propriedade bem definidos. Incentivos fiscais (Lei 60/90).
...
\item[Poluição luminosa]  Bortle 8 (céu urbano), radiância artificial estimada em 100 nW/cm²/sr. Fonte: World Atlas of Artificial Night Sky Brightness.
\end{description}
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.2667°, -57.6333°. Média
...
Escolaridade média & 11,6 anos (média homens 11,7 / mulheres 11,4) &
dist. \\
...
Taxa de homicídios (est., /100k hab) & \textasciitilde4,5 (estimativa) &
dept. \\
