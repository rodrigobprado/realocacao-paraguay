...
\item
  Lacunas ainda abertas para séries mensais de clima, preços locais,
  internet e indicadores sociais padronizados.
\end{itemize}
...
\item[Precipitação — PRECTOTCORR (mm/\allowbreak dia)]  Jan 4.06 | Fev 4.92 | Mar 4.37 | Abr 4.97 | Mai 4.62 | Jun 2.47 | Jul 2.03 | Ago 1.23 | Set 2.44 | Out 5.27 | Nov 6.35 | Dez 5.78. Média anual: \textasciitilde 1.471 mm/\allowbreak ano. Estação chuvosa Out-Mai; seca Jun-Set (mínimo em Ago). Fonte: NASA POWER (acesso em 2026-03-20).
...
\item[Poluição luminosa]  pendente para outra etapa; não há índice oficial aberto por município e a leitura dependerá de proxy satelital e metodologia padronizada.
\end{description}
