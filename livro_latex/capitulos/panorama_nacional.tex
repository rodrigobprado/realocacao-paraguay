...
\item
  ...
  \tightlist
  \item
    San Jose de los Arroyos (\hyperref[dept:Cordillera]{Cordillera}) - GSS 8.6
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    \hyperref[dist:Yaguarón]{Yaguarón} (\hyperref[dept:Paraguari]{Paraguari}) - GSS 8.5
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
\item
  ...
  \tightlist
  \item
    \hyperref[dist:Tavai]{Tavai} (\hyperref[dept:Caazapa]{Caazapa}) - GSS 8.3
  \end{enumerate}
\item
  \begin{enumerate}
  \def\labelenumi{\arabic{enumi}.}
...
4 & \hyperref[dept:Cordillera]{Cordillera} & San Jose de los Arroyos & 8.6 \\
...
8 & \hyperref[dept:Paraguari]{Paraguari} & \hyperref[dist:Yaguarón]{Yaguarón} & 8.5 \\
9 & \hyperref[dept:San Pedro]{San Pedro} & \hyperref[dist:San Vicente Pancholo]{San Vicente Pancholo} & 8.3 \\
10 & \hyperref[dept:Caazapa]{Caazapa} & \hyperref[dist:Tavai]{Tavai} & 8.3 \\
...
40 & \hyperref[dept:Paraguari]{Paraguari} & \hyperref[dist:Ybytymi]{Ybytymi} & 7.7 \\
...
74 & \hyperref[dept:San Pedro]{San Pedro} & \hyperref[dist:Itacurubi del Rosario]{Itacurubi del Rosario} & 7.3 \\
75 & \hyperref[dept:Cordillera]{Cordillera} & \hyperref[dist:Piribebuy]{Piribebuy} & 7.3 \\
76 & \hyperref[dept:Guaira]{Guaira} & \hyperref[dist:Yataity]{Yataity} & 7.3 \\
...
93 & \hyperref[dept:Presidente Hayes]{Presidente Hayes} & \hyperref[dist:General Jose Maria Bruguez]{General Jose Maria Bruguez} & 7.2 \\
...
144 & \hyperref[dept:Caazapa]{Caazapa} & \hyperref[dist:Dr Moises S Bertoni]{Dr Moises S Bertoni} & 6.7 \\
...
195 & \hyperref[dept:Caaguazu]{Caaguazu} & \hyperref[dist:San Jose de los Arroyos (Caaguazú)]{San Jose de los Arroyos (Caaguazú)} & 6.3 \\
...
201 & \hyperref[dept:Canindeyu]{Canindeyu} & \hyperref[dist:Francisco Caballero Alvarez]{Francisco Caballero Alvarez} & 6.3 \\
...
205 & \hyperref[dept:Caaguazu]{Caaguazu} & \hyperref[dist:San Joaquin (Norte)]{San Joaquin (Norte)} & 6.2 \\
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.82\textwidth, height=0.75\textheight, keepaspectratio]{mapas/heatmap_gss_distrito.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.82\textwidth, height=0.75\textheight, keepaspectratio]{mapas/heatmap_gss_departamento.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.82\textwidth, height=0.75\textheight, keepaspectratio]{mapas/mapa_idh_departamento.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.82\textwidth, height=0.75\textheight, keepaspectratio]{mapas/mapa_risco_social.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.82\textwidth, height=0.75\textheight, keepaspectratio]{mapas/mapa_autossuficiencia.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.82\textwidth, height=0.75\textheight, keepaspectratio]{mapas/mapa_solar_departamento.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.82\textwidth, height=0.75\textheight, keepaspectratio]{mapas/mapa_risco_inundacao.png}
