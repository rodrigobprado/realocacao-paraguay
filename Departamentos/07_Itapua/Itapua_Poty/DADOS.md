# Avaliacao de Localidade: Itapua Poty, Itapua

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 26°38′S 55°31′W (geocodificado via Nominatim).
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----------|
| 4.73 | 4.40 | 4.42 | 5.85 | 5.13 | 3.56 | 2.82 | 2.34 | 3.50 | 6.38 | 6.25 | 5.57 | **1673 mm** |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -26.6333°, -55.5167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=46/100.
- Duplicar rotas/logistica quando conectividade viaria=92/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (92/100) e exposicao hidro (46/100).
- B (infraestrutura): combina conectividade (92/100) e escala populacional (237450 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (46/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (478.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 237450 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 478 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 92/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 46/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
- Amplitude de sensibilidade: 0.6 ponto(s)
- Leitura: variacao controlada para decisao comparativa entre distritos; priorizar monitoramento de B e C.

## 11. Redacao Final
### Diagnostico Integrado
Itapua_Poty (07_Itapua) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 8.1 em 2026-03-05; risco predominante: moderado.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~107 km (Encarnacion) |
