# Avaliacao de Localidade: Villa del Rosario, San Pedro

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 24°25′S 57°07′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.6 |
| Carbono orgânico (SOC) | 24.67 g/kg |
| Argila | 29.12 % |
| Areia | 39.07 % |
| Silte (calc.) | 31.8 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -24.4167°, -57.1167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (94/100) e exposicao hidro (23/100).
- B (infraestrutura): combina conectividade (94/100) e escala populacional (23572 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (23/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (54.0 hab/km2) e risco hidro.
...
- Duplicar rotas/logistica quando conectividade viaria=94/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- Populacao municipal/distrital (consolidado operacional): 23572 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 54 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 94/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
...
Villa_del_Rosario (02_San_Pedro) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~47 km (San Pedro de Ycuamandiyu) |
