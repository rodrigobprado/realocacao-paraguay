# Avaliacao de Localidade: Nueva Germania, San Pedro

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 23°55′S 56°42′W (geocodificado via Nominatim).
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -23.9167°, -56.7°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (90/100) e exposicao hidro (66/100).
- B (infraestrutura): combina conectividade (90/100) e escala populacional (182512 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (66/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (281.0 hab/km2) e risco hidro.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=66/100.
- Duplicar rotas/logistica quando conectividade viaria=90/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- Populacao municipal/distrital (consolidado operacional): 182512 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 281 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 90/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 66/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Nueva_Germania (02_San_Pedro) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.5 em 2026-03-05; risco predominante: alto.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~54 km (San Pedro de Ycuamandiyu) |
