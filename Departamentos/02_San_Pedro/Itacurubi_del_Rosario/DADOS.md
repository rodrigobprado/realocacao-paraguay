# Avaliacao de Localidade: Itacurubi del Rosario, San Pedro

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 24°32′S 56°49′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.4 |
| Carbono orgânico (SOC) | 15.82 g/kg |
| Argila | 26.52 % |
| Areia | 55.02 % |
| Silte (calc.) | 18.5 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -24.5333°, -56.8167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (88/100) e exposicao hidro (23/100).
- B (infraestrutura): combina conectividade (88/100) e escala populacional (66854 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (23/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (367.0 hab/km2) e risco hidro.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=23/100.
- Duplicar rotas/logistica quando conectividade viaria=88/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- Populacao municipal/distrital (consolidado operacional): 66854 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 367 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 88/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 23/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Itacurubi_del_Rosario (02_San_Pedro) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~71 km (San Pedro de Ycuamandiyu) |
