# Avaliacao de Localidade: General Resquin, San Pedro

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 24°06′S 57°04′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.7 |
| Carbono orgânico (SOC) | 17.85 g/kg |
| Argila | 26.05 % |
| Areia | 49.35 % |
| Silte (calc.) | 24.6 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -24.1°, -57.0667°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (80/100) e exposicao hidro (40/100).
- B (infraestrutura): combina conectividade (80/100) e escala populacional (175427 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (40/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (260.0 hab/km2) e risco hidro.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=40/100.
- Duplicar rotas/logistica quando conectividade viaria=80/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- Populacao municipal/distrital (consolidado operacional): 175427 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 260 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 80/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 40/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
General_Resquin (02_San_Pedro) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~2 km (San Pedro de Ycuamandiyu) |
