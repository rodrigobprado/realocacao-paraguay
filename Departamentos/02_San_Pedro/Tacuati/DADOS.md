# Avaliacao de Localidade: Tacuati, San Pedro

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 23°27′S 56°44′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.6 |
| Carbono orgânico (SOC) | 16.77 g/kg |
| Argila | 19.18 % |
| Areia | 61.02 % |
| Silte (calc.) | 19.8 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -23.45°, -56.7333°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (87/100) e exposicao hidro (48/100).
- B (infraestrutura): combina conectividade (87/100) e escala populacional (132765 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (48/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (186.0 hab/km2) e risco hidro.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=48/100.
- Duplicar rotas/logistica quando conectividade viaria=87/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- Populacao municipal/distrital (consolidado operacional): 132765 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 186 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 87/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 48/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Tacuati (02_San_Pedro) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.8 em 2026-03-05; risco predominante: moderado.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~97 km (San Pedro de Ycuamandiyu) |
