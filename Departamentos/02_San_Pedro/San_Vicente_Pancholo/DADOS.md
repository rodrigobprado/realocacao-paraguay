# Avaliacao de Localidade: San Vicente Pancholo, San Pedro

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 22°28′S 56°48′W (geocodificado via Nominatim).
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -22.4667°, -56.8°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (93/100) e exposicao hidro (21/100).
- B (infraestrutura): combina conectividade (93/100) e escala populacional (118132 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (21/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (9.0 hab/km2) e risco hidro.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=21/100.
- Duplicar rotas/logistica quando conectividade viaria=93/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- Populacao municipal/distrital (consolidado operacional): 118132 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 9 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 93/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 21/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
San_Vicente_Pancholo (02_San_Pedro) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 8.3 em 2026-03-05; risco predominante: baixo.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~89 km (San Pedro de Ycuamandiyu) |
