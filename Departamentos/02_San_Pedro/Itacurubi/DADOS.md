# Avaliacao de Localidade: Itacurubi, San Pedro
...
- A (geoestrategia): combina conectividade viaria (61/100) e exposicao hidro (38/100).
- B (infraestrutura): combina conectividade (61/100) e escala populacional (120283 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (38/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (136.0 hab/km2) e risco hidro.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=38/100.
- Duplicar rotas/logistica quando conectividade viaria=61/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- Populacao municipal/distrital (consolidado operacional): 120283 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 136 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 61/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 38/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Itacurubi (02_San_Pedro) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
