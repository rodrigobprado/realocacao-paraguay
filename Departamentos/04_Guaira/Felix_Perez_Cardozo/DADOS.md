# Avaliacao de Localidade: Felix Perez Cardozo, Guaira

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°45′S 56°31′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.38 |
| Carbono orgânico (SOC) | 17.77 g/kg |
| Argila | 27.89 % |
| Areia | 47.32 % |
| Silte (calc.) | 24.8 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.75°, -56.5167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Duplicar rotas/logistica quando conectividade viaria=59/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (59/100) e exposicao hidro (37/100).
- B (infraestrutura): combina conectividade (59/100) e escala populacional (180336 hab).
...
- Populacao municipal/distrital (consolidado operacional): 180336 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
...
- Conectividade viaria funcional (consolidado operacional): 59/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
...
Felix_Perez_Cardozo (04_Guaira) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~11 km (Villarrica) |
