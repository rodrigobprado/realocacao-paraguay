...
- **População:** 6.153 (Censo 2022 Final).
- **Densidade:** ~2,74 hab/km² (**Baixa densidade**, ideal para evitar grandes massas populacionais e garantir privacidade estratégica).
- **Vias de Acesso:** **Acesso Terrestre Crítico.** Estradas de terra que sofrem severamente em períodos de chuva. Conexão principal com Concepción e Bella Vista Norte. Isolamento físico frequente.
...
| População (Censo 2022) | 6.153 | dist. |
...
- **Insegurança Regional:** Atividade insurgente e criminosa na fronteira seca (Mitigação: sistemas de segurança redundantes, comunicação via satélite e apoio à FTC).
- **Isolamento Logístico:** Estradas de terra intransitáveis (Mitigação: estoque de suprimentos para 60 dias e posse de veículos de tração 4x4 pesada).
- **Instabilidade Energética:** Rede elétrica pouco confiável (Mitigação: instalação de sistemas solares off-grid com baterias de lítio).
- **Restrições de Propriedade:** Zona de fronteira exige estratégias jurídicas para investidores estrangeiros.

## 6. Pontuacao GSS (avaliacao calibrada - Onda 2)
Notas (0-10):
- A: 4.0 (Zona de fronteira seca ativa e hotspot de grupos irregulares)
- B: 5.5 (Densidade baixíssima compensada pelo alto risco social/segurança regional)
- C: 6.5 (Risco de isolamento hídrico moderado; geologia estável)
- D: 7.5 (Solo fértil e abundância hídrica natural; potencial de autossuficiência elevado)
- E: 5.0 (Município recente; restrições legais rigorosas para estrangeiros)
...
- **Homicidios/100k:** ~20.0 (Regional/Fronteira).
- **Preço Terra Rural:** US$ 2.000-5.000/ha.

## 10. Analise de Riscos
- **Cenario curto prazo:** Conflitos de segurança na zona de fronteira e isolamento por chuvas severas.
- **Cenario medio prazo:** Potencial valorização como zona de reserva ambiental e expansão pecuária.

## 11. Redacao Final
### Diagnostico Integrado
Sargento José Félix López (Puentesino) oferece um dos maiores potenciais de isolamento do Norte paraguaio, mas exige um alto compromisso com a segurança tática e autonomia logística. É um local de "fronteira viva" com desafios proporcionais ao seu isolamento.

### Por que sim
- Proximidade com o Parque Nacional Paso Bravo (isolamento natural massivo).
- Densidade demográfica muito baixa.
- Ótimos recursos naturais para autossuficiência básica.

### Por que nao
- Insegurança regional crônica (EPP/Narcotráfico).
- Acesso terrestre extremamente difícil em épocas de chuva.
- Restrições legais para estrangeiros brasileiros (Lei de Fronteira).

### Recomendacao Tecnica
Ideal para estabelecimentos que funcionam como postos avançados ou refúgios táticos. Não recomendado para residência civil sem suporte de segurança e logística independente. Referencia atual de score: GSS 5.6 em 2026-03-05.

## 13. Matriz de Evidencias (E1)
- 1) Dados censitários (INE 2022).
- 2) Relatórios de segurança regional (CODI 2025).
- 3) Informações sobre o Parque Nacional Paso Bravo (MADES).
