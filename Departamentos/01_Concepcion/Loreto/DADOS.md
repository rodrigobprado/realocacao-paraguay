# Avaliacao de Localidade: Loreto, Concepcion

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 23°16′S 57°19′W (geocodificado via Nominatim).
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -23.2667°, -57.3167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (85/100) e exposicao hidro (44/100).
- B (infraestrutura): combina conectividade (85/100) e escala populacional (170262 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (44/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (138.0 hab/km2) e risco hidro.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=44/100.
- Duplicar rotas/logistica quando conectividade viaria=85/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- Populacao municipal/distrital (consolidado operacional): 170262 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 138 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 85/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 44/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Loreto (01_Concepcion) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.9 em 2026-03-05; risco predominante: baixo.
...
# Pesquisa Técnica: Loreto, Concepción

## 1. Clima e Energia Solar
- **Sol e Chuva Mensal (Candle Format - Médias):**
    - [Jan-Mar: 155mm | Max 34°C | Min 23°C]
    - [Abr-Jun: 140mm | Max 29°C | Min 17°C]
    - [Jul-Set: 50mm | Max 28°C | Min 15°C]
    - [Out-Dez: 180mm | Max 33°C | Min 22°C]
- **Ângulo Solar Ideal:** 23° ao Norte.
- **Radiação Média:** 5.6 kWh/m²/dia.

## 2. Indicadores Sociais (Censo 2022)
- **População:** 13.580 habitantes.
- **Idade Média:** 28 anos.
- **IDH:** 0.650 (estimado).
- **Escolaridade:** 8.0 anos (média).
- **Fertilidade:** 2.5 filhos por mulher.
- **Saúde:** Centro de Salud Loreto; forte integração com hospitais de Concepción (20km).
- **Educação:** Colégios de nível médio; acesso direto às universidades da capital.
- **Violência:** Nível baixo; cidade dormitório e agrícola.

## 3. Serviços e Infraestrutura
- **Serviços Públicos:** Delegacia 4ª Loreto; Apoio de Bombeiros de Concepción.
- **Água:** Juntas de Saneamento. Poços artesianos: 80-130 metros.
- **Internet:** Fibra ótica (Personal/Tigo); 4G pleno.
- **Energia:** ANDE. Boa estabilidade devido à proximidade com a capital.

## 4. Custos e Logística
- **Residência Urbana:** Gs. 1.000.000 - 1.800.000 (aluguel).
- **Residência Rural (Terra):** USD 2.500 - 5.500/hectare (Valorizado para granjas e sítios).
- **Postos:** 3 postos (Shell/Petropar/Copetrol).
- **Logística:** Conexão pavimentada com a capital (Rota PY05). Ideal para logística de última milha para Concepción.

## 5. Lazer e Comércio
- **Lazer:** Praças históricas, arquitetura colonial, festas religiosas tradicionais.
- **Comércio:** Supermercados locais e agropecuárias.
- **Poluição Luminosa:** Baixa-Média (Visível brilho da capital Concepción ao sul).
