# Avaliacao de Localidade: Paso Horqueta, Concepcion

## Pesquisa oficial consolidada

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 23°05′S 57°23′W (geocodificado via Nominatim).
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -23.0833°, -57.3833°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (73/100) e exposicao hidro (31/100).
- B (infraestrutura): combina conectividade (73/100) e escala populacional (227594 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (31/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (470.0 hab/km2) e risco hidro.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=31/100.
- Duplicar rotas/logistica quando conectividade viaria=73/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- Populacao municipal/distrital (consolidado operacional): 227594 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 470 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 73/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 31/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Paso_Horqueta (01_Concepcion) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 8.0 em 2026-03-05; risco predominante: baixo.
...
# Pesquisa Técnica: Paso Horqueta, Concepción
...
- **Sol e Chuva Mensal (Candle Format - Médias):**
    ...
    - [Jul-Set: 45mm | Max 28°C | Min 15°C]
...
- **População:** 7.646 habitantes.
- **Idade Média:** 24 anos.
- **IDH:** 0.640 (estimado).
- **Escolaridade:** 7.8 anos (média).
- **Fertilidade:** 2.8 filhos por mulher.
- **Saúde:** Unidade de Salud de la Familia (USF) Paso Horqueta.
- **Educação:** Escolas de nível básico e médio (orientação turismo/serviços).
- **Violência:** Nível baixo; foco em hospitalidade e turismo fluvial.

## 3. Serviços e Infraestrutura
- **Serviços Públicos:** Delegacia local; Apoio de Bombeiros de Concepción ou Horqueta.
- **Água:** Juntas de Saneamento. Poços artesianos: 90-140 metros.
- **Internet:** 4G pleno; Cobertura wireless para pousadas e áreas turísticas.
- **Energia:** ANDE. Linhas reforçadas devido ao polo de lazer.

## 4. Custos e Logística
- **Residência Urbana:** Gs. 800.000 - 1.500.000 (aluguel de temporada ou anual).
- **Residência Rural (Terra):** USD 1.800 - 4.500/hectare (Valorizado pelo potencial turístico/recreativo).
- **Postos:** 2 postos de combustível locais.
- **Logística:** Conexão direta via Ruta PY22 com Concepción (45km).

## 5. Lazer e Comércio
- **Lazer:** Praias de areia branca do Rio Aquidabán, campings, gastronomia de peixe, festivais de verão.
- **Comércio:** Pousadas, restaurantes, mercadinhos de conveniência turística.
- **Poluição Luminosa:** Baixa (Focos de iluminação em áreas de camping).
...
| Farmácia | sim |
| Distância ao hospital de referência | ~47 km (Concepcion) |
