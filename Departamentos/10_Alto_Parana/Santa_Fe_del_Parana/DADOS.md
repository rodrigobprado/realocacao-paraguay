# Avaliacao de Localidade: Santa Fe del Parana, Alto Parana

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°14′S 54°42′W (geocodificado via Nominatim).
...
| Areia | 21.64 % |
| Silte (calc.) | 26.4 % |
| Densidade aparente | 1.18 g/cm³ |
| **Aptidão agrícola** | **Média** |

Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.2333°, -54.7°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=61/100.
- Duplicar rotas/logistica quando conectividade viaria=57/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (57/100) e exposicao hidro (61/100).
- B (infraestrutura): combina conectividade (57/100) e escala populacional (207008 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (61/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (187.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 207008 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 187 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 57/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 61/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Santa_Fe_del_Parana (10_Alto_Parana) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~42 km (Ciudad del Este) |
