# Avaliacao de Localidade: Yguazu, Alto Parana
...
Fonte: ISRIC SoilGrids 2.0 via WCS. Coords: -25.4667°, -55.0°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=78/100.
- Duplicar rotas/logistica quando conectividade viaria=52/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (52/100) e exposicao hidro (78/100).
- B (infraestrutura): combina conectividade (52/100) e escala populacional (42288 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (78/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (499.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 42288 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 499 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 52/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 78/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
- Cenario otimista (B+1, C+1): GSS 5.8
- Cenario conservador (B-1, C-1): GSS 5.1
...
Yguazu (10_Alto_Parana) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 5.4 em 2026-03-05; risco predominante: alto.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~49 km (Ciudad del Este) |
