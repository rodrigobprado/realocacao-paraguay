# Avaliacao de Localidade: Tavapy, Alto Parana

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°40′S 55°00′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.4 |
| Carbono orgânico (SOC) | 21.24 g/kg |
| Argila | 40.53 % |
| Areia | 23.51 % |
| Silte (calc.) | 36.0 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.6667°, -55.0°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Duplicar rotas/logistica quando conectividade viaria=67/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (67/100) e exposicao hidro (40/100).
- B (infraestrutura): combina conectividade (67/100) e escala populacional (126589 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (40/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (73.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 126589 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 73 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 67/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
...
Tavapy (10_Alto_Parana) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~52 km (Ciudad del Este) |
