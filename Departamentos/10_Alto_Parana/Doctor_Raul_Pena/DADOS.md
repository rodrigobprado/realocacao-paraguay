...
- **População:** 10.048 habitantes (Censo 2022 Final). Perfil demográfico majoritariamente rural (85%) com forte presença de imigrantes e descendentes de origem brasileira.
- **Densidade:** ~44,6 hab/km² (**Densidade baixa**, oferecendo isolamento relativo em áreas de fazendas mecanizadas).
- **Vias de Acesso:** Acesso via ramais pavimentados e estradas de terra que conectam à Ruta **PY06**. Localização que favorece a discrição, estando protegida dos grandes fluxos migratórios pela topografia e distância das rotas principais.
...
- **Dependência de Cadeias Globais:** Economia focada exclusivamente em commodities exportáveis (Mitigação: implementação de sistemas de policultivo de subsistência e criação de pequenos animais).
...
- **Fragilidade da Rede Elétrica:** Dependência de energia externa para silos e bombas (Mitigação: instalação de sistemas solares fotovoltaicos potentes e geradores).

## 6. Pontuacao GSS (avaliacao calibrada - Onda 2)
Notas (0-10):
- A: 6.0 (Localização discreta e protegida de eixos de conflito; excelente invisibilidade tática)
- B: 7.0 (População pequena e densidade controlada; baixíssimo risco social urbano)
- C: 7.0 (Geologia muito estável e baixo risco de desastres naturais graves)
- D: 7.5 (Recursos agrícolas de elite e abundância hídrica; limitado pela especialização técnica)
- E: 2.0 (Nota penalizada no ranking nacional para refletir a dependência de insumos globais e infraestrutura local mínima - GSS 5.6 total)
...
|-----------|-------|
| pH (H₂O) | 5.4 |
| Carbono orgânico (SOC) | 20.82 g/kg |
| Argila | 41.76 % |
| Areia | 26.3 % |
| Silte (calc.) | 31.9 % |
...
- **Cenario curto prazo:** Manutenção da rentabilidade das safras e valorização de áreas mecanizadas.
- **Cenario medio prazo:** Impacto de crises no mercado global de fertilizantes sobre a produtividade local.

## 11. Redacao Final
### Diagnostico Integrado
Doctor Raúl Peña é um enclave de alta produtividade no sul de Alto Paraná. Oferece o máximo em termos de qualidade de solo e segurança social rural, sendo uma localidade "fora do radar" das grandes crises demográficas. Sua viabilidade como refúgio é sustentada pela riqueza agrícola, mas exige do ocupante um alto nível de autonomia tática, energética e de saúde, dada a simplicidade da infraestrutura institucional local e a perigosa dependência da monocultura exportadora.
...
Altamente indicado para estabelecimentos de autossuficiência tecnificada ou exploração agrícola que busque isolamento demográfico em solo de alta performance. Requer autonomia em logística básica e saúde. O GSS de 5.6 reflete a segurança do isolamento em contraste com a vulnerabilidade sistêmica da especialização agrícola. Referencia atual de score: GSS 5.6 em 2026-03-05.

## 13. Matriz de Evidencias (E1)
- 1) Dados censitários validados (INE 2022).
- 2) Relatórios de produtividade agrícola de elite (MAG).
...
| Farmácia | sim |
| Distância ao hospital de referência | ~5 km (Ciudad del Este) |
