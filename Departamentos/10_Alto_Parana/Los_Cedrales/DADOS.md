# Avaliacao de Localidade: Los Cedrales, Alto Parana

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°40′S 54°43′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.5 |
| Carbono orgânico (SOC) | 24.42 g/kg |
| Argila | 49.77 % |
| Areia | 17.83 % |
| Silte (calc.) | 32.4 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.6667°, -54.7167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=52/100.
...
- A (geoestrategia): combina conectividade viaria (54/100) e exposicao hidro (52/100).
- B (infraestrutura): combina conectividade (54/100) e escala populacional (191966 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (52/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (96.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 191966 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 96 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 54/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 52/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
- Cenario otimista (B+1, C+1): GSS 7.3
- Cenario conservador (B-1, C-1): GSS 6.6
...
Los_Cedrales (10_Alto_Parana) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
