# Avaliacao de Localidade: Tobati, Cordillera

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°16′S 57°05′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.5 |
| Carbono orgânico (SOC) | 17.05 g/kg |
| Argila | 26.22 % |
| Areia | 52.91 % |
| Silte (calc.) | 20.9 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.2667°, -57.0833°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (90/100) e exposicao hidro (60/100).
- B (infraestrutura): combina conectividade (90/100) e escala populacional (28632 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (60/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (212.0 hab/km2) e risco hidro.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=60/100.
...
- Populacao municipal/distrital (consolidado operacional): 28632 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 212 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 90/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 60/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Tobati (03_Cordillera) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~19 km (Caacupe) |
