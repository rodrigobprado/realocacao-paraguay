# Avaliacao de Localidade: San Roque Gonzalez, Paraguari

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°53′S 57°17′W (geocodificado via Nominatim).
...
|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----|-----------|
| 4.23 | 4.53 | 4.39 | 5.24 | 4.61 | 2.63 | 2.15 | 1.51 | 2.68 | 5.45 | 6.16 | 5.56 | **1496 mm** |
...
|-----------|-------|
| pH (H₂O) | 5.4 |
| Carbono orgânico (SOC) | 21.33 g/kg |
| Argila | 23.67 % |
| Areia | 55.23 % |
| Silte (calc.) | 21.1 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.8833°, -57.2833°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=30/100.
...
- A (geoestrategia): combina conectividade viaria (80/100) e exposicao hidro (30/100).
- B (infraestrutura): combina conectividade (80/100) e escala populacional (106967 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (30/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (340.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 106967 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 340 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 80/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 30/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
San_Roque_Gonzalez (09_Paraguari) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~40 km (Paraguari) |
