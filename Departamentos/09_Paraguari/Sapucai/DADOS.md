# Avaliacao de Localidade: Sapucai, Paraguari

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°40′S 56°57′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.3 |
| Carbono orgânico (SOC) | 24.27 g/kg |
| Argila | 24.92 % |
| Areia | 51.17 % |
| Silte (calc.) | 23.9 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.6667°, -56.95°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=43/100.
- Duplicar rotas/logistica quando conectividade viaria=66/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (66/100) e exposicao hidro (43/100).
- B (infraestrutura): combina conectividade (66/100) e escala populacional (145127 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (43/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (153.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 145127 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 153 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 66/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 43/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Sapucai (09_Paraguari) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.4 em 2026-03-05; risco predominante: baixo.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~30 km (Paraguari) |
