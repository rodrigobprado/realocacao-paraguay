# Avaliacao de Localidade: Quyquyho, Paraguari

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 26°14′S 56°59′W (geocodificado via Nominatim).
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -26.2333°, -56.9833°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=33/100.
- Duplicar rotas/logistica quando conectividade viaria=53/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (53/100) e exposicao hidro (33/100).
- B (infraestrutura): combina conectividade (53/100) e escala populacional (199827 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (33/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (22.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 199827 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 22 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 53/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 33/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Quyquyho (09_Paraguari) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~87 km (Paraguari) |
