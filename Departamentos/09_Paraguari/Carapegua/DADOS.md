# Avaliacao de Localidade: Carapegua, Paraguari

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°46′S 57°15′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.4 |
| Carbono orgânico (SOC) | 18.18 g/kg |
| Argila | 23.4 % |
| Areia | 56.48 % |
| Silte (calc.) | 20.1 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.7667°, -57.25°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=89/100.
...
- A (geoestrategia): combina conectividade viaria (91/100) e exposicao hidro (89/100).
- B (infraestrutura): combina conectividade (91/100) e escala populacional (173866 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (89/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (251.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 173866 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 251 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 91/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 89/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Carapegua (09_Paraguari) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.0 em 2026-03-05; risco predominante: alto.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~23 km (Paraguari) |
