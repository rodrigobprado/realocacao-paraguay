# Avaliacao de Localidade: Escobar, Paraguari

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°40′S 57°02′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.3 |
| Carbono orgânico (SOC) | 18.63 g/kg |
| Argila | 23.46 % |
| Areia | 49.03 % |
| Silte (calc.) | 27.5 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.6667°, -57.0333°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (88/100) e exposicao hidro (37/100).
- B (infraestrutura): combina conectividade (88/100) e escala populacional (79581 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (37/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (24.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 79581 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 24 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
...
Escobar (09_Paraguari) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.6 em 2026-03-05; risco predominante: baixo.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~16 km (Paraguari) |
