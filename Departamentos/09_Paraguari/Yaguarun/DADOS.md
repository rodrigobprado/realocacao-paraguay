# Avaliacao de Localidade: Yaguarun, Paraguari

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 26°02′S 57°17′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.57 |
| Carbono orgânico (SOC) | 18.13 g/kg |
| Argila | 24.69 % |
| Areia | 54.54 % |
| Silte (calc.) | 20.8 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -26.0333°, -57.2833°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (85/100) e exposicao hidro (23/100).
- B (infraestrutura): combina conectividade (85/100) e escala populacional (169094 hab).
...
- Populacao municipal/distrital (consolidado operacional): 169094 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
...
Yaguarun (09_Paraguari) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~56 km (Paraguari) |
