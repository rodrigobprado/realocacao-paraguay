# Avaliacao de Localidade: Acahay, Paraguari

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°55′S 57°07′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.5 |
| Carbono orgânico (SOC) | 18.64 g/kg |
| Argila | 26.22 % |
| Areia | 53.1 % |
| Silte (calc.) | 20.7 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.9167°, -57.1167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=35/100.
...
- A (geoestrategia): combina conectividade viaria (89/100) e exposicao hidro (35/100).
- B (infraestrutura): combina conectividade (89/100) e escala populacional (172125 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (35/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (516.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 172125 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 516 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 89/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 35/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Acahay (09_Paraguari) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 8.1 em 2026-03-05; risco predominante: baixo.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~41 km (Paraguari) |
