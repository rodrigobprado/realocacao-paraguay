# Avaliacao de Localidade: Mbuyapey, Paraguari

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 26°13′S 56°45′W (geocodificado via Nominatim).
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -26.2167°, -56.75°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=55/100.
- Duplicar rotas/logistica quando conectividade viaria=71/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (71/100) e exposicao hidro (55/100).
- B (infraestrutura): combina conectividade (71/100) e escala populacional (168826 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (55/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (373.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 168826 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 373 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 71/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 55/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Mbuyapey (09_Paraguari) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.1 em 2026-03-05; risco predominante: moderado.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~97 km (Paraguari) |
