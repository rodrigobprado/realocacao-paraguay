# Avaliacao de Localidade: Capiata, Central

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°21′S 57°27′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.6 |
| Carbono orgânico (SOC) | 16.28 g/kg |
| Argila | 25.48 % |
| Areia | 50.5 % |
| Silte (calc.) | 24.0 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.35°, -57.45°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=36/100.
...
- A (geoestrategia): combina conectividade viaria (37/100) e exposicao hidro (36/100).
- B (infraestrutura): combina conectividade (37/100) e escala populacional (232757 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (36/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (311.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 232757 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 311 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 37/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 36/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Capiata (11_Central) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~8 km (Aregua) |
