...
- **População:** 7.536 habitantes (Censo 2022 Final). População com forte tradição comercial e resiliência hídrica.
- **Densidade:** ~33,9 hab/km² (**Densidade baixa**, embora concentrada no núcleo urbano orla-rio). Oferece excelente isolamento social em relação aos grandes centros urbanos paraguaios.
- **Vias de Acesso:** A nova Ruta **PY19** (pavimentada) rompeu o isolamento histórico, conectando Alberdi a Villeta/Assunção ao norte e a Pilar ao sul. Acesso fluvial contínuo para a Argentina.
...
- **Energia:** Rede nacional (Itaipu/Yacyretá); vulnerável a interrupções em tempestades devido à extensão das linhas de transmissão rurais.
...
|-----------|-------|
| pH (H₂O) | 6.0 |
| Carbono orgânico (SOC) | 15.93 g/kg |
| Argila | 19.03 % |
| Areia | 53.33 % |
| Silte (calc.) | 27.6 % |
...
- **Vulnerabilidade Hídrica Extrema:** Dependência vital do muro de contenção (Mitigação: residência construída com sistema de palafitas ou em zonas rurais mais elevadas fora do perímetro de inundação direta).
- **Dependência Comercial:** Economia sensível à política cambial argentina (Mitigação: diversificação para pecuária ou agricultura de arroz).
- **Isolamento de Redes:** Fragilidade elétrica (Mitigação: instalação de sistemas solares fotovoltaicos e geradores).

## 6. Pontuacao GSS (avaliacao calibrada - Onda 2)
Notas (0-10):
- A: 7.5 (Isolamento geográfico estratégico; longe de alvos militares primários e eixos de fallout)
- B: 7.5 (População pequena e gerenciável; baixa densidade demográfica total)
- C: 5.0 (Risco crítico de inundação; nota penalizada pela dependência de muros de defesa)
- D: 7.0 (Excelentes recursos de proteína animal e água; hub de suprimentos importados)
- E: 6.5 (Comunidade resiliente e segura; forte presença institucional de fronteira)
...
- **Populacao:** 7.536 habitantes.
- **Densidade:** 33,9 hab/km².
- **Logística:** Conexão asfáltica nova via PY19 e via balsa com Formosa (Arg).
- **Homicidios/100k:** ~4,0 (Muito abaixo da média nacional).

## 10. Analise de Riscos
- **Cenario curto prazo:** Valorização imobiliária pela nova conectividade asfáltica.
- **Cenario medio prazo:** Impacto de mudanças climáticas no regime de cheias do Rio Paraguai.

## 11. Redacao Final
### Diagnostico Integrado
Alberdi é um enclave estratégico de resiliência no sul do Paraguai. Oferece um dos melhores níveis de isolamento demográfico e tático do país, protegida por vastos humedais e longe dos eixos de conflito primários. Sua força reside na abundância de proteína animal e na infraestrutura de suprimentos importados. O desafio crítico é a gestão hídrica; a sobrevivência em Alberdi exige a escolha de terrenos em cotas seguras e a manutenção de autonomia energética, aproveitando a nova rota asfáltica que garante logística eficiente em tempos de paz.
...
Altamente indicado para residências de isolamento tático "low profile" ou projetos de pecuária/rizicultura. Exige planejamento de construção contra cheias e autonomia de recursos. O GSS de 6.9 reflete o poder do isolamento tático equilibrado pela vulnerabilidade hídrica. Referencia atual de score: GSS 6.9 em 2026-03-05.

## 13. Matriz de Evidencias (E1)
- 1) Dados censitários validados (INE 2022).
- 2) Relatórios de engenharia do muro de defesa costeira (MOPC).
- 3) Mapa de solos e bacias hidrográficas de Ñeembucú (MAG).
- 4) Registro de segurança pública e comércio de fronteira.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~95 km (Pilar) |
