...
- **População:** 4.340 habitantes (Censo 2022 Final). População com forte ligação com a atividade pesqueira e pecuária.
- **Densidade:** ~6,4 hab/km² (**Densidade extremamente baixa**, garantindo privacidade absoluta e ausência de riscos sociais de massa urbana).
- **Vias de Acesso:** Acesso via ramais de terra a partir da Ruta PY04. Localização remota que favorece o anonimato estratégico, mas sujeita a períodos de isolamento físico devido à precariedade das vias de terra durante cheias extraordinárias. Acesso fluvial contínuo e privilegiado.
...
|-----------|-------|
| pH (H₂O) | 5.7 |
| Carbono orgânico (SOC) | 18.4 g/kg |
| Argila | 15.05 % |
| Areia | 68.82 % |
| Silte (calc.) | 16.1 % |
...
- **Isolamento Terrestre Recorrente:** Risco de ficar sem acesso por terra em grandes cheias (Mitigação: posse de embarcação a motor como via de transporte primária; manutenção de estoque de suprimentos para 90 dias).
- **Fragilidade de Suporte Médico:** Distância crítica de hospitais terrestres (Mitigação: manutenção de estoque médico básico e kit trauma local; aproveitar proximidade fluvial com Ayolas).
- **Dependência de Redes:** Vulnerabilidade elétrica rural (Mitigação: instalação de sistemas solares fotovoltaicos).

## 6. Pontuacao GSS (avaliacao calibrada - Onda 2)
Notas (0-10):
- A: 7.5 (Posição tática protegida por colina; margem do rio e isolamento geográfico superior; baixa visibilidade de alvos)
...
- D: 7.5 (Excelentes recursos pesqueiros e de proteína animal; água fluvial ilimitada)
- E: 6.0 (Ambiente social seguro e estável, mas com suporte institucional limitado regionalmente)
...
- **Ativo Hídrico:** Margem do Rio Paraná (Abundância absoluta).
- **Homicidios/100k:** ~0,0 (Histórico de paz absoluta).

## 10. Analise de Riscos
- **Cenario curto prazo:** Manutenção da tranquilidade rural e estabilidade do turismo de pesca.
- **Cenario medio prazo:** Impacto de mudanças no regime de vazão de Yacyretá sobre a orla do distrito.

## 11. Redacao Final
### Diagnostico Integrado
Cerrito é o refúgio "anfíbio" do sul paraguaio. Oferece um isolamento geográfico e demográfico que transforma a localidade em uma zona virtualmente invisível a crises globais, protegida pela geografia dos grandes rios e pela própria elevação que dá nome ao distrito. Sua força absoluta reside na abundância inesgotável de recursos hídricos e pesqueiros, além da segurança social de uma comunidade integrada e pacífica. O desafio principal é a logística terrestre, que exige do ocupante autonomia de transporte fluvial e estoque tático de suprimentos. É o local ideal para quem busca segurança através da inacessibilidade e abundância natural.

### Por que sim
- Máximo isolamento geográfico e demográfico (anonimato absoluto).
- Abundância ilimitada de água e recursos alimentares (peixes/gado).
...
### Por que nao
- Risco de isolamento físico total por terra em eventos climáticos extremos.
...
Altamente indicado para residências de isolamento tático que priorizem a invisibilidade e possuam infraestrutura própria de transporte fluvial. Requer autonomia energética e hídrica individual. O GSS de 7.1 reflete a solidez do isolamento geográfico e a riqueza de recursos naturais da localidade. Referencia atual de score: GSS 7.1 em 2026-03-05.

## 13. Matriz de Evidencias (E1)
- 1) Dados censitários validados (INE 2022).
- 2) Relatórios de monitoramento fluvial do Rio Paraná (EBY/ANNP).
