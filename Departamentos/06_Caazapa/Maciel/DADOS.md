# Avaliacao de Localidade: Maciel, Caazapa

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 26°11′S 56°28′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.4 |
| Carbono orgânico (SOC) | 15.07 g/kg |
| Argila | 22.9 % |
| Areia | 50.16 % |
| Silte (calc.) | 26.9 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -26.1833°, -56.4667°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=59/100.
...
- A (geoestrategia): combina conectividade viaria (80/100) e exposicao hidro (59/100).
- B (infraestrutura): combina conectividade (80/100) e escala populacional (207626 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (59/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (386.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 207626 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 386 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 80/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 59/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
Maciel (06_Caazapa) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~13 km (Caazapa) |
