...
|-----------|-------|
| pH (H₂O) | 5.25 |
| Carbono orgânico (SOC) | 24.82 g/kg |
| Argila | 39.3 % |
| Areia | 44.93 % |
| Silte (calc.) | 15.8 % |
...
- Duplicar rotas/logistica quando conectividade viaria=82/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (82/100) e exposicao hidro (39/100).
- B (infraestrutura): combina conectividade (82/100) e escala populacional (106721 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (39/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (133.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 106721 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 133 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 82/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
...
Pedro_Juan_Caballero (13_Amambay) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.8 em 2026-03-05; risco predominante: baixo.
...
**Principais estabelecimentos:** Hospital distrital / regional de Pedro Juan Caballero; rede de USF e farmacias locais
