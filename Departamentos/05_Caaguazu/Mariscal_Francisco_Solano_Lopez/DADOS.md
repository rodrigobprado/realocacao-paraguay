# Avaliacao de Localidade: Mariscal Francisco Solano Lopez, Caaguazu

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°28′S 56°01′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.23 |
| Carbono orgânico (SOC) | 17.38 g/kg |
| Argila | 27.91 % |
| Areia | 49.93 % |
| Silte (calc.) | 22.2 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.4667°, -56.0167°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- A (geoestrategia): combina conectividade viaria (80/100) e exposicao hidro (23/100).
- B (infraestrutura): combina conectividade (80/100) e escala populacional (60561 hab).
...
- Populacao municipal/distrital (consolidado operacional): 60561 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
...
Mariscal_Francisco_Solano_Lopez (05_Caaguazu) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.7 em 2026-03-05; risco predominante: baixo.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~100 km (Coronel Oviedo) |
