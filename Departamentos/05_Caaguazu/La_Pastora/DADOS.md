...
|-----------|-------|
| pH (H₂O) | 5.3 |
| Carbono orgânico (SOC) | 17.29 g/kg |
| Argila | 25.77 % |
| Areia | 53.32 % |
| Silte (calc.) | 20.9 % |
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=29/100.
...
- A (geoestrategia): combina conectividade viaria (52/100) e exposicao hidro (29/100).
- B (infraestrutura): combina conectividade (52/100) e escala populacional (10884 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (29/100).
...
- Populacao municipal/distrital (consolidado operacional): 10884 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
...
- Exposicao hidrometeorologica relativa (consolidado operacional): 29/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
La_Pastora (05_Caaguazu) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
