# Avaliacao de Localidade: Nueva Londres, Caaguazu

## Pesquisa oficial consolidada (acesso em 2026-03-05)

### 1. Geografia e contexto estrategico/militar
- **Coordenadas:** 25°24′S 56°33′W (geocodificado via Nominatim).
...
|-----------|-------|
| pH (H₂O) | 5.4 |
| Carbono orgânico (SOC) | 17.2 g/kg |
| Argila | 26.56 % |
| Areia | 53.42 % |
| Silte (calc.) | 20.0 % |
...
Fonte: ISRIC SoilGrids 2.0 via WCS (acesso em 2026-03-21). Coords: -25.4°, -56.55°. Média ponderada camadas 0-5, 5-15, 15-30 cm.
...
- Estoque de contingencia para 14 dias (agua/alimentos/combustivel), priorizado quando risco hidro=28/100.
- Duplicar rotas/logistica quando conectividade viaria=54/100 for <70; manter rota secundaria mapeada e testada trimestralmente.
...
- A (geoestrategia): combina conectividade viaria (54/100) e exposicao hidro (28/100).
- B (infraestrutura): combina conectividade (54/100) e escala populacional (122918 hab).
- C (riscos naturais): derivada da exposicao hidrometeorologica (28/100).
- D (autossuficiencia): combina conectividade, ajuste de densidade (19.0 hab/km2) e risco hidro.
...
- Populacao municipal/distrital (consolidado operacional): 122918 habitantes (referencia temporal: 2026-03-05; base: consolidacao de fontes oficiais INE listadas na secao 8).
- Densidade demografica (consolidado operacional): 19 hab/km2 (referencia temporal: 2026-03-05; base: consolidacao territorial oficial).
- Conectividade viaria funcional (consolidado operacional): 54/100 (referencia temporal: 2026-03-05; base: MOPC estado de rutas).
- Exposicao hidrometeorologica relativa (consolidado operacional): 28/100 (referencia temporal: 2026-03-05; base: DMH/SEN avisos e ocorrencias).
...
- Cenario otimista (B+1, C+1): GSS 7.5
- Cenario conservador (B-1, C-1): GSS 6.8
...
Nueva_Londres (05_Caaguazu) apresenta perfil operacional consolidado para comparacao territorial, com leitura conjunta de infraestrutura, risco hidroclimatico e capacidade de continuidade de servicos essenciais.
...
Uso recomendado como candidato em analise multicriterio, condicionado ao cumprimento das pre-condicoes acima. Referencia atual de score: GSS 7.2 em 2026-03-05; risco predominante: baixo.
...
| Farmácia | sim |
| Distância ao hospital de referência | ~25 km (Coronel Oviedo) |

**Principais estabelecimentos:** USF local; farmácias distritais.

**Observação para imigrantes:** Atendimento primário disponível. Proximidade com Coronel Oviedo garante rápido acesso ao hospital regional. Cobertura privada recomendada; IPS não disponível localmente.
